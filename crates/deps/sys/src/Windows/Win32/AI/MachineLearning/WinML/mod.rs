...
pub type MLCreateOperatorRegistry = unsafe extern "system" fn(registry: *mut IMLOperatorRegistry) -> ::windows_sys::core::HRESULT;
pub type WinMLCreateRuntime = unsafe extern "system" fn(runtime: *mut IWinMLRuntime) -> ::windows_sys::core::HRESULT;
