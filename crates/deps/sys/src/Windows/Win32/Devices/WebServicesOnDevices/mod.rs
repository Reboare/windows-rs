...
pub type WSDAllocateLinkedMemory = unsafe extern "system" fn(pparent: *mut ::core::ffi::c_void, cbsize: usize) -> *mut ::core::ffi::c_void;
pub type WSDAttachLinkedMemory = unsafe extern "system" fn(pparent: *mut ::core::ffi::c_void, pchild: *mut ::core::ffi::c_void);
#[cfg(feature = "Win32_Foundation")]
pub type WSDCreateDeviceHost = unsafe extern "system" fn(pszlocalid: super::super::Foundation::PWSTR, pcontext: IWSDXMLContext, ppdevicehost: *mut IWSDDeviceHost) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type WSDCreateDeviceHost2 = unsafe extern "system" fn(pszlocalid: super::super::Foundation::PWSTR, pcontext: IWSDXMLContext, pconfigparams: *const WSD_CONFIG_PARAM, dwconfigparamcount: u32, ppdevicehost: *mut IWSDDeviceHost) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type WSDCreateDeviceHostAdvanced = unsafe extern "system" fn(pszlocalid: super::super::Foundation::PWSTR, pcontext: IWSDXMLContext, pphostaddresses: *const IWSDAddress, dwhostaddresscount: u32, ppdevicehost: *mut IWSDDeviceHost) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type WSDCreateDeviceProxy = unsafe extern "system" fn(pszdeviceid: super::super::Foundation::PWSTR, pszlocalid: super::super::Foundation::PWSTR, pcontext: IWSDXMLContext, ppdeviceproxy: *mut IWSDDeviceProxy) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type WSDCreateDeviceProxy2 = unsafe extern "system" fn(pszdeviceid: super::super::Foundation::PWSTR, pszlocalid: super::super::Foundation::PWSTR, pcontext: IWSDXMLContext, pconfigparams: *const WSD_CONFIG_PARAM, dwconfigparamcount: u32, ppdeviceproxy: *mut IWSDDeviceProxy) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type WSDCreateDeviceProxyAdvanced = unsafe extern "system" fn(pszdeviceid: super::super::Foundation::PWSTR, pdeviceaddress: IWSDAddress, pszlocalid: super::super::Foundation::PWSTR, pcontext: IWSDXMLContext, ppdeviceproxy: *mut IWSDDeviceProxy) -> ::windows_sys::core::HRESULT;
pub type WSDCreateDiscoveryProvider = unsafe extern "system" fn(pcontext: IWSDXMLContext, ppprovider: *mut IWSDiscoveryProvider) -> ::windows_sys::core::HRESULT;
pub type WSDCreateDiscoveryProvider2 = unsafe extern "system" fn(pcontext: IWSDXMLContext, pconfigparams: *const WSD_CONFIG_PARAM, dwconfigparamcount: u32, ppprovider: *mut IWSDiscoveryProvider) -> ::windows_sys::core::HRESULT;
pub type WSDCreateDiscoveryPublisher = unsafe extern "system" fn(pcontext: IWSDXMLContext, pppublisher: *mut IWSDiscoveryPublisher) -> ::windows_sys::core::HRESULT;
pub type WSDCreateDiscoveryPublisher2 = unsafe extern "system" fn(pcontext: IWSDXMLContext, pconfigparams: *const WSD_CONFIG_PARAM, dwconfigparamcount: u32, pppublisher: *mut IWSDiscoveryPublisher) -> ::windows_sys::core::HRESULT;
pub type WSDCreateHttpAddress = unsafe extern "system" fn(ppaddress: *mut IWSDHttpAddress) -> ::windows_sys::core::HRESULT;
pub type WSDCreateHttpMessageParameters = unsafe extern "system" fn(pptxparams: *mut IWSDHttpMessageParameters) -> ::windows_sys::core::HRESULT;
pub type WSDCreateOutboundAttachment = unsafe extern "system" fn(ppattachment: *mut IWSDOutboundAttachment) -> ::windows_sys::core::HRESULT;
pub type WSDCreateUdpAddress = unsafe extern "system" fn(ppaddress: *mut IWSDUdpAddress) -> ::windows_sys::core::HRESULT;
pub type WSDCreateUdpMessageParameters = unsafe extern "system" fn(pptxparams: *mut IWSDUdpMessageParameters) -> ::windows_sys::core::HRESULT;
pub type WSDDetachLinkedMemory = unsafe extern "system" fn(pvoid: *mut ::core::ffi::c_void);
pub type WSDFreeLinkedMemory = unsafe extern "system" fn(pvoid: *mut ::core::ffi::c_void);
#[cfg(feature = "Win32_Foundation")]
pub type WSDGenerateFault = unsafe extern "system" fn(pszcode: super::super::Foundation::PWSTR, pszsubcode: super::super::Foundation::PWSTR, pszreason: super::super::Foundation::PWSTR, pszdetail: super::super::Foundation::PWSTR, pcontext: IWSDXMLContext, ppfault: *mut *mut WSD_SOAP_FAULT) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type WSDGenerateFaultEx = unsafe extern "system" fn(pcode: *const WSDXML_NAME, psubcode: *const WSDXML_NAME, preasons: *const WSD_LOCALIZED_STRING_LIST, pszdetail: super::super::Foundation::PWSTR, ppfault: *mut *mut WSD_SOAP_FAULT) -> ::windows_sys::core::HRESULT;
pub type WSDGetConfigurationOption = unsafe extern "system" fn(dwoption: u32, pvoid: *mut ::core::ffi::c_void, cboutbuffer: u32) -> ::windows_sys::core::HRESULT;
pub type WSDSetConfigurationOption = unsafe extern "system" fn(dwoption: u32, pvoid: *const ::core::ffi::c_void, cbinbuffer: u32) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type WSDUriDecode = unsafe extern "system" fn(source: super::super::Foundation::PWSTR, cchsource: u32, destout: *mut super::super::Foundation::PWSTR, cchdestout: *mut u32) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type WSDUriEncode = unsafe extern "system" fn(source: super::super::Foundation::PWSTR, cchsource: u32, destout: *mut super::super::Foundation::PWSTR, cchdestout: *mut u32) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type WSDXMLAddChild = unsafe extern "system" fn(pparent: *mut WSDXML_ELEMENT, pchild: *mut WSDXML_ELEMENT) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type WSDXMLAddSibling = unsafe extern "system" fn(pfirst: *mut WSDXML_ELEMENT, psecond: *mut WSDXML_ELEMENT) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type WSDXMLBuildAnyForSingleElement = unsafe extern "system" fn(pelementname: *mut WSDXML_NAME, psztext: super::super::Foundation::PWSTR, ppany: *mut *mut WSDXML_ELEMENT) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type WSDXMLCleanupElement = unsafe extern "system" fn(pany: *mut WSDXML_ELEMENT) -> ::windows_sys::core::HRESULT;
pub type WSDXMLCreateContext = unsafe extern "system" fn(ppcontext: *mut IWSDXMLContext) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type WSDXMLGetNameFromBuiltinNamespace = unsafe extern "system" fn(psznamespace: super::super::Foundation::PWSTR, pszname: super::super::Foundation::PWSTR, ppname: *mut *mut WSDXML_NAME) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type WSDXMLGetValueFromAny = unsafe extern "system" fn(psznamespace: super::super::Foundation::PWSTR, pszname: super::super::Foundation::PWSTR, pany: *mut WSDXML_ELEMENT, ppszvalue: *mut super::super::Foundation::PWSTR) -> ::windows_sys::core::HRESULT;
