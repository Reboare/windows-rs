...
pub type CompareStringA = unsafe extern "system" fn(locale: u32, dwcmpflags: u32, lpstring1: *const i8, cchcount1: i32, lpstring2: *const i8, cchcount2: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type CompareStringEx = unsafe extern "system" fn(lplocalename: super::Foundation::PWSTR, dwcmpflags: COMPARE_STRING_FLAGS, lpstring1: super::Foundation::PWSTR, cchcount1: i32, lpstring2: super::Foundation::PWSTR, cchcount2: i32, lpversioninformation: *mut NLSVERSIONINFO, lpreserved: *mut ::core::ffi::c_void, lparam: super::Foundation::LPARAM) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type CompareStringOrdinal = unsafe extern "system" fn(lpstring1: super::Foundation::PWSTR, cchcount1: i32, lpstring2: super::Foundation::PWSTR, cchcount2: i32, bignorecase: super::Foundation::BOOL) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type CompareStringW = unsafe extern "system" fn(locale: u32, dwcmpflags: u32, lpstring1: super::Foundation::PWSTR, cchcount1: i32, lpstring2: super::Foundation::PWSTR, cchcount2: i32) -> i32;
pub type ConvertDefaultLocale = unsafe extern "system" fn(locale: u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type EnumCalendarInfoA = unsafe extern "system" fn(lpcalinfoenumproc: CALINFO_ENUMPROCA, locale: u32, calendar: u32, caltype: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumCalendarInfoExA = unsafe extern "system" fn(lpcalinfoenumprocex: CALINFO_ENUMPROCEXA, locale: u32, calendar: u32, caltype: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumCalendarInfoExEx = unsafe extern "system" fn(pcalinfoenumprocexex: CALINFO_ENUMPROCEXEX, lplocalename: super::Foundation::PWSTR, calendar: u32, lpreserved: super::Foundation::PWSTR, caltype: u32, lparam: super::Foundation::LPARAM) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumCalendarInfoExW = unsafe extern "system" fn(lpcalinfoenumprocex: CALINFO_ENUMPROCEXW, locale: u32, calendar: u32, caltype: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumCalendarInfoW = unsafe extern "system" fn(lpcalinfoenumproc: CALINFO_ENUMPROCW, locale: u32, calendar: u32, caltype: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumDateFormatsA = unsafe extern "system" fn(lpdatefmtenumproc: DATEFMT_ENUMPROCA, locale: u32, dwflags: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumDateFormatsExA = unsafe extern "system" fn(lpdatefmtenumprocex: DATEFMT_ENUMPROCEXA, locale: u32, dwflags: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumDateFormatsExEx = unsafe extern "system" fn(lpdatefmtenumprocexex: DATEFMT_ENUMPROCEXEX, lplocalename: super::Foundation::PWSTR, dwflags: ENUM_DATE_FORMATS_FLAGS, lparam: super::Foundation::LPARAM) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumDateFormatsExW = unsafe extern "system" fn(lpdatefmtenumprocex: DATEFMT_ENUMPROCEXW, locale: u32, dwflags: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumDateFormatsW = unsafe extern "system" fn(lpdatefmtenumproc: DATEFMT_ENUMPROCW, locale: u32, dwflags: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumLanguageGroupLocalesA = unsafe extern "system" fn(lplanggrouplocaleenumproc: LANGGROUPLOCALE_ENUMPROCA, languagegroup: u32, dwflags: u32, lparam: isize) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumLanguageGroupLocalesW = unsafe extern "system" fn(lplanggrouplocaleenumproc: LANGGROUPLOCALE_ENUMPROCW, languagegroup: u32, dwflags: u32, lparam: isize) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumSystemCodePagesA = unsafe extern "system" fn(lpcodepageenumproc: CODEPAGE_ENUMPROCA, dwflags: ENUM_SYSTEM_CODE_PAGES_FLAGS) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumSystemCodePagesW = unsafe extern "system" fn(lpcodepageenumproc: CODEPAGE_ENUMPROCW, dwflags: ENUM_SYSTEM_CODE_PAGES_FLAGS) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumSystemGeoID = unsafe extern "system" fn(geoclass: u32, parentgeoid: i32, lpgeoenumproc: GEO_ENUMPROC) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumSystemGeoNames = unsafe extern "system" fn(geoclass: u32, geoenumproc: GEO_ENUMNAMEPROC, data: super::Foundation::LPARAM) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumSystemLanguageGroupsA = unsafe extern "system" fn(lplanguagegroupenumproc: LANGUAGEGROUP_ENUMPROCA, dwflags: ENUM_SYSTEM_LANGUAGE_GROUPS_FLAGS, lparam: isize) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumSystemLanguageGroupsW = unsafe extern "system" fn(lplanguagegroupenumproc: LANGUAGEGROUP_ENUMPROCW, dwflags: ENUM_SYSTEM_LANGUAGE_GROUPS_FLAGS, lparam: isize) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumSystemLocalesA = unsafe extern "system" fn(lplocaleenumproc: LOCALE_ENUMPROCA, dwflags: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumSystemLocalesEx = unsafe extern "system" fn(lplocaleenumprocex: LOCALE_ENUMPROCEX, dwflags: u32, lparam: super::Foundation::LPARAM, lpreserved: *const ::core::ffi::c_void) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumSystemLocalesW = unsafe extern "system" fn(lplocaleenumproc: LOCALE_ENUMPROCW, dwflags: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumTimeFormatsA = unsafe extern "system" fn(lptimefmtenumproc: TIMEFMT_ENUMPROCA, locale: u32, dwflags: TIME_FORMAT_FLAGS) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumTimeFormatsEx = unsafe extern "system" fn(lptimefmtenumprocex: TIMEFMT_ENUMPROCEX, lplocalename: super::Foundation::PWSTR, dwflags: u32, lparam: super::Foundation::LPARAM) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumTimeFormatsW = unsafe extern "system" fn(lptimefmtenumproc: TIMEFMT_ENUMPROCW, locale: u32, dwflags: TIME_FORMAT_FLAGS) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumUILanguagesA = unsafe extern "system" fn(lpuilanguageenumproc: UILANGUAGE_ENUMPROCA, dwflags: u32, lparam: isize) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EnumUILanguagesW = unsafe extern "system" fn(lpuilanguageenumproc: UILANGUAGE_ENUMPROCW, dwflags: u32, lparam: isize) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type FindNLSString = unsafe extern "system" fn(locale: u32, dwfindnlsstringflags: u32, lpstringsource: super::Foundation::PWSTR, cchsource: i32, lpstringvalue: super::Foundation::PWSTR, cchvalue: i32, pcchfound: *mut i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type FindNLSStringEx = unsafe extern "system" fn(lplocalename: super::Foundation::PWSTR, dwfindnlsstringflags: u32, lpstringsource: super::Foundation::PWSTR, cchsource: i32, lpstringvalue: super::Foundation::PWSTR, cchvalue: i32, pcchfound: *mut i32, lpversioninformation: *const NLSVERSIONINFO, lpreserved: *const ::core::ffi::c_void, sorthandle: super::Foundation::LPARAM) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type FindStringOrdinal = unsafe extern "system" fn(dwfindstringordinalflags: u32, lpstringsource: super::Foundation::PWSTR, cchsource: i32, lpstringvalue: super::Foundation::PWSTR, cchvalue: i32, bignorecase: super::Foundation::BOOL) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type FoldStringA = unsafe extern "system" fn(dwmapflags: FOLD_STRING_MAP_FLAGS, lpsrcstr: super::Foundation::PSTR, cchsrc: i32, lpdeststr: super::Foundation::PSTR, cchdest: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type FoldStringW = unsafe extern "system" fn(dwmapflags: FOLD_STRING_MAP_FLAGS, lpsrcstr: super::Foundation::PWSTR, cchsrc: i32, lpdeststr: super::Foundation::PWSTR, cchdest: i32) -> i32;
pub type GetACP = unsafe extern "system" fn() -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetCPInfo = unsafe extern "system" fn(codepage: u32, lpcpinfo: *mut CPINFO) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetCPInfoExA = unsafe extern "system" fn(codepage: u32, dwflags: u32, lpcpinfoex: *mut CPINFOEXA) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetCPInfoExW = unsafe extern "system" fn(codepage: u32, dwflags: u32, lpcpinfoex: *mut CPINFOEXW) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetCalendarInfoA = unsafe extern "system" fn(locale: u32, calendar: u32, caltype: u32, lpcaldata: super::Foundation::PSTR, cchdata: i32, lpvalue: *mut u32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetCalendarInfoEx = unsafe extern "system" fn(lplocalename: super::Foundation::PWSTR, calendar: u32, lpreserved: super::Foundation::PWSTR, caltype: u32, lpcaldata: super::Foundation::PWSTR, cchdata: i32, lpvalue: *mut u32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetCalendarInfoW = unsafe extern "system" fn(locale: u32, calendar: u32, caltype: u32, lpcaldata: super::Foundation::PWSTR, cchdata: i32, lpvalue: *mut u32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetCurrencyFormatA = unsafe extern "system" fn(locale: u32, dwflags: u32, lpvalue: super::Foundation::PSTR, lpformat: *const CURRENCYFMTA, lpcurrencystr: super::Foundation::PSTR, cchcurrency: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetCurrencyFormatEx = unsafe extern "system" fn(lplocalename: super::Foundation::PWSTR, dwflags: u32, lpvalue: super::Foundation::PWSTR, lpformat: *const CURRENCYFMTW, lpcurrencystr: super::Foundation::PWSTR, cchcurrency: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetCurrencyFormatW = unsafe extern "system" fn(locale: u32, dwflags: u32, lpvalue: super::Foundation::PWSTR, lpformat: *const CURRENCYFMTW, lpcurrencystr: super::Foundation::PWSTR, cchcurrency: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetDateFormatA = unsafe extern "system" fn(locale: u32, dwflags: u32, lpdate: *const super::Foundation::SYSTEMTIME, lpformat: super::Foundation::PSTR, lpdatestr: super::Foundation::PSTR, cchdate: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetDateFormatEx = unsafe extern "system" fn(lplocalename: super::Foundation::PWSTR, dwflags: ENUM_DATE_FORMATS_FLAGS, lpdate: *const super::Foundation::SYSTEMTIME, lpformat: super::Foundation::PWSTR, lpdatestr: super::Foundation::PWSTR, cchdate: i32, lpcalendar: super::Foundation::PWSTR) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetDateFormatW = unsafe extern "system" fn(locale: u32, dwflags: u32, lpdate: *const super::Foundation::SYSTEMTIME, lpformat: super::Foundation::PWSTR, lpdatestr: super::Foundation::PWSTR, cchdate: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetDistanceOfClosestLanguageInList = unsafe extern "system" fn(pszlanguage: super::Foundation::PWSTR, pszlanguageslist: super::Foundation::PWSTR, wchlistdelimiter: u16, pclosestdistance: *mut f64) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type GetDurationFormat = unsafe extern "system" fn(locale: u32, dwflags: u32, lpduration: *const super::Foundation::SYSTEMTIME, ullduration: u64, lpformat: super::Foundation::PWSTR, lpdurationstr: super::Foundation::PWSTR, cchduration: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetDurationFormatEx = unsafe extern "system" fn(lplocalename: super::Foundation::PWSTR, dwflags: u32, lpduration: *const super::Foundation::SYSTEMTIME, ullduration: u64, lpformat: super::Foundation::PWSTR, lpdurationstr: super::Foundation::PWSTR, cchduration: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetFileMUIInfo = unsafe extern "system" fn(dwflags: u32, pcwszfilepath: super::Foundation::PWSTR, pfilemuiinfo: *mut FILEMUIINFO, pcbfilemuiinfo: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetFileMUIPath = unsafe extern "system" fn(dwflags: u32, pcwszfilepath: super::Foundation::PWSTR, pwszlanguage: super::Foundation::PWSTR, pcchlanguage: *mut u32, pwszfilemuipath: super::Foundation::PWSTR, pcchfilemuipath: *mut u32, pululenumerator: *mut u64) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetGeoInfoA = unsafe extern "system" fn(location: i32, geotype: u32, lpgeodata: super::Foundation::PSTR, cchdata: i32, langid: u16) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetGeoInfoEx = unsafe extern "system" fn(location: super::Foundation::PWSTR, geotype: u32, geodata: super::Foundation::PWSTR, geodatacount: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetGeoInfoW = unsafe extern "system" fn(location: i32, geotype: u32, lpgeodata: super::Foundation::PWSTR, cchdata: i32, langid: u16) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetLocaleInfoA = unsafe extern "system" fn(locale: u32, lctype: u32, lplcdata: super::Foundation::PSTR, cchdata: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetLocaleInfoEx = unsafe extern "system" fn(lplocalename: super::Foundation::PWSTR, lctype: u32, lplcdata: super::Foundation::PWSTR, cchdata: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetLocaleInfoW = unsafe extern "system" fn(locale: u32, lctype: u32, lplcdata: super::Foundation::PWSTR, cchdata: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetNLSVersion = unsafe extern "system" fn(function: u32, locale: u32, lpversioninformation: *mut NLSVERSIONINFO) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetNLSVersionEx = unsafe extern "system" fn(function: u32, lplocalename: super::Foundation::PWSTR, lpversioninformation: *mut NLSVERSIONINFOEX) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetNumberFormatA = unsafe extern "system" fn(locale: u32, dwflags: u32, lpvalue: super::Foundation::PSTR, lpformat: *const NUMBERFMTA, lpnumberstr: super::Foundation::PSTR, cchnumber: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetNumberFormatEx = unsafe extern "system" fn(lplocalename: super::Foundation::PWSTR, dwflags: u32, lpvalue: super::Foundation::PWSTR, lpformat: *const NUMBERFMTW, lpnumberstr: super::Foundation::PWSTR, cchnumber: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetNumberFormatW = unsafe extern "system" fn(locale: u32, dwflags: u32, lpvalue: super::Foundation::PWSTR, lpformat: *const NUMBERFMTW, lpnumberstr: super::Foundation::PWSTR, cchnumber: i32) -> i32;
pub type GetOEMCP = unsafe extern "system" fn() -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetProcessPreferredUILanguages = unsafe extern "system" fn(dwflags: u32, pulnumlanguages: *mut u32, pwszlanguagesbuffer: super::Foundation::PWSTR, pcchlanguagesbuffer: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetStringScripts = unsafe extern "system" fn(dwflags: u32, lpstring: super::Foundation::PWSTR, cchstring: i32, lpscripts: super::Foundation::PWSTR, cchscripts: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetStringTypeA = unsafe extern "system" fn(locale: u32, dwinfotype: u32, lpsrcstr: super::Foundation::PSTR, cchsrc: i32, lpchartype: *mut u16) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetStringTypeExA = unsafe extern "system" fn(locale: u32, dwinfotype: u32, lpsrcstr: super::Foundation::PSTR, cchsrc: i32, lpchartype: *mut u16) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetStringTypeExW = unsafe extern "system" fn(locale: u32, dwinfotype: u32, lpsrcstr: super::Foundation::PWSTR, cchsrc: i32, lpchartype: *mut u16) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetStringTypeW = unsafe extern "system" fn(dwinfotype: u32, lpsrcstr: super::Foundation::PWSTR, cchsrc: i32, lpchartype: *mut u16) -> super::Foundation::BOOL;
pub type GetSystemDefaultLCID = unsafe extern "system" fn() -> u32;
pub type GetSystemDefaultLangID = unsafe extern "system" fn() -> u16;
#[cfg(feature = "Win32_Foundation")]
pub type GetSystemDefaultLocaleName = unsafe extern "system" fn(lplocalename: super::Foundation::PWSTR, cchlocalename: i32) -> i32;
pub type GetSystemDefaultUILanguage = unsafe extern "system" fn() -> u16;
#[cfg(feature = "Win32_Foundation")]
pub type GetSystemPreferredUILanguages = unsafe extern "system" fn(dwflags: u32, pulnumlanguages: *mut u32, pwszlanguagesbuffer: super::Foundation::PWSTR, pcchlanguagesbuffer: *mut u32) -> super::Foundation::BOOL;
...
#[cfg(feature = "Win32_Foundation")]
pub type GetThreadPreferredUILanguages = unsafe extern "system" fn(dwflags: u32, pulnumlanguages: *mut u32, pwszlanguagesbuffer: super::Foundation::PWSTR, pcchlanguagesbuffer: *mut u32) -> super::Foundation::BOOL;
pub type GetThreadUILanguage = unsafe extern "system" fn() -> u16;
#[cfg(feature = "Win32_Foundation")]
pub type GetTimeFormatA = unsafe extern "system" fn(locale: u32, dwflags: u32, lptime: *const super::Foundation::SYSTEMTIME, lpformat: super::Foundation::PSTR, lptimestr: super::Foundation::PSTR, cchtime: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetTimeFormatEx = unsafe extern "system" fn(lplocalename: super::Foundation::PWSTR, dwflags: TIME_FORMAT_FLAGS, lptime: *const super::Foundation::SYSTEMTIME, lpformat: super::Foundation::PWSTR, lptimestr: super::Foundation::PWSTR, cchtime: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetTimeFormatW = unsafe extern "system" fn(locale: u32, dwflags: u32, lptime: *const super::Foundation::SYSTEMTIME, lpformat: super::Foundation::PWSTR, lptimestr: super::Foundation::PWSTR, cchtime: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetUILanguageInfo = unsafe extern "system" fn(dwflags: u32, pwmszlanguage: super::Foundation::PWSTR, pwszfallbacklanguages: super::Foundation::PWSTR, pcchfallbacklanguages: *mut u32, pattributes: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetUserDefaultGeoName = unsafe extern "system" fn(geoname: super::Foundation::PWSTR, geonamecount: i32) -> i32;
pub type GetUserDefaultLCID = unsafe extern "system" fn() -> u32;
pub type GetUserDefaultLangID = unsafe extern "system" fn() -> u16;
#[cfg(feature = "Win32_Foundation")]
pub type GetUserDefaultLocaleName = unsafe extern "system" fn(lplocalename: super::Foundation::PWSTR, cchlocalename: i32) -> i32;
pub type GetUserDefaultUILanguage = unsafe extern "system" fn() -> u16;
pub type GetUserGeoID = unsafe extern "system" fn(geoclass: u32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type GetUserPreferredUILanguages = unsafe extern "system" fn(dwflags: u32, pulnumlanguages: *mut u32, pwszlanguagesbuffer: super::Foundation::PWSTR, pcchlanguagesbuffer: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IdnToAscii = unsafe extern "system" fn(dwflags: u32, lpunicodecharstr: super::Foundation::PWSTR, cchunicodechar: i32, lpasciicharstr: super::Foundation::PWSTR, cchasciichar: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type IdnToNameprepUnicode = unsafe extern "system" fn(dwflags: u32, lpunicodecharstr: super::Foundation::PWSTR, cchunicodechar: i32, lpnameprepcharstr: super::Foundation::PWSTR, cchnameprepchar: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type IdnToUnicode = unsafe extern "system" fn(dwflags: u32, lpasciicharstr: super::Foundation::PWSTR, cchasciichar: i32, lpunicodecharstr: super::Foundation::PWSTR, cchunicodechar: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type IsDBCSLeadByte = unsafe extern "system" fn(testchar: u8) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsDBCSLeadByteEx = unsafe extern "system" fn(codepage: u32, testchar: u8) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsNLSDefinedString = unsafe extern "system" fn(function: u32, dwflags: u32, lpversioninformation: *const NLSVERSIONINFO, lpstring: super::Foundation::PWSTR, cchstr: i32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsNormalizedString = unsafe extern "system" fn(normform: NORM_FORM, lpstring: super::Foundation::PWSTR, cwlength: i32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsTextUnicode = unsafe extern "system" fn(lpv: *const ::core::ffi::c_void, isize: i32, lpiresult: *mut IS_TEXT_UNICODE_RESULT) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsValidCodePage = unsafe extern "system" fn(codepage: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsValidLanguageGroup = unsafe extern "system" fn(languagegroup: u32, dwflags: ENUM_SYSTEM_LANGUAGE_GROUPS_FLAGS) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsValidLocale = unsafe extern "system" fn(locale: u32, dwflags: IS_VALID_LOCALE_FLAGS) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsValidLocaleName = unsafe extern "system" fn(lplocalename: super::Foundation::PWSTR) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsValidNLSVersion = unsafe extern "system" fn(function: u32, lplocalename: super::Foundation::PWSTR, lpversioninformation: *const NLSVERSIONINFOEX) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type IsWellFormedTag = unsafe extern "system" fn(psztag: super::Foundation::PWSTR) -> u8;
#[cfg(feature = "Win32_Foundation")]
pub type LCIDToLocaleName = unsafe extern "system" fn(locale: u32, lpname: super::Foundation::PWSTR, cchname: i32, dwflags: u32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type LCMapStringA = unsafe extern "system" fn(locale: u32, dwmapflags: u32, lpsrcstr: super::Foundation::PSTR, cchsrc: i32, lpdeststr: super::Foundation::PSTR, cchdest: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type LCMapStringEx = unsafe extern "system" fn(lplocalename: super::Foundation::PWSTR, dwmapflags: u32, lpsrcstr: super::Foundation::PWSTR, cchsrc: i32, lpdeststr: super::Foundation::PWSTR, cchdest: i32, lpversioninformation: *const NLSVERSIONINFO, lpreserved: *const ::core::ffi::c_void, sorthandle: super::Foundation::LPARAM) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type LCMapStringW = unsafe extern "system" fn(locale: u32, dwmapflags: u32, lpsrcstr: super::Foundation::PWSTR, cchsrc: i32, lpdeststr: super::Foundation::PWSTR, cchdest: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type LocaleNameToLCID = unsafe extern "system" fn(lpname: super::Foundation::PWSTR, dwflags: u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type MappingDoAction = unsafe extern "system" fn(pbag: *mut MAPPING_PROPERTY_BAG, dwrangeindex: u32, pszactionid: super::Foundation::PWSTR) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
...
#[cfg(feature = "Win32_Foundation")]
pub type MappingRecognizeText = unsafe extern "system" fn(pserviceinfo: *const MAPPING_SERVICE_INFO, psztext: super::Foundation::PWSTR, dwlength: u32, dwindex: u32, poptions: *const MAPPING_OPTIONS, pbag: *mut MAPPING_PROPERTY_BAG) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type MultiByteToWideChar = unsafe extern "system" fn(codepage: u32, dwflags: MULTI_BYTE_TO_WIDE_CHAR_FLAGS, lpmultibytestr: super::Foundation::PSTR, cbmultibyte: i32, lpwidecharstr: super::Foundation::PWSTR, cchwidechar: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type NormalizeString = unsafe extern "system" fn(normform: NORM_FORM, lpsrcstring: super::Foundation::PWSTR, cwsrclength: i32, lpdststring: super::Foundation::PWSTR, cwdstlength: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type NotifyUILanguageChange = unsafe extern "system" fn(dwflags: u32, pcwstrnewlanguage: super::Foundation::PWSTR, pcwstrpreviouslanguage: super::Foundation::PWSTR, dwreserved: u32, pdwstatusrtrn: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type ResolveLocaleName = unsafe extern "system" fn(lpnametoresolve: super::Foundation::PWSTR, lplocalename: super::Foundation::PWSTR, cchlocalename: i32) -> i32;
...
#[cfg(feature = "Win32_Foundation")]
pub type ScriptBreak = unsafe extern "system" fn(pwcchars: super::Foundation::PWSTR, cchars: i32, psa: *const SCRIPT_ANALYSIS, psla: *mut SCRIPT_LOGATTR) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type ScriptCPtoX = unsafe extern "system" fn(icp: i32, ftrailing: super::Foundation::BOOL, cchars: i32, cglyphs: i32, pwlogclust: *const u16, psva: *const SCRIPT_VISATTR, piadvance: *const i32, psa: *const SCRIPT_ANALYSIS, pix: *mut i32) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
pub type ScriptGetCMap = unsafe extern "system" fn(hdc: super::Graphics::Gdi::HDC, psc: *mut *mut ::core::ffi::c_void, pwcinchars: super::Foundation::PWSTR, cchars: i32, dwflags: u32, pwoutglyphs: *mut u16) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Foundation")]
pub type ScriptIsComplex = unsafe extern "system" fn(pwcinchars: super::Foundation::PWSTR, cinchars: i32, dwflags: SCRIPT_IS_COMPLEX_FLAGS) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type ScriptItemize = unsafe extern "system" fn(pwcinchars: super::Foundation::PWSTR, cinchars: i32, cmaxitems: i32, pscontrol: *const SCRIPT_CONTROL, psstate: *const SCRIPT_STATE, pitems: *mut SCRIPT_ITEM, pcitems: *mut i32) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type ScriptItemizeOpenType = unsafe extern "system" fn(pwcinchars: super::Foundation::PWSTR, cinchars: i32, cmaxitems: i32, pscontrol: *const SCRIPT_CONTROL, psstate: *const SCRIPT_STATE, pitems: *mut SCRIPT_ITEM, pscripttags: *mut u32, pcitems: *mut i32) -> ::windows_sys::core::HRESULT;
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Graphics_Gdi"))]
pub type ScriptPlaceOpenType = unsafe extern "system" fn(
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Graphics_Gdi"))]
pub type ScriptShape = unsafe extern "system" fn(hdc: super::Graphics::Gdi::HDC, psc: *mut *mut ::core::ffi::c_void, pwcchars: super::Foundation::PWSTR, cchars: i32, cmaxglyphs: i32, psa: *mut SCRIPT_ANALYSIS, pwoutglyphs: *mut u16, pwlogclust: *mut u16, psva: *mut SCRIPT_VISATTR, pcglyphs: *mut i32) -> ::windows_sys::core::HRESULT;
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Graphics_Gdi"))]
pub type ScriptShapeOpenType =
    unsafe extern "system" fn(hdc: super::Graphics::Gdi::HDC, psc: *mut *mut ::core::ffi::c_void, psa: *mut SCRIPT_ANALYSIS, tagscript: u32, taglangsys: u32, rcrangechars: *const i32, rprangeproperties: *const *const textrange_properties, cranges: i32, pwcchars: super::Foundation::PWSTR, cchars: i32, cmaxglyphs: i32, pwlogclust: *mut u16, pcharprops: *mut script_charprop, pwoutglyphs: *mut u16, poutglyphprops: *mut script_glyphprop, pcglyphs: *mut i32) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Graphics_Gdi")]
...
#[cfg(feature = "Win32_Foundation")]
pub type ScriptStringCPtoX = unsafe extern "system" fn(ssa: *const ::core::ffi::c_void, icp: i32, ftrailing: super::Foundation::BOOL, px: *mut i32) -> ::windows_sys::core::HRESULT;
...
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Graphics_Gdi"))]
pub type ScriptStringOut = unsafe extern "system" fn(ssa: *const ::core::ffi::c_void, ix: i32, iy: i32, uoptions: super::Graphics::Gdi::ETO_OPTIONS, prc: *const super::Foundation::RECT, iminsel: i32, imaxsel: i32, fdisabled: super::Foundation::BOOL) -> ::windows_sys::core::HRESULT;
...
#[cfg(feature = "Win32_Foundation")]
pub type SetCalendarInfoA = unsafe extern "system" fn(locale: u32, calendar: u32, caltype: u32, lpcaldata: super::Foundation::PSTR) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetCalendarInfoW = unsafe extern "system" fn(locale: u32, calendar: u32, caltype: u32, lpcaldata: super::Foundation::PWSTR) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetLocaleInfoA = unsafe extern "system" fn(locale: u32, lctype: u32, lplcdata: super::Foundation::PSTR) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetLocaleInfoW = unsafe extern "system" fn(locale: u32, lctype: u32, lplcdata: super::Foundation::PWSTR) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetProcessPreferredUILanguages = unsafe extern "system" fn(dwflags: u32, pwszlanguagesbuffer: super::Foundation::PWSTR, pulnumlanguages: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetThreadLocale = unsafe extern "system" fn(locale: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetThreadPreferredUILanguages = unsafe extern "system" fn(dwflags: u32, pwszlanguagesbuffer: super::Foundation::PWSTR, pulnumlanguages: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetThreadPreferredUILanguages2 = unsafe extern "system" fn(flags: u32, languages: super::Foundation::PWSTR, numlanguagesset: *mut u32, snapshot: *mut HSAVEDUILANGUAGES) -> super::Foundation::BOOL;
pub type SetThreadUILanguage = unsafe extern "system" fn(langid: u16) -> u16;
#[cfg(feature = "Win32_Foundation")]
pub type SetUserGeoID = unsafe extern "system" fn(geoid: i32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetUserGeoName = unsafe extern "system" fn(geoname: super::Foundation::PWSTR) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type TranslateCharsetInfo = unsafe extern "system" fn(lpsrc: *mut u32, lpcs: *mut CHARSETINFO, dwflags: TRANSLATE_CHARSET_INFO_FLAGS) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type UCNV_FROM_U_CALLBACK_ESCAPE = unsafe extern "system" fn(context: *const ::core::ffi::c_void, fromuargs: *mut UConverterFromUnicodeArgs, codeunits: *const u16, length: i32, codepoint: i32, reason: UConverterCallbackReason, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type UCNV_FROM_U_CALLBACK_SKIP = unsafe extern "system" fn(context: *const ::core::ffi::c_void, fromuargs: *mut UConverterFromUnicodeArgs, codeunits: *const u16, length: i32, codepoint: i32, reason: UConverterCallbackReason, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type UCNV_FROM_U_CALLBACK_STOP = unsafe extern "system" fn(context: *const ::core::ffi::c_void, fromuargs: *mut UConverterFromUnicodeArgs, codeunits: *const u16, length: i32, codepoint: i32, reason: UConverterCallbackReason, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type UCNV_FROM_U_CALLBACK_SUBSTITUTE = unsafe extern "system" fn(context: *const ::core::ffi::c_void, fromuargs: *mut UConverterFromUnicodeArgs, codeunits: *const u16, length: i32, codepoint: i32, reason: UConverterCallbackReason, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type UCNV_TO_U_CALLBACK_ESCAPE = unsafe extern "system" fn(context: *const ::core::ffi::c_void, touargs: *mut UConverterToUnicodeArgs, codeunits: super::Foundation::PSTR, length: i32, reason: UConverterCallbackReason, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type UCNV_TO_U_CALLBACK_SKIP = unsafe extern "system" fn(context: *const ::core::ffi::c_void, touargs: *mut UConverterToUnicodeArgs, codeunits: super::Foundation::PSTR, length: i32, reason: UConverterCallbackReason, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type UCNV_TO_U_CALLBACK_STOP = unsafe extern "system" fn(context: *const ::core::ffi::c_void, touargs: *mut UConverterToUnicodeArgs, codeunits: super::Foundation::PSTR, length: i32, reason: UConverterCallbackReason, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type UCNV_TO_U_CALLBACK_SUBSTITUTE = unsafe extern "system" fn(context: *const ::core::ffi::c_void, touargs: *mut UConverterToUnicodeArgs, codeunits: super::Foundation::PSTR, length: i32, reason: UConverterCallbackReason, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type VerifyScripts = unsafe extern "system" fn(dwflags: u32, lplocalescripts: super::Foundation::PWSTR, cchlocalescripts: i32, lptestscripts: super::Foundation::PWSTR, cchtestscripts: i32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type WideCharToMultiByte = unsafe extern "system" fn(codepage: u32, dwflags: u32, lpwidecharstr: super::Foundation::PWSTR, cchwidechar: i32, lpmultibytestr: super::Foundation::PSTR, cbmultibyte: i32, lpdefaultchar: super::Foundation::PSTR, lpuseddefaultchar: *mut i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type lstrcatA = unsafe extern "system" fn(lpstring1: super::Foundation::PSTR, lpstring2: super::Foundation::PSTR) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type lstrcatW = unsafe extern "system" fn(lpstring1: super::Foundation::PWSTR, lpstring2: super::Foundation::PWSTR) -> super::Foundation::PWSTR;
#[cfg(feature = "Win32_Foundation")]
pub type lstrcmpA = unsafe extern "system" fn(lpstring1: super::Foundation::PSTR, lpstring2: super::Foundation::PSTR) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type lstrcmpW = unsafe extern "system" fn(lpstring1: super::Foundation::PWSTR, lpstring2: super::Foundation::PWSTR) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type lstrcmpiA = unsafe extern "system" fn(lpstring1: super::Foundation::PSTR, lpstring2: super::Foundation::PSTR) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type lstrcmpiW = unsafe extern "system" fn(lpstring1: super::Foundation::PWSTR, lpstring2: super::Foundation::PWSTR) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type lstrcpyA = unsafe extern "system" fn(lpstring1: super::Foundation::PSTR, lpstring2: super::Foundation::PSTR) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type lstrcpyW = unsafe extern "system" fn(lpstring1: super::Foundation::PWSTR, lpstring2: super::Foundation::PWSTR) -> super::Foundation::PWSTR;
#[cfg(feature = "Win32_Foundation")]
pub type lstrcpynA = unsafe extern "system" fn(lpstring1: super::Foundation::PSTR, lpstring2: super::Foundation::PSTR, imaxlength: i32) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type lstrcpynW = unsafe extern "system" fn(lpstring1: super::Foundation::PWSTR, lpstring2: super::Foundation::PWSTR, imaxlength: i32) -> super::Foundation::PWSTR;
#[cfg(feature = "Win32_Foundation")]
pub type lstrlenA = unsafe extern "system" fn(lpstring: super::Foundation::PSTR) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type lstrlenW = unsafe extern "system" fn(lpstring: super::Foundation::PWSTR) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type u_UCharsToChars = unsafe extern "system" fn(us: *const u16, cs: super::Foundation::PSTR, length: i32);
#[cfg(feature = "Win32_Foundation")]
pub type u_austrcpy = unsafe extern "system" fn(dst: super::Foundation::PSTR, src: *const u16) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type u_austrncpy = unsafe extern "system" fn(dst: super::Foundation::PSTR, src: *const u16, n: i32) -> super::Foundation::PSTR;
pub type u_catclose = unsafe extern "system" fn(catd: *mut UResourceBundle);
pub type u_catgets = unsafe extern "system" fn(catd: *mut UResourceBundle, set_num: i32, msg_num: i32, s: *const u16, len: *mut i32, ec: *mut UErrorCode) -> *mut u16;
#[cfg(feature = "Win32_Foundation")]
pub type u_catopen = unsafe extern "system" fn(name: super::Foundation::PSTR, locale: super::Foundation::PSTR, ec: *mut UErrorCode) -> *mut UResourceBundle;
pub type u_charAge = unsafe extern "system" fn(c: i32, versionarray: *mut u8);
pub type u_charDigitValue = unsafe extern "system" fn(c: i32) -> i32;
pub type u_charDirection = unsafe extern "system" fn(c: i32) -> UCharDirection;
#[cfg(feature = "Win32_Foundation")]
pub type u_charFromName = unsafe extern "system" fn(namechoice: UCharNameChoice, name: super::Foundation::PSTR, perrorcode: *mut UErrorCode) -> i32;
pub type u_charMirror = unsafe extern "system" fn(c: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type u_charName = unsafe extern "system" fn(code: i32, namechoice: UCharNameChoice, buffer: super::Foundation::PSTR, bufferlength: i32, perrorcode: *mut UErrorCode) -> i32;
pub type u_charType = unsafe extern "system" fn(c: i32) -> i8;
#[cfg(feature = "Win32_Foundation")]
pub type u_charsToUChars = unsafe extern "system" fn(cs: super::Foundation::PSTR, us: *mut u16, length: i32);
pub type u_cleanup = unsafe extern "system" fn();
pub type u_countChar32 = unsafe extern "system" fn(s: *const u16, length: i32) -> i32;
pub type u_digit = unsafe extern "system" fn(ch: i32, radix: i8) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type u_enumCharNames = unsafe extern "system" fn(start: i32, limit: i32, r#fn: *mut UEnumCharNamesFn, context: *mut ::core::ffi::c_void, namechoice: UCharNameChoice, perrorcode: *mut UErrorCode);
pub type u_enumCharTypes = unsafe extern "system" fn(enumrange: *mut UCharEnumTypeRange, context: *const ::core::ffi::c_void);
#[cfg(feature = "Win32_Foundation")]
pub type u_errorName = unsafe extern "system" fn(code: UErrorCode) -> super::Foundation::PSTR;
pub type u_foldCase = unsafe extern "system" fn(c: i32, options: u32) -> i32;
pub type u_forDigit = unsafe extern "system" fn(digit: i32, radix: i8) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type u_formatMessage = unsafe extern "system" fn(locale: super::Foundation::PSTR, pattern: *const u16, patternlength: i32, result: *mut u16, resultlength: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type u_formatMessageWithError = unsafe extern "system" fn(locale: super::Foundation::PSTR, pattern: *const u16, patternlength: i32, result: *mut u16, resultlength: i32, parseerror: *mut UParseError, status: *mut UErrorCode) -> i32;
pub type u_getBidiPairedBracket = unsafe extern "system" fn(c: i32) -> i32;
pub type u_getBinaryPropertySet = unsafe extern "system" fn(property: UProperty, perrorcode: *mut UErrorCode) -> *mut USet;
pub type u_getCombiningClass = unsafe extern "system" fn(c: i32) -> u8;
pub type u_getDataVersion = unsafe extern "system" fn(dataversionfillin: *mut u8, status: *mut UErrorCode);
pub type u_getFC_NFKC_Closure = unsafe extern "system" fn(c: i32, dest: *mut u16, destcapacity: i32, perrorcode: *mut UErrorCode) -> i32;
pub type u_getIntPropertyMap = unsafe extern "system" fn(property: UProperty, perrorcode: *mut UErrorCode) -> *mut UCPMap;
pub type u_getIntPropertyMaxValue = unsafe extern "system" fn(which: UProperty) -> i32;
pub type u_getIntPropertyMinValue = unsafe extern "system" fn(which: UProperty) -> i32;
pub type u_getIntPropertyValue = unsafe extern "system" fn(c: i32, which: UProperty) -> i32;
pub type u_getNumericValue = unsafe extern "system" fn(c: i32) -> f64;
#[cfg(feature = "Win32_Foundation")]
pub type u_getPropertyEnum = unsafe extern "system" fn(alias: super::Foundation::PSTR) -> UProperty;
#[cfg(feature = "Win32_Foundation")]
pub type u_getPropertyName = unsafe extern "system" fn(property: UProperty, namechoice: UPropertyNameChoice) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type u_getPropertyValueEnum = unsafe extern "system" fn(property: UProperty, alias: super::Foundation::PSTR) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type u_getPropertyValueName = unsafe extern "system" fn(property: UProperty, value: i32, namechoice: UPropertyNameChoice) -> super::Foundation::PSTR;
pub type u_getUnicodeVersion = unsafe extern "system" fn(versionarray: *mut u8);
pub type u_getVersion = unsafe extern "system" fn(versionarray: *mut u8);
pub type u_hasBinaryProperty = unsafe extern "system" fn(c: i32, which: UProperty) -> i8;
pub type u_init = unsafe extern "system" fn(status: *mut UErrorCode);
pub type u_isIDIgnorable = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isIDPart = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isIDStart = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isISOControl = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isJavaIDPart = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isJavaIDStart = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isJavaSpaceChar = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isMirrored = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isUAlphabetic = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isULowercase = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isUUppercase = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isUWhiteSpace = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isWhitespace = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isalnum = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isalpha = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isbase = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isblank = unsafe extern "system" fn(c: i32) -> i8;
pub type u_iscntrl = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isdefined = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isdigit = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isgraph = unsafe extern "system" fn(c: i32) -> i8;
pub type u_islower = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isprint = unsafe extern "system" fn(c: i32) -> i8;
pub type u_ispunct = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isspace = unsafe extern "system" fn(c: i32) -> i8;
pub type u_istitle = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isupper = unsafe extern "system" fn(c: i32) -> i8;
pub type u_isxdigit = unsafe extern "system" fn(c: i32) -> i8;
pub type u_memcasecmp = unsafe extern "system" fn(s1: *const u16, s2: *const u16, length: i32, options: u32) -> i32;
pub type u_memchr = unsafe extern "system" fn(s: *const u16, c: u16, count: i32) -> *mut u16;
pub type u_memchr32 = unsafe extern "system" fn(s: *const u16, c: i32, count: i32) -> *mut u16;
pub type u_memcmp = unsafe extern "system" fn(buf1: *const u16, buf2: *const u16, count: i32) -> i32;
pub type u_memcmpCodePointOrder = unsafe extern "system" fn(s1: *const u16, s2: *const u16, count: i32) -> i32;
pub type u_memcpy = unsafe extern "system" fn(dest: *mut u16, src: *const u16, count: i32) -> *mut u16;
pub type u_memmove = unsafe extern "system" fn(dest: *mut u16, src: *const u16, count: i32) -> *mut u16;
pub type u_memrchr = unsafe extern "system" fn(s: *const u16, c: u16, count: i32) -> *mut u16;
pub type u_memrchr32 = unsafe extern "system" fn(s: *const u16, c: i32, count: i32) -> *mut u16;
pub type u_memset = unsafe extern "system" fn(dest: *mut u16, c: u16, count: i32) -> *mut u16;
#[cfg(feature = "Win32_Foundation")]
pub type u_parseMessage = unsafe extern "system" fn(locale: super::Foundation::PSTR, pattern: *const u16, patternlength: i32, source: *const u16, sourcelength: i32, status: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type u_parseMessageWithError = unsafe extern "system" fn(locale: super::Foundation::PSTR, pattern: *const u16, patternlength: i32, source: *const u16, sourcelength: i32, parseerror: *mut UParseError, status: *mut UErrorCode);
pub type u_setMemoryFunctions = unsafe extern "system" fn(context: *const ::core::ffi::c_void, a: *mut UMemAllocFn, r: *mut UMemReallocFn, f: *mut UMemFreeFn, status: *mut UErrorCode);
pub type u_shapeArabic = unsafe extern "system" fn(source: *const u16, sourcelength: i32, dest: *mut u16, destsize: i32, options: u32, perrorcode: *mut UErrorCode) -> i32;
pub type u_strCaseCompare = unsafe extern "system" fn(s1: *const u16, length1: i32, s2: *const u16, length2: i32, options: u32, perrorcode: *mut UErrorCode) -> i32;
pub type u_strCompare = unsafe extern "system" fn(s1: *const u16, length1: i32, s2: *const u16, length2: i32, codepointorder: i8) -> i32;
pub type u_strCompareIter = unsafe extern "system" fn(iter1: *mut UCharIterator, iter2: *mut UCharIterator, codepointorder: i8) -> i32;
pub type u_strFindFirst = unsafe extern "system" fn(s: *const u16, length: i32, substring: *const u16, sublength: i32) -> *mut u16;
pub type u_strFindLast = unsafe extern "system" fn(s: *const u16, length: i32, substring: *const u16, sublength: i32) -> *mut u16;
pub type u_strFoldCase = unsafe extern "system" fn(dest: *mut u16, destcapacity: i32, src: *const u16, srclength: i32, options: u32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type u_strFromJavaModifiedUTF8WithSub = unsafe extern "system" fn(dest: *mut u16, destcapacity: i32, pdestlength: *mut i32, src: super::Foundation::PSTR, srclength: i32, subchar: i32, pnumsubstitutions: *mut i32, perrorcode: *mut UErrorCode) -> *mut u16;
pub type u_strFromUTF32 = unsafe extern "system" fn(dest: *mut u16, destcapacity: i32, pdestlength: *mut i32, src: *const i32, srclength: i32, perrorcode: *mut UErrorCode) -> *mut u16;
pub type u_strFromUTF32WithSub = unsafe extern "system" fn(dest: *mut u16, destcapacity: i32, pdestlength: *mut i32, src: *const i32, srclength: i32, subchar: i32, pnumsubstitutions: *mut i32, perrorcode: *mut UErrorCode) -> *mut u16;
#[cfg(feature = "Win32_Foundation")]
pub type u_strFromUTF8 = unsafe extern "system" fn(dest: *mut u16, destcapacity: i32, pdestlength: *mut i32, src: super::Foundation::PSTR, srclength: i32, perrorcode: *mut UErrorCode) -> *mut u16;
#[cfg(feature = "Win32_Foundation")]
pub type u_strFromUTF8Lenient = unsafe extern "system" fn(dest: *mut u16, destcapacity: i32, pdestlength: *mut i32, src: super::Foundation::PSTR, srclength: i32, perrorcode: *mut UErrorCode) -> *mut u16;
#[cfg(feature = "Win32_Foundation")]
pub type u_strFromUTF8WithSub = unsafe extern "system" fn(dest: *mut u16, destcapacity: i32, pdestlength: *mut i32, src: super::Foundation::PSTR, srclength: i32, subchar: i32, pnumsubstitutions: *mut i32, perrorcode: *mut UErrorCode) -> *mut u16;
#[cfg(feature = "Win32_Foundation")]
pub type u_strFromWCS = unsafe extern "system" fn(dest: *mut u16, destcapacity: i32, pdestlength: *mut i32, src: super::Foundation::PWSTR, srclength: i32, perrorcode: *mut UErrorCode) -> *mut u16;
pub type u_strHasMoreChar32Than = unsafe extern "system" fn(s: *const u16, length: i32, number: i32) -> i8;
#[cfg(feature = "Win32_Foundation")]
pub type u_strToJavaModifiedUTF8 = unsafe extern "system" fn(dest: super::Foundation::PSTR, destcapacity: i32, pdestlength: *mut i32, src: *const u16, srclength: i32, perrorcode: *mut UErrorCode) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type u_strToLower = unsafe extern "system" fn(dest: *mut u16, destcapacity: i32, src: *const u16, srclength: i32, locale: super::Foundation::PSTR, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type u_strToTitle = unsafe extern "system" fn(dest: *mut u16, destcapacity: i32, src: *const u16, srclength: i32, titleiter: *mut UBreakIterator, locale: super::Foundation::PSTR, perrorcode: *mut UErrorCode) -> i32;
pub type u_strToUTF32 = unsafe extern "system" fn(dest: *mut i32, destcapacity: i32, pdestlength: *mut i32, src: *const u16, srclength: i32, perrorcode: *mut UErrorCode) -> *mut i32;
pub type u_strToUTF32WithSub = unsafe extern "system" fn(dest: *mut i32, destcapacity: i32, pdestlength: *mut i32, src: *const u16, srclength: i32, subchar: i32, pnumsubstitutions: *mut i32, perrorcode: *mut UErrorCode) -> *mut i32;
#[cfg(feature = "Win32_Foundation")]
pub type u_strToUTF8 = unsafe extern "system" fn(dest: super::Foundation::PSTR, destcapacity: i32, pdestlength: *mut i32, src: *const u16, srclength: i32, perrorcode: *mut UErrorCode) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type u_strToUTF8WithSub = unsafe extern "system" fn(dest: super::Foundation::PSTR, destcapacity: i32, pdestlength: *mut i32, src: *const u16, srclength: i32, subchar: i32, pnumsubstitutions: *mut i32, perrorcode: *mut UErrorCode) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type u_strToUpper = unsafe extern "system" fn(dest: *mut u16, destcapacity: i32, src: *const u16, srclength: i32, locale: super::Foundation::PSTR, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type u_strToWCS = unsafe extern "system" fn(dest: super::Foundation::PWSTR, destcapacity: i32, pdestlength: *mut i32, src: *const u16, srclength: i32, perrorcode: *mut UErrorCode) -> super::Foundation::PWSTR;
pub type u_strcasecmp = unsafe extern "system" fn(s1: *const u16, s2: *const u16, options: u32) -> i32;
pub type u_strcat = unsafe extern "system" fn(dst: *mut u16, src: *const u16) -> *mut u16;
pub type u_strchr = unsafe extern "system" fn(s: *const u16, c: u16) -> *mut u16;
pub type u_strchr32 = unsafe extern "system" fn(s: *const u16, c: i32) -> *mut u16;
pub type u_strcmp = unsafe extern "system" fn(s1: *const u16, s2: *const u16) -> i32;
pub type u_strcmpCodePointOrder = unsafe extern "system" fn(s1: *const u16, s2: *const u16) -> i32;
pub type u_strcpy = unsafe extern "system" fn(dst: *mut u16, src: *const u16) -> *mut u16;
pub type u_strcspn = unsafe extern "system" fn(string: *const u16, matchset: *const u16) -> i32;
pub type u_strlen = unsafe extern "system" fn(s: *const u16) -> i32;
pub type u_strncasecmp = unsafe extern "system" fn(s1: *const u16, s2: *const u16, n: i32, options: u32) -> i32;
pub type u_strncat = unsafe extern "system" fn(dst: *mut u16, src: *const u16, n: i32) -> *mut u16;
pub type u_strncmp = unsafe extern "system" fn(ucs1: *const u16, ucs2: *const u16, n: i32) -> i32;
pub type u_strncmpCodePointOrder = unsafe extern "system" fn(s1: *const u16, s2: *const u16, n: i32) -> i32;
pub type u_strncpy = unsafe extern "system" fn(dst: *mut u16, src: *const u16, n: i32) -> *mut u16;
pub type u_strpbrk = unsafe extern "system" fn(string: *const u16, matchset: *const u16) -> *mut u16;
pub type u_strrchr = unsafe extern "system" fn(s: *const u16, c: u16) -> *mut u16;
pub type u_strrchr32 = unsafe extern "system" fn(s: *const u16, c: i32) -> *mut u16;
pub type u_strrstr = unsafe extern "system" fn(s: *const u16, substring: *const u16) -> *mut u16;
pub type u_strspn = unsafe extern "system" fn(string: *const u16, matchset: *const u16) -> i32;
pub type u_strstr = unsafe extern "system" fn(s: *const u16, substring: *const u16) -> *mut u16;
pub type u_strtok_r = unsafe extern "system" fn(src: *mut u16, delim: *const u16, savestate: *mut *mut u16) -> *mut u16;
pub type u_tolower = unsafe extern "system" fn(c: i32) -> i32;
pub type u_totitle = unsafe extern "system" fn(c: i32) -> i32;
pub type u_toupper = unsafe extern "system" fn(c: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type u_uastrcpy = unsafe extern "system" fn(dst: *mut u16, src: super::Foundation::PSTR) -> *mut u16;
#[cfg(feature = "Win32_Foundation")]
pub type u_uastrncpy = unsafe extern "system" fn(dst: *mut u16, src: super::Foundation::PSTR, n: i32) -> *mut u16;
#[cfg(feature = "Win32_Foundation")]
pub type u_unescape = unsafe extern "system" fn(src: super::Foundation::PSTR, dest: *mut u16, destcapacity: i32) -> i32;
pub type u_unescapeAt = unsafe extern "system" fn(charat: UNESCAPE_CHAR_AT, offset: *mut i32, length: i32, context: *mut ::core::ffi::c_void) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type u_versionFromString = unsafe extern "system" fn(versionarray: *mut u8, versionstring: super::Foundation::PSTR);
pub type u_versionFromUString = unsafe extern "system" fn(versionarray: *mut u8, versionstring: *const u16);
#[cfg(feature = "Win32_Foundation")]
pub type u_versionToString = unsafe extern "system" fn(versionarray: *const u8, versionstring: super::Foundation::PSTR);
#[cfg(feature = "Win32_Foundation")]
pub type u_vformatMessage = unsafe extern "system" fn(locale: super::Foundation::PSTR, pattern: *const u16, patternlength: i32, result: *mut u16, resultlength: i32, ap: *mut i8, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type u_vformatMessageWithError = unsafe extern "system" fn(locale: super::Foundation::PSTR, pattern: *const u16, patternlength: i32, result: *mut u16, resultlength: i32, parseerror: *mut UParseError, ap: *mut i8, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type u_vparseMessage = unsafe extern "system" fn(locale: super::Foundation::PSTR, pattern: *const u16, patternlength: i32, source: *const u16, sourcelength: i32, ap: *mut i8, status: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type u_vparseMessageWithError = unsafe extern "system" fn(locale: super::Foundation::PSTR, pattern: *const u16, patternlength: i32, source: *const u16, sourcelength: i32, ap: *mut i8, parseerror: *mut UParseError, status: *mut UErrorCode);
pub type ubidi_close = unsafe extern "system" fn(pbidi: *mut UBiDi);
pub type ubidi_countParagraphs = unsafe extern "system" fn(pbidi: *mut UBiDi) -> i32;
pub type ubidi_countRuns = unsafe extern "system" fn(pbidi: *mut UBiDi, perrorcode: *mut UErrorCode) -> i32;
pub type ubidi_getBaseDirection = unsafe extern "system" fn(text: *const u16, length: i32) -> UBiDiDirection;
pub type ubidi_getClassCallback = unsafe extern "system" fn(pbidi: *mut UBiDi, r#fn: *mut UBiDiClassCallback, context: *const *const ::core::ffi::c_void);
pub type ubidi_getCustomizedClass = unsafe extern "system" fn(pbidi: *mut UBiDi, c: i32) -> UCharDirection;
pub type ubidi_getDirection = unsafe extern "system" fn(pbidi: *const UBiDi) -> UBiDiDirection;
pub type ubidi_getLength = unsafe extern "system" fn(pbidi: *const UBiDi) -> i32;
pub type ubidi_getLevelAt = unsafe extern "system" fn(pbidi: *const UBiDi, charindex: i32) -> u8;
pub type ubidi_getLevels = unsafe extern "system" fn(pbidi: *mut UBiDi, perrorcode: *mut UErrorCode) -> *mut u8;
pub type ubidi_getLogicalIndex = unsafe extern "system" fn(pbidi: *mut UBiDi, visualindex: i32, perrorcode: *mut UErrorCode) -> i32;
pub type ubidi_getLogicalMap = unsafe extern "system" fn(pbidi: *mut UBiDi, indexmap: *mut i32, perrorcode: *mut UErrorCode);
pub type ubidi_getLogicalRun = unsafe extern "system" fn(pbidi: *const UBiDi, logicalposition: i32, plogicallimit: *mut i32, plevel: *mut u8);
pub type ubidi_getParaLevel = unsafe extern "system" fn(pbidi: *const UBiDi) -> u8;
pub type ubidi_getParagraph = unsafe extern "system" fn(pbidi: *const UBiDi, charindex: i32, pparastart: *mut i32, pparalimit: *mut i32, pparalevel: *mut u8, perrorcode: *mut UErrorCode) -> i32;
pub type ubidi_getParagraphByIndex = unsafe extern "system" fn(pbidi: *const UBiDi, paraindex: i32, pparastart: *mut i32, pparalimit: *mut i32, pparalevel: *mut u8, perrorcode: *mut UErrorCode);
pub type ubidi_getProcessedLength = unsafe extern "system" fn(pbidi: *const UBiDi) -> i32;
pub type ubidi_getReorderingMode = unsafe extern "system" fn(pbidi: *mut UBiDi) -> UBiDiReorderingMode;
pub type ubidi_getReorderingOptions = unsafe extern "system" fn(pbidi: *mut UBiDi) -> u32;
pub type ubidi_getResultLength = unsafe extern "system" fn(pbidi: *const UBiDi) -> i32;
pub type ubidi_getText = unsafe extern "system" fn(pbidi: *const UBiDi) -> *mut u16;
pub type ubidi_getVisualIndex = unsafe extern "system" fn(pbidi: *mut UBiDi, logicalindex: i32, perrorcode: *mut UErrorCode) -> i32;
pub type ubidi_getVisualMap = unsafe extern "system" fn(pbidi: *mut UBiDi, indexmap: *mut i32, perrorcode: *mut UErrorCode);
pub type ubidi_getVisualRun = unsafe extern "system" fn(pbidi: *mut UBiDi, runindex: i32, plogicalstart: *mut i32, plength: *mut i32) -> UBiDiDirection;
pub type ubidi_invertMap = unsafe extern "system" fn(srcmap: *const i32, destmap: *mut i32, length: i32);
pub type ubidi_isInverse = unsafe extern "system" fn(pbidi: *mut UBiDi) -> i8;
pub type ubidi_isOrderParagraphsLTR = unsafe extern "system" fn(pbidi: *mut UBiDi) -> i8;
pub type ubidi_open = unsafe extern "system" fn() -> *mut UBiDi;
pub type ubidi_openSized = unsafe extern "system" fn(maxlength: i32, maxruncount: i32, perrorcode: *mut UErrorCode) -> *mut UBiDi;
pub type ubidi_orderParagraphsLTR = unsafe extern "system" fn(pbidi: *mut UBiDi, orderparagraphsltr: i8);
pub type ubidi_reorderLogical = unsafe extern "system" fn(levels: *const u8, length: i32, indexmap: *mut i32);
pub type ubidi_reorderVisual = unsafe extern "system" fn(levels: *const u8, length: i32, indexmap: *mut i32);
pub type ubidi_setClassCallback = unsafe extern "system" fn(pbidi: *mut UBiDi, newfn: UBiDiClassCallback, newcontext: *const ::core::ffi::c_void, oldfn: *mut UBiDiClassCallback, oldcontext: *const *const ::core::ffi::c_void, perrorcode: *mut UErrorCode);
pub type ubidi_setContext = unsafe extern "system" fn(pbidi: *mut UBiDi, prologue: *const u16, prolength: i32, epilogue: *const u16, epilength: i32, perrorcode: *mut UErrorCode);
pub type ubidi_setInverse = unsafe extern "system" fn(pbidi: *mut UBiDi, isinverse: i8);
pub type ubidi_setLine = unsafe extern "system" fn(pparabidi: *const UBiDi, start: i32, limit: i32, plinebidi: *mut UBiDi, perrorcode: *mut UErrorCode);
pub type ubidi_setPara = unsafe extern "system" fn(pbidi: *mut UBiDi, text: *const u16, length: i32, paralevel: u8, embeddinglevels: *mut u8, perrorcode: *mut UErrorCode);
pub type ubidi_setReorderingMode = unsafe extern "system" fn(pbidi: *mut UBiDi, reorderingmode: UBiDiReorderingMode);
pub type ubidi_setReorderingOptions = unsafe extern "system" fn(pbidi: *mut UBiDi, reorderingoptions: u32);
pub type ubidi_writeReordered = unsafe extern "system" fn(pbidi: *mut UBiDi, dest: *mut u16, destsize: i32, options: u16, perrorcode: *mut UErrorCode) -> i32;
pub type ubidi_writeReverse = unsafe extern "system" fn(src: *const u16, srclength: i32, dest: *mut u16, destsize: i32, options: u16, perrorcode: *mut UErrorCode) -> i32;
pub type ubiditransform_close = unsafe extern "system" fn(pbiditransform: *mut UBiDiTransform);
pub type ubiditransform_open = unsafe extern "system" fn(perrorcode: *mut UErrorCode) -> *mut UBiDiTransform;
pub type ubiditransform_transform = unsafe extern "system" fn(pbiditransform: *mut UBiDiTransform, src: *const u16, srclength: i32, dest: *mut u16, destsize: i32, inparalevel: u8, inorder: UBiDiOrder, outparalevel: u8, outorder: UBiDiOrder, domirroring: UBiDiMirroring, shapingoptions: u32, perrorcode: *mut UErrorCode) -> u32;
pub type ublock_getCode = unsafe extern "system" fn(c: i32) -> UBlockCode;
pub type ubrk_close = unsafe extern "system" fn(bi: *mut UBreakIterator);
pub type ubrk_countAvailable = unsafe extern "system" fn() -> i32;
pub type ubrk_current = unsafe extern "system" fn(bi: *const UBreakIterator) -> i32;
pub type ubrk_first = unsafe extern "system" fn(bi: *mut UBreakIterator) -> i32;
pub type ubrk_following = unsafe extern "system" fn(bi: *mut UBreakIterator, offset: i32) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ubrk_getAvailable = unsafe extern "system" fn(index: i32) -> super::Foundation::PSTR;
pub type ubrk_getBinaryRules = unsafe extern "system" fn(bi: *mut UBreakIterator, binaryrules: *mut u8, rulescapacity: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ubrk_getLocaleByType = unsafe extern "system" fn(bi: *const UBreakIterator, r#type: ULocDataLocaleType, status: *mut UErrorCode) -> super::Foundation::PSTR;
pub type ubrk_getRuleStatus = unsafe extern "system" fn(bi: *mut UBreakIterator) -> i32;
pub type ubrk_getRuleStatusVec = unsafe extern "system" fn(bi: *mut UBreakIterator, fillinvec: *mut i32, capacity: i32, status: *mut UErrorCode) -> i32;
pub type ubrk_isBoundary = unsafe extern "system" fn(bi: *mut UBreakIterator, offset: i32) -> i8;
pub type ubrk_last = unsafe extern "system" fn(bi: *mut UBreakIterator) -> i32;
pub type ubrk_next = unsafe extern "system" fn(bi: *mut UBreakIterator) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ubrk_open = unsafe extern "system" fn(r#type: UBreakIteratorType, locale: super::Foundation::PSTR, text: *const u16, textlength: i32, status: *mut UErrorCode) -> *mut UBreakIterator;
pub type ubrk_openBinaryRules = unsafe extern "system" fn(binaryrules: *const u8, ruleslength: i32, text: *const u16, textlength: i32, status: *mut UErrorCode) -> *mut UBreakIterator;
pub type ubrk_openRules = unsafe extern "system" fn(rules: *const u16, ruleslength: i32, text: *const u16, textlength: i32, parseerr: *mut UParseError, status: *mut UErrorCode) -> *mut UBreakIterator;
pub type ubrk_preceding = unsafe extern "system" fn(bi: *mut UBreakIterator, offset: i32) -> i32;
pub type ubrk_previous = unsafe extern "system" fn(bi: *mut UBreakIterator) -> i32;
pub type ubrk_refreshUText = unsafe extern "system" fn(bi: *mut UBreakIterator, text: *mut UText, status: *mut UErrorCode);
pub type ubrk_safeClone = unsafe extern "system" fn(bi: *const UBreakIterator, stackbuffer: *mut ::core::ffi::c_void, pbuffersize: *mut i32, status: *mut UErrorCode) -> *mut UBreakIterator;
pub type ubrk_setText = unsafe extern "system" fn(bi: *mut UBreakIterator, text: *const u16, textlength: i32, status: *mut UErrorCode);
pub type ubrk_setUText = unsafe extern "system" fn(bi: *mut UBreakIterator, text: *mut UText, status: *mut UErrorCode);
pub type ucal_add = unsafe extern "system" fn(cal: *mut *mut ::core::ffi::c_void, field: UCalendarDateFields, amount: i32, status: *mut UErrorCode);
pub type ucal_clear = unsafe extern "system" fn(calendar: *mut *mut ::core::ffi::c_void);
pub type ucal_clearField = unsafe extern "system" fn(cal: *mut *mut ::core::ffi::c_void, field: UCalendarDateFields);
pub type ucal_clone = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, status: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
pub type ucal_close = unsafe extern "system" fn(cal: *mut *mut ::core::ffi::c_void);
pub type ucal_countAvailable = unsafe extern "system" fn() -> i32;
pub type ucal_equivalentTo = unsafe extern "system" fn(cal1: *const *const ::core::ffi::c_void, cal2: *const *const ::core::ffi::c_void) -> i8;
pub type ucal_get = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, field: UCalendarDateFields, status: *mut UErrorCode) -> i32;
pub type ucal_getAttribute = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, attr: UCalendarAttribute) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucal_getAvailable = unsafe extern "system" fn(localeindex: i32) -> super::Foundation::PSTR;
pub type ucal_getCanonicalTimeZoneID = unsafe extern "system" fn(id: *const u16, len: i32, result: *mut u16, resultcapacity: i32, issystemid: *mut i8, status: *mut UErrorCode) -> i32;
pub type ucal_getDSTSavings = unsafe extern "system" fn(zoneid: *const u16, ec: *mut UErrorCode) -> i32;
pub type ucal_getDayOfWeekType = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, dayofweek: UCalendarDaysOfWeek, status: *mut UErrorCode) -> UCalendarWeekdayType;
pub type ucal_getDefaultTimeZone = unsafe extern "system" fn(result: *mut u16, resultcapacity: i32, ec: *mut UErrorCode) -> i32;
pub type ucal_getFieldDifference = unsafe extern "system" fn(cal: *mut *mut ::core::ffi::c_void, target: f64, field: UCalendarDateFields, status: *mut UErrorCode) -> i32;
pub type ucal_getGregorianChange = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, perrorcode: *mut UErrorCode) -> f64;
pub type ucal_getHostTimeZone = unsafe extern "system" fn(result: *mut u16, resultcapacity: i32, ec: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucal_getKeywordValuesForLocale = unsafe extern "system" fn(key: super::Foundation::PSTR, locale: super::Foundation::PSTR, commonlyused: i8, status: *mut UErrorCode) -> *mut UEnumeration;
pub type ucal_getLimit = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, field: UCalendarDateFields, r#type: UCalendarLimitType, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucal_getLocaleByType = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, r#type: ULocDataLocaleType, status: *mut UErrorCode) -> super::Foundation::PSTR;
pub type ucal_getMillis = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, status: *mut UErrorCode) -> f64;
pub type ucal_getNow = unsafe extern "system" fn() -> f64;
#[cfg(feature = "Win32_Foundation")]
pub type ucal_getTZDataVersion = unsafe extern "system" fn(status: *mut UErrorCode) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type ucal_getTimeZoneDisplayName = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, r#type: UCalendarDisplayNameType, locale: super::Foundation::PSTR, result: *mut u16, resultlength: i32, status: *mut UErrorCode) -> i32;
pub type ucal_getTimeZoneID = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, result: *mut u16, resultlength: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucal_getTimeZoneIDForWindowsID = unsafe extern "system" fn(winid: *const u16, len: i32, region: super::Foundation::PSTR, id: *mut u16, idcapacity: i32, status: *mut UErrorCode) -> i32;
pub type ucal_getTimeZoneTransitionDate = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, r#type: UTimeZoneTransitionType, transition: *mut f64, status: *mut UErrorCode) -> i8;
#[cfg(feature = "Win32_Foundation")]
pub type ucal_getType = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, status: *mut UErrorCode) -> super::Foundation::PSTR;
pub type ucal_getWeekendTransition = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, dayofweek: UCalendarDaysOfWeek, status: *mut UErrorCode) -> i32;
pub type ucal_getWindowsTimeZoneID = unsafe extern "system" fn(id: *const u16, len: i32, winid: *mut u16, winidcapacity: i32, status: *mut UErrorCode) -> i32;
pub type ucal_inDaylightTime = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, status: *mut UErrorCode) -> i8;
pub type ucal_isSet = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, field: UCalendarDateFields) -> i8;
pub type ucal_isWeekend = unsafe extern "system" fn(cal: *const *const ::core::ffi::c_void, date: f64, status: *mut UErrorCode) -> i8;
#[cfg(feature = "Win32_Foundation")]
pub type ucal_open = unsafe extern "system" fn(zoneid: *const u16, len: i32, locale: super::Foundation::PSTR, r#type: UCalendarType, status: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
#[cfg(feature = "Win32_Foundation")]
pub type ucal_openCountryTimeZones = unsafe extern "system" fn(country: super::Foundation::PSTR, ec: *mut UErrorCode) -> *mut UEnumeration;
#[cfg(feature = "Win32_Foundation")]
pub type ucal_openTimeZoneIDEnumeration = unsafe extern "system" fn(zonetype: USystemTimeZoneType, region: super::Foundation::PSTR, rawoffset: *const i32, ec: *mut UErrorCode) -> *mut UEnumeration;
pub type ucal_openTimeZones = unsafe extern "system" fn(ec: *mut UErrorCode) -> *mut UEnumeration;
pub type ucal_roll = unsafe extern "system" fn(cal: *mut *mut ::core::ffi::c_void, field: UCalendarDateFields, amount: i32, status: *mut UErrorCode);
pub type ucal_set = unsafe extern "system" fn(cal: *mut *mut ::core::ffi::c_void, field: UCalendarDateFields, value: i32);
pub type ucal_setAttribute = unsafe extern "system" fn(cal: *mut *mut ::core::ffi::c_void, attr: UCalendarAttribute, newvalue: i32);
pub type ucal_setDate = unsafe extern "system" fn(cal: *mut *mut ::core::ffi::c_void, year: i32, month: i32, date: i32, status: *mut UErrorCode);
pub type ucal_setDateTime = unsafe extern "system" fn(cal: *mut *mut ::core::ffi::c_void, year: i32, month: i32, date: i32, hour: i32, minute: i32, second: i32, status: *mut UErrorCode);
pub type ucal_setDefaultTimeZone = unsafe extern "system" fn(zoneid: *const u16, ec: *mut UErrorCode);
pub type ucal_setGregorianChange = unsafe extern "system" fn(cal: *mut *mut ::core::ffi::c_void, date: f64, perrorcode: *mut UErrorCode);
pub type ucal_setMillis = unsafe extern "system" fn(cal: *mut *mut ::core::ffi::c_void, datetime: f64, status: *mut UErrorCode);
pub type ucal_setTimeZone = unsafe extern "system" fn(cal: *mut *mut ::core::ffi::c_void, zoneid: *const u16, len: i32, status: *mut UErrorCode);
pub type ucasemap_close = unsafe extern "system" fn(csm: *mut UCaseMap);
pub type ucasemap_getBreakIterator = unsafe extern "system" fn(csm: *const UCaseMap) -> *mut UBreakIterator;
#[cfg(feature = "Win32_Foundation")]
pub type ucasemap_getLocale = unsafe extern "system" fn(csm: *const UCaseMap) -> super::Foundation::PSTR;
pub type ucasemap_getOptions = unsafe extern "system" fn(csm: *const UCaseMap) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type ucasemap_open = unsafe extern "system" fn(locale: super::Foundation::PSTR, options: u32, perrorcode: *mut UErrorCode) -> *mut UCaseMap;
pub type ucasemap_setBreakIterator = unsafe extern "system" fn(csm: *mut UCaseMap, itertoadopt: *mut UBreakIterator, perrorcode: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucasemap_setLocale = unsafe extern "system" fn(csm: *mut UCaseMap, locale: super::Foundation::PSTR, perrorcode: *mut UErrorCode);
pub type ucasemap_setOptions = unsafe extern "system" fn(csm: *mut UCaseMap, options: u32, perrorcode: *mut UErrorCode);
pub type ucasemap_toTitle = unsafe extern "system" fn(csm: *mut UCaseMap, dest: *mut u16, destcapacity: i32, src: *const u16, srclength: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucasemap_utf8FoldCase = unsafe extern "system" fn(csm: *const UCaseMap, dest: super::Foundation::PSTR, destcapacity: i32, src: super::Foundation::PSTR, srclength: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucasemap_utf8ToLower = unsafe extern "system" fn(csm: *const UCaseMap, dest: super::Foundation::PSTR, destcapacity: i32, src: super::Foundation::PSTR, srclength: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucasemap_utf8ToTitle = unsafe extern "system" fn(csm: *mut UCaseMap, dest: super::Foundation::PSTR, destcapacity: i32, src: super::Foundation::PSTR, srclength: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucasemap_utf8ToUpper = unsafe extern "system" fn(csm: *const UCaseMap, dest: super::Foundation::PSTR, destcapacity: i32, src: super::Foundation::PSTR, srclength: i32, perrorcode: *mut UErrorCode) -> i32;
pub type ucfpos_close = unsafe extern "system" fn(ucfpos: *mut UConstrainedFieldPosition);
pub type ucfpos_constrainCategory = unsafe extern "system" fn(ucfpos: *mut UConstrainedFieldPosition, category: i32, ec: *mut UErrorCode);
pub type ucfpos_constrainField = unsafe extern "system" fn(ucfpos: *mut UConstrainedFieldPosition, category: i32, field: i32, ec: *mut UErrorCode);
pub type ucfpos_getCategory = unsafe extern "system" fn(ucfpos: *const UConstrainedFieldPosition, ec: *mut UErrorCode) -> i32;
pub type ucfpos_getField = unsafe extern "system" fn(ucfpos: *const UConstrainedFieldPosition, ec: *mut UErrorCode) -> i32;
pub type ucfpos_getIndexes = unsafe extern "system" fn(ucfpos: *const UConstrainedFieldPosition, pstart: *mut i32, plimit: *mut i32, ec: *mut UErrorCode);
pub type ucfpos_getInt64IterationContext = unsafe extern "system" fn(ucfpos: *const UConstrainedFieldPosition, ec: *mut UErrorCode) -> i64;
pub type ucfpos_matchesField = unsafe extern "system" fn(ucfpos: *const UConstrainedFieldPosition, category: i32, field: i32, ec: *mut UErrorCode) -> i8;
pub type ucfpos_open = unsafe extern "system" fn(ec: *mut UErrorCode) -> *mut UConstrainedFieldPosition;
pub type ucfpos_reset = unsafe extern "system" fn(ucfpos: *mut UConstrainedFieldPosition, ec: *mut UErrorCode);
pub type ucfpos_setInt64IterationContext = unsafe extern "system" fn(ucfpos: *mut UConstrainedFieldPosition, context: i64, ec: *mut UErrorCode);
pub type ucfpos_setState = unsafe extern "system" fn(ucfpos: *mut UConstrainedFieldPosition, category: i32, field: i32, start: i32, limit: i32, ec: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_cbFromUWriteBytes = unsafe extern "system" fn(args: *mut UConverterFromUnicodeArgs, source: super::Foundation::PSTR, length: i32, offsetindex: i32, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_cbFromUWriteSub = unsafe extern "system" fn(args: *mut UConverterFromUnicodeArgs, offsetindex: i32, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_cbFromUWriteUChars = unsafe extern "system" fn(args: *mut UConverterFromUnicodeArgs, source: *const *const u16, sourcelimit: *const u16, offsetindex: i32, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_cbToUWriteSub = unsafe extern "system" fn(args: *mut UConverterToUnicodeArgs, offsetindex: i32, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_cbToUWriteUChars = unsafe extern "system" fn(args: *mut UConverterToUnicodeArgs, source: *const u16, length: i32, offsetindex: i32, err: *mut UErrorCode);
pub type ucnv_close = unsafe extern "system" fn(converter: *mut UConverter);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_compareNames = unsafe extern "system" fn(name1: super::Foundation::PSTR, name2: super::Foundation::PSTR) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_convert = unsafe extern "system" fn(toconvertername: super::Foundation::PSTR, fromconvertername: super::Foundation::PSTR, target: super::Foundation::PSTR, targetcapacity: i32, source: super::Foundation::PSTR, sourcelength: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_convertEx = unsafe extern "system" fn(targetcnv: *mut UConverter, sourcecnv: *mut UConverter, target: *mut *mut i8, targetlimit: super::Foundation::PSTR, source: *const *const i8, sourcelimit: super::Foundation::PSTR, pivotstart: *mut u16, pivotsource: *mut *mut u16, pivottarget: *mut *mut u16, pivotlimit: *const u16, reset: i8, flush: i8, perrorcode: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_countAliases = unsafe extern "system" fn(alias: super::Foundation::PSTR, perrorcode: *mut UErrorCode) -> u16;
pub type ucnv_countAvailable = unsafe extern "system" fn() -> i32;
pub type ucnv_countStandards = unsafe extern "system" fn() -> u16;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_detectUnicodeSignature = unsafe extern "system" fn(source: super::Foundation::PSTR, sourcelength: i32, signaturelength: *mut i32, perrorcode: *mut UErrorCode) -> super::Foundation::PSTR;
pub type ucnv_fixFileSeparator = unsafe extern "system" fn(cnv: *const UConverter, source: *mut u16, sourcelen: i32);
pub type ucnv_flushCache = unsafe extern "system" fn() -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_fromAlgorithmic = unsafe extern "system" fn(cnv: *mut UConverter, algorithmictype: UConverterType, target: super::Foundation::PSTR, targetcapacity: i32, source: super::Foundation::PSTR, sourcelength: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_fromUChars = unsafe extern "system" fn(cnv: *mut UConverter, dest: super::Foundation::PSTR, destcapacity: i32, src: *const u16, srclength: i32, perrorcode: *mut UErrorCode) -> i32;
pub type ucnv_fromUCountPending = unsafe extern "system" fn(cnv: *const UConverter, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_fromUnicode = unsafe extern "system" fn(converter: *mut UConverter, target: *mut *mut i8, targetlimit: super::Foundation::PSTR, source: *const *const u16, sourcelimit: *const u16, offsets: *mut i32, flush: i8, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_getAlias = unsafe extern "system" fn(alias: super::Foundation::PSTR, n: u16, perrorcode: *mut UErrorCode) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_getAliases = unsafe extern "system" fn(alias: super::Foundation::PSTR, aliases: *const *const i8, perrorcode: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_getAvailableName = unsafe extern "system" fn(n: i32) -> super::Foundation::PSTR;
pub type ucnv_getCCSID = unsafe extern "system" fn(converter: *const UConverter, err: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_getCanonicalName = unsafe extern "system" fn(alias: super::Foundation::PSTR, standard: super::Foundation::PSTR, perrorcode: *mut UErrorCode) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_getDefaultName = unsafe extern "system" fn() -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_getDisplayName = unsafe extern "system" fn(converter: *const UConverter, displaylocale: super::Foundation::PSTR, displayname: *mut u16, displaynamecapacity: i32, err: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_getFromUCallBack = unsafe extern "system" fn(converter: *const UConverter, action: *mut UConverterFromUCallback, context: *const *const ::core::ffi::c_void);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_getInvalidChars = unsafe extern "system" fn(converter: *const UConverter, errbytes: super::Foundation::PSTR, len: *mut i8, err: *mut UErrorCode);
pub type ucnv_getInvalidUChars = unsafe extern "system" fn(converter: *const UConverter, erruchars: *mut u16, len: *mut i8, err: *mut UErrorCode);
pub type ucnv_getMaxCharSize = unsafe extern "system" fn(converter: *const UConverter) -> i8;
pub type ucnv_getMinCharSize = unsafe extern "system" fn(converter: *const UConverter) -> i8;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_getName = unsafe extern "system" fn(converter: *const UConverter, err: *mut UErrorCode) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_getNextUChar = unsafe extern "system" fn(converter: *mut UConverter, source: *const *const i8, sourcelimit: super::Foundation::PSTR, err: *mut UErrorCode) -> i32;
pub type ucnv_getPlatform = unsafe extern "system" fn(converter: *const UConverter, err: *mut UErrorCode) -> UConverterPlatform;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_getStandard = unsafe extern "system" fn(n: u16, perrorcode: *mut UErrorCode) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_getStandardName = unsafe extern "system" fn(name: super::Foundation::PSTR, standard: super::Foundation::PSTR, perrorcode: *mut UErrorCode) -> super::Foundation::PSTR;
pub type ucnv_getStarters = unsafe extern "system" fn(converter: *const UConverter, starters: *mut i8, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_getSubstChars = unsafe extern "system" fn(converter: *const UConverter, subchars: super::Foundation::PSTR, len: *mut i8, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_getToUCallBack = unsafe extern "system" fn(converter: *const UConverter, action: *mut UConverterToUCallback, context: *const *const ::core::ffi::c_void);
pub type ucnv_getType = unsafe extern "system" fn(converter: *const UConverter) -> UConverterType;
pub type ucnv_getUnicodeSet = unsafe extern "system" fn(cnv: *const UConverter, setfillin: *mut USet, whichset: UConverterUnicodeSet, perrorcode: *mut UErrorCode);
pub type ucnv_isAmbiguous = unsafe extern "system" fn(cnv: *const UConverter) -> i8;
pub type ucnv_isFixedWidth = unsafe extern "system" fn(cnv: *mut UConverter, status: *mut UErrorCode) -> i8;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_open = unsafe extern "system" fn(convertername: super::Foundation::PSTR, err: *mut UErrorCode) -> *mut UConverter;
pub type ucnv_openAllNames = unsafe extern "system" fn(perrorcode: *mut UErrorCode) -> *mut UEnumeration;
pub type ucnv_openCCSID = unsafe extern "system" fn(codepage: i32, platform: UConverterPlatform, err: *mut UErrorCode) -> *mut UConverter;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_openPackage = unsafe extern "system" fn(packagename: super::Foundation::PSTR, convertername: super::Foundation::PSTR, err: *mut UErrorCode) -> *mut UConverter;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_openStandardNames = unsafe extern "system" fn(convname: super::Foundation::PSTR, standard: super::Foundation::PSTR, perrorcode: *mut UErrorCode) -> *mut UEnumeration;
pub type ucnv_openU = unsafe extern "system" fn(name: *const u16, err: *mut UErrorCode) -> *mut UConverter;
pub type ucnv_reset = unsafe extern "system" fn(converter: *mut UConverter);
pub type ucnv_resetFromUnicode = unsafe extern "system" fn(converter: *mut UConverter);
pub type ucnv_resetToUnicode = unsafe extern "system" fn(converter: *mut UConverter);
pub type ucnv_safeClone = unsafe extern "system" fn(cnv: *const UConverter, stackbuffer: *mut ::core::ffi::c_void, pbuffersize: *mut i32, status: *mut UErrorCode) -> *mut UConverter;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_setDefaultName = unsafe extern "system" fn(name: super::Foundation::PSTR);
pub type ucnv_setFallback = unsafe extern "system" fn(cnv: *mut UConverter, usesfallback: i8);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_setFromUCallBack = unsafe extern "system" fn(converter: *mut UConverter, newaction: UConverterFromUCallback, newcontext: *const ::core::ffi::c_void, oldaction: *mut UConverterFromUCallback, oldcontext: *const *const ::core::ffi::c_void, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_setSubstChars = unsafe extern "system" fn(converter: *mut UConverter, subchars: super::Foundation::PSTR, len: i8, err: *mut UErrorCode);
pub type ucnv_setSubstString = unsafe extern "system" fn(cnv: *mut UConverter, s: *const u16, length: i32, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_setToUCallBack = unsafe extern "system" fn(converter: *mut UConverter, newaction: UConverterToUCallback, newcontext: *const ::core::ffi::c_void, oldaction: *mut UConverterToUCallback, oldcontext: *const *const ::core::ffi::c_void, err: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_toAlgorithmic = unsafe extern "system" fn(algorithmictype: UConverterType, cnv: *mut UConverter, target: super::Foundation::PSTR, targetcapacity: i32, source: super::Foundation::PSTR, sourcelength: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_toUChars = unsafe extern "system" fn(cnv: *mut UConverter, dest: *mut u16, destcapacity: i32, src: super::Foundation::PSTR, srclength: i32, perrorcode: *mut UErrorCode) -> i32;
pub type ucnv_toUCountPending = unsafe extern "system" fn(cnv: *const UConverter, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucnv_toUnicode = unsafe extern "system" fn(converter: *mut UConverter, target: *mut *mut u16, targetlimit: *const u16, source: *const *const i8, sourcelimit: super::Foundation::PSTR, offsets: *mut i32, flush: i8, err: *mut UErrorCode);
pub type ucnv_usesFallback = unsafe extern "system" fn(cnv: *const UConverter) -> i8;
pub type ucnvsel_close = unsafe extern "system" fn(sel: *mut UConverterSelector);
pub type ucnvsel_open = unsafe extern "system" fn(converterlist: *const *const i8, converterlistsize: i32, excludedcodepoints: *const USet, whichset: UConverterUnicodeSet, status: *mut UErrorCode) -> *mut UConverterSelector;
pub type ucnvsel_openFromSerialized = unsafe extern "system" fn(buffer: *const ::core::ffi::c_void, length: i32, status: *mut UErrorCode) -> *mut UConverterSelector;
pub type ucnvsel_selectForString = unsafe extern "system" fn(sel: *const UConverterSelector, s: *const u16, length: i32, status: *mut UErrorCode) -> *mut UEnumeration;
#[cfg(feature = "Win32_Foundation")]
pub type ucnvsel_selectForUTF8 = unsafe extern "system" fn(sel: *const UConverterSelector, s: super::Foundation::PSTR, length: i32, status: *mut UErrorCode) -> *mut UEnumeration;
pub type ucnvsel_serialize = unsafe extern "system" fn(sel: *const UConverterSelector, buffer: *mut ::core::ffi::c_void, buffercapacity: i32, status: *mut UErrorCode) -> i32;
pub type ucol_cloneBinary = unsafe extern "system" fn(coll: *const UCollator, buffer: *mut u8, capacity: i32, status: *mut UErrorCode) -> i32;
pub type ucol_close = unsafe extern "system" fn(coll: *mut UCollator);
pub type ucol_closeElements = unsafe extern "system" fn(elems: *mut UCollationElements);
pub type ucol_countAvailable = unsafe extern "system" fn() -> i32;
pub type ucol_equal = unsafe extern "system" fn(coll: *const UCollator, source: *const u16, sourcelength: i32, target: *const u16, targetlength: i32) -> i8;
pub type ucol_getAttribute = unsafe extern "system" fn(coll: *const UCollator, attr: UColAttribute, status: *mut UErrorCode) -> UColAttributeValue;
#[cfg(feature = "Win32_Foundation")]
pub type ucol_getAvailable = unsafe extern "system" fn(localeindex: i32) -> super::Foundation::PSTR;
pub type ucol_getBound = unsafe extern "system" fn(source: *const u8, sourcelength: i32, boundtype: UColBoundMode, nooflevels: u32, result: *mut u8, resultlength: i32, status: *mut UErrorCode) -> i32;
pub type ucol_getContractionsAndExpansions = unsafe extern "system" fn(coll: *const UCollator, contractions: *mut USet, expansions: *mut USet, addprefixes: i8, status: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucol_getDisplayName = unsafe extern "system" fn(objloc: super::Foundation::PSTR, disploc: super::Foundation::PSTR, result: *mut u16, resultlength: i32, status: *mut UErrorCode) -> i32;
pub type ucol_getEquivalentReorderCodes = unsafe extern "system" fn(reordercode: i32, dest: *mut i32, destcapacity: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucol_getFunctionalEquivalent = unsafe extern "system" fn(result: super::Foundation::PSTR, resultcapacity: i32, keyword: super::Foundation::PSTR, locale: super::Foundation::PSTR, isavailable: *mut i8, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucol_getKeywordValues = unsafe extern "system" fn(keyword: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut UEnumeration;
#[cfg(feature = "Win32_Foundation")]
pub type ucol_getKeywordValuesForLocale = unsafe extern "system" fn(key: super::Foundation::PSTR, locale: super::Foundation::PSTR, commonlyused: i8, status: *mut UErrorCode) -> *mut UEnumeration;
pub type ucol_getKeywords = unsafe extern "system" fn(status: *mut UErrorCode) -> *mut UEnumeration;
#[cfg(feature = "Win32_Foundation")]
pub type ucol_getLocaleByType = unsafe extern "system" fn(coll: *const UCollator, r#type: ULocDataLocaleType, status: *mut UErrorCode) -> super::Foundation::PSTR;
pub type ucol_getMaxExpansion = unsafe extern "system" fn(elems: *const UCollationElements, order: i32) -> i32;
pub type ucol_getMaxVariable = unsafe extern "system" fn(coll: *const UCollator) -> UColReorderCode;
pub type ucol_getOffset = unsafe extern "system" fn(elems: *const UCollationElements) -> i32;
pub type ucol_getReorderCodes = unsafe extern "system" fn(coll: *const UCollator, dest: *mut i32, destcapacity: i32, perrorcode: *mut UErrorCode) -> i32;
pub type ucol_getRules = unsafe extern "system" fn(coll: *const UCollator, length: *mut i32) -> *mut u16;
pub type ucol_getRulesEx = unsafe extern "system" fn(coll: *const UCollator, delta: UColRuleOption, buffer: *mut u16, bufferlen: i32) -> i32;
pub type ucol_getSortKey = unsafe extern "system" fn(coll: *const UCollator, source: *const u16, sourcelength: i32, result: *mut u8, resultlength: i32) -> i32;
pub type ucol_getStrength = unsafe extern "system" fn(coll: *const UCollator) -> UColAttributeValue;
pub type ucol_getTailoredSet = unsafe extern "system" fn(coll: *const UCollator, status: *mut UErrorCode) -> *mut USet;
pub type ucol_getUCAVersion = unsafe extern "system" fn(coll: *const UCollator, info: *mut u8);
pub type ucol_getVariableTop = unsafe extern "system" fn(coll: *const UCollator, status: *mut UErrorCode) -> u32;
pub type ucol_getVersion = unsafe extern "system" fn(coll: *const UCollator, info: *mut u8);
pub type ucol_greater = unsafe extern "system" fn(coll: *const UCollator, source: *const u16, sourcelength: i32, target: *const u16, targetlength: i32) -> i8;
pub type ucol_greaterOrEqual = unsafe extern "system" fn(coll: *const UCollator, source: *const u16, sourcelength: i32, target: *const u16, targetlength: i32) -> i8;
pub type ucol_keyHashCode = unsafe extern "system" fn(key: *const u8, length: i32) -> i32;
pub type ucol_mergeSortkeys = unsafe extern "system" fn(src1: *const u8, src1length: i32, src2: *const u8, src2length: i32, dest: *mut u8, destcapacity: i32) -> i32;
pub type ucol_next = unsafe extern "system" fn(elems: *mut UCollationElements, status: *mut UErrorCode) -> i32;
pub type ucol_nextSortKeyPart = unsafe extern "system" fn(coll: *const UCollator, iter: *mut UCharIterator, state: *mut u32, dest: *mut u8, count: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucol_open = unsafe extern "system" fn(loc: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut UCollator;
pub type ucol_openAvailableLocales = unsafe extern "system" fn(status: *mut UErrorCode) -> *mut UEnumeration;
pub type ucol_openBinary = unsafe extern "system" fn(bin: *const u8, length: i32, base: *const UCollator, status: *mut UErrorCode) -> *mut UCollator;
pub type ucol_openElements = unsafe extern "system" fn(coll: *const UCollator, text: *const u16, textlength: i32, status: *mut UErrorCode) -> *mut UCollationElements;
pub type ucol_openRules = unsafe extern "system" fn(rules: *const u16, ruleslength: i32, normalizationmode: UColAttributeValue, strength: UColAttributeValue, parseerror: *mut UParseError, status: *mut UErrorCode) -> *mut UCollator;
pub type ucol_previous = unsafe extern "system" fn(elems: *mut UCollationElements, status: *mut UErrorCode) -> i32;
pub type ucol_primaryOrder = unsafe extern "system" fn(order: i32) -> i32;
pub type ucol_reset = unsafe extern "system" fn(elems: *mut UCollationElements);
pub type ucol_safeClone = unsafe extern "system" fn(coll: *const UCollator, stackbuffer: *mut ::core::ffi::c_void, pbuffersize: *mut i32, status: *mut UErrorCode) -> *mut UCollator;
pub type ucol_secondaryOrder = unsafe extern "system" fn(order: i32) -> i32;
pub type ucol_setAttribute = unsafe extern "system" fn(coll: *mut UCollator, attr: UColAttribute, value: UColAttributeValue, status: *mut UErrorCode);
pub type ucol_setMaxVariable = unsafe extern "system" fn(coll: *mut UCollator, group: UColReorderCode, perrorcode: *mut UErrorCode);
pub type ucol_setOffset = unsafe extern "system" fn(elems: *mut UCollationElements, offset: i32, status: *mut UErrorCode);
pub type ucol_setReorderCodes = unsafe extern "system" fn(coll: *mut UCollator, reordercodes: *const i32, reordercodeslength: i32, perrorcode: *mut UErrorCode);
pub type ucol_setStrength = unsafe extern "system" fn(coll: *mut UCollator, strength: UColAttributeValue);
pub type ucol_setText = unsafe extern "system" fn(elems: *mut UCollationElements, text: *const u16, textlength: i32, status: *mut UErrorCode);
pub type ucol_strcoll = unsafe extern "system" fn(coll: *const UCollator, source: *const u16, sourcelength: i32, target: *const u16, targetlength: i32) -> UCollationResult;
pub type ucol_strcollIter = unsafe extern "system" fn(coll: *const UCollator, siter: *mut UCharIterator, titer: *mut UCharIterator, status: *mut UErrorCode) -> UCollationResult;
#[cfg(feature = "Win32_Foundation")]
pub type ucol_strcollUTF8 = unsafe extern "system" fn(coll: *const UCollator, source: super::Foundation::PSTR, sourcelength: i32, target: super::Foundation::PSTR, targetlength: i32, status: *mut UErrorCode) -> UCollationResult;
pub type ucol_tertiaryOrder = unsafe extern "system" fn(order: i32) -> i32;
pub type ucpmap_get = unsafe extern "system" fn(map: *const UCPMap, c: i32) -> u32;
pub type ucpmap_getRange = unsafe extern "system" fn(map: *const UCPMap, start: i32, option: UCPMapRangeOption, surrogatevalue: u32, filter: *mut UCPMapValueFilter, context: *const ::core::ffi::c_void, pvalue: *mut u32) -> i32;
pub type ucptrie_close = unsafe extern "system" fn(trie: *mut UCPTrie);
pub type ucptrie_get = unsafe extern "system" fn(trie: *const UCPTrie, c: i32) -> u32;
pub type ucptrie_getRange = unsafe extern "system" fn(trie: *const UCPTrie, start: i32, option: UCPMapRangeOption, surrogatevalue: u32, filter: *mut UCPMapValueFilter, context: *const ::core::ffi::c_void, pvalue: *mut u32) -> i32;
pub type ucptrie_getType = unsafe extern "system" fn(trie: *const UCPTrie) -> UCPTrieType;
pub type ucptrie_getValueWidth = unsafe extern "system" fn(trie: *const UCPTrie) -> UCPTrieValueWidth;
pub type ucptrie_internalSmallIndex = unsafe extern "system" fn(trie: *const UCPTrie, c: i32) -> i32;
pub type ucptrie_internalSmallU8Index = unsafe extern "system" fn(trie: *const UCPTrie, lt1: i32, t2: u8, t3: u8) -> i32;
pub type ucptrie_internalU8PrevIndex = unsafe extern "system" fn(trie: *const UCPTrie, c: i32, start: *const u8, src: *const u8) -> i32;
pub type ucptrie_openFromBinary = unsafe extern "system" fn(r#type: UCPTrieType, valuewidth: UCPTrieValueWidth, data: *const ::core::ffi::c_void, length: i32, pactuallength: *mut i32, perrorcode: *mut UErrorCode) -> *mut UCPTrie;
pub type ucptrie_toBinary = unsafe extern "system" fn(trie: *const UCPTrie, data: *mut ::core::ffi::c_void, capacity: i32, perrorcode: *mut UErrorCode) -> i32;
pub type ucsdet_close = unsafe extern "system" fn(ucsd: *mut UCharsetDetector);
pub type ucsdet_detect = unsafe extern "system" fn(ucsd: *mut UCharsetDetector, status: *mut UErrorCode) -> *mut UCharsetMatch;
pub type ucsdet_detectAll = unsafe extern "system" fn(ucsd: *mut UCharsetDetector, matchesfound: *mut i32, status: *mut UErrorCode) -> *mut *mut UCharsetMatch;
pub type ucsdet_enableInputFilter = unsafe extern "system" fn(ucsd: *mut UCharsetDetector, filter: i8) -> i8;
pub type ucsdet_getAllDetectableCharsets = unsafe extern "system" fn(ucsd: *const UCharsetDetector, status: *mut UErrorCode) -> *mut UEnumeration;
pub type ucsdet_getConfidence = unsafe extern "system" fn(ucsm: *const UCharsetMatch, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucsdet_getLanguage = unsafe extern "system" fn(ucsm: *const UCharsetMatch, status: *mut UErrorCode) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type ucsdet_getName = unsafe extern "system" fn(ucsm: *const UCharsetMatch, status: *mut UErrorCode) -> super::Foundation::PSTR;
pub type ucsdet_getUChars = unsafe extern "system" fn(ucsm: *const UCharsetMatch, buf: *mut u16, cap: i32, status: *mut UErrorCode) -> i32;
pub type ucsdet_isInputFilterEnabled = unsafe extern "system" fn(ucsd: *const UCharsetDetector) -> i8;
pub type ucsdet_open = unsafe extern "system" fn(status: *mut UErrorCode) -> *mut UCharsetDetector;
#[cfg(feature = "Win32_Foundation")]
pub type ucsdet_setDeclaredEncoding = unsafe extern "system" fn(ucsd: *mut UCharsetDetector, encoding: super::Foundation::PSTR, length: i32, status: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucsdet_setText = unsafe extern "system" fn(ucsd: *mut UCharsetDetector, textin: super::Foundation::PSTR, len: i32, status: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ucurr_countCurrencies = unsafe extern "system" fn(locale: super::Foundation::PSTR, date: f64, ec: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucurr_forLocale = unsafe extern "system" fn(locale: super::Foundation::PSTR, buff: *mut u16, buffcapacity: i32, ec: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucurr_forLocaleAndDate = unsafe extern "system" fn(locale: super::Foundation::PSTR, date: f64, index: i32, buff: *mut u16, buffcapacity: i32, ec: *mut UErrorCode) -> i32;
pub type ucurr_getDefaultFractionDigits = unsafe extern "system" fn(currency: *const u16, ec: *mut UErrorCode) -> i32;
pub type ucurr_getDefaultFractionDigitsForUsage = unsafe extern "system" fn(currency: *const u16, usage: UCurrencyUsage, ec: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucurr_getKeywordValuesForLocale = unsafe extern "system" fn(key: super::Foundation::PSTR, locale: super::Foundation::PSTR, commonlyused: i8, status: *mut UErrorCode) -> *mut UEnumeration;
#[cfg(feature = "Win32_Foundation")]
pub type ucurr_getName = unsafe extern "system" fn(currency: *const u16, locale: super::Foundation::PSTR, namestyle: UCurrNameStyle, ischoiceformat: *mut i8, len: *mut i32, ec: *mut UErrorCode) -> *mut u16;
pub type ucurr_getNumericCode = unsafe extern "system" fn(currency: *const u16) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ucurr_getPluralName = unsafe extern "system" fn(currency: *const u16, locale: super::Foundation::PSTR, ischoiceformat: *mut i8, pluralcount: super::Foundation::PSTR, len: *mut i32, ec: *mut UErrorCode) -> *mut u16;
pub type ucurr_getRoundingIncrement = unsafe extern "system" fn(currency: *const u16, ec: *mut UErrorCode) -> f64;
pub type ucurr_getRoundingIncrementForUsage = unsafe extern "system" fn(currency: *const u16, usage: UCurrencyUsage, ec: *mut UErrorCode) -> f64;
pub type ucurr_isAvailable = unsafe extern "system" fn(isocode: *const u16, from: f64, to: f64, errorcode: *mut UErrorCode) -> i8;
pub type ucurr_openISOCurrencies = unsafe extern "system" fn(currtype: u32, perrorcode: *mut UErrorCode) -> *mut UEnumeration;
#[cfg(feature = "Win32_Foundation")]
pub type ucurr_register = unsafe extern "system" fn(isocode: *const u16, locale: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut ::core::ffi::c_void;
pub type ucurr_unregister = unsafe extern "system" fn(key: *mut ::core::ffi::c_void, status: *mut UErrorCode) -> i8;
pub type udat_adoptNumberFormat = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, numberformattoadopt: *mut *mut ::core::ffi::c_void);
pub type udat_adoptNumberFormatForFields = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, fields: *const u16, numberformattoset: *mut *mut ::core::ffi::c_void, status: *mut UErrorCode);
pub type udat_applyPattern = unsafe extern "system" fn(format: *mut *mut ::core::ffi::c_void, localized: i8, pattern: *const u16, patternlength: i32);
pub type udat_clone = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, status: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
pub type udat_close = unsafe extern "system" fn(format: *mut *mut ::core::ffi::c_void);
pub type udat_countAvailable = unsafe extern "system" fn() -> i32;
pub type udat_countSymbols = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, r#type: UDateFormatSymbolType) -> i32;
pub type udat_format = unsafe extern "system" fn(format: *const *const ::core::ffi::c_void, datetoformat: f64, result: *mut u16, resultlength: i32, position: *mut UFieldPosition, status: *mut UErrorCode) -> i32;
pub type udat_formatCalendar = unsafe extern "system" fn(format: *const *const ::core::ffi::c_void, calendar: *mut *mut ::core::ffi::c_void, result: *mut u16, capacity: i32, position: *mut UFieldPosition, status: *mut UErrorCode) -> i32;
pub type udat_formatCalendarForFields = unsafe extern "system" fn(format: *const *const ::core::ffi::c_void, calendar: *mut *mut ::core::ffi::c_void, result: *mut u16, capacity: i32, fpositer: *mut UFieldPositionIterator, status: *mut UErrorCode) -> i32;
pub type udat_formatForFields = unsafe extern "system" fn(format: *const *const ::core::ffi::c_void, datetoformat: f64, result: *mut u16, resultlength: i32, fpositer: *mut UFieldPositionIterator, status: *mut UErrorCode) -> i32;
pub type udat_get2DigitYearStart = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, status: *mut UErrorCode) -> f64;
#[cfg(feature = "Win32_Foundation")]
pub type udat_getAvailable = unsafe extern "system" fn(localeindex: i32) -> super::Foundation::PSTR;
pub type udat_getBooleanAttribute = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, attr: UDateFormatBooleanAttribute, status: *mut UErrorCode) -> i8;
pub type udat_getCalendar = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void) -> *mut *mut ::core::ffi::c_void;
pub type udat_getContext = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, r#type: UDisplayContextType, status: *mut UErrorCode) -> UDisplayContext;
#[cfg(feature = "Win32_Foundation")]
pub type udat_getLocaleByType = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, r#type: ULocDataLocaleType, status: *mut UErrorCode) -> super::Foundation::PSTR;
pub type udat_getNumberFormat = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void) -> *mut *mut ::core::ffi::c_void;
pub type udat_getNumberFormatForField = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, field: u16) -> *mut *mut ::core::ffi::c_void;
pub type udat_getSymbols = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, r#type: UDateFormatSymbolType, symbolindex: i32, result: *mut u16, resultlength: i32, status: *mut UErrorCode) -> i32;
pub type udat_isLenient = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void) -> i8;
#[cfg(feature = "Win32_Foundation")]
pub type udat_open = unsafe extern "system" fn(timestyle: UDateFormatStyle, datestyle: UDateFormatStyle, locale: super::Foundation::PSTR, tzid: *const u16, tzidlength: i32, pattern: *const u16, patternlength: i32, status: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
pub type udat_parse = unsafe extern "system" fn(format: *const *const ::core::ffi::c_void, text: *const u16, textlength: i32, parsepos: *mut i32, status: *mut UErrorCode) -> f64;
pub type udat_parseCalendar = unsafe extern "system" fn(format: *const *const ::core::ffi::c_void, calendar: *mut *mut ::core::ffi::c_void, text: *const u16, textlength: i32, parsepos: *mut i32, status: *mut UErrorCode);
pub type udat_set2DigitYearStart = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, d: f64, status: *mut UErrorCode);
pub type udat_setBooleanAttribute = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, attr: UDateFormatBooleanAttribute, newvalue: i8, status: *mut UErrorCode);
pub type udat_setCalendar = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, calendartoset: *const *const ::core::ffi::c_void);
pub type udat_setContext = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, value: UDisplayContext, status: *mut UErrorCode);
pub type udat_setLenient = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, islenient: i8);
pub type udat_setNumberFormat = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, numberformattoset: *const *const ::core::ffi::c_void);
pub type udat_setSymbols = unsafe extern "system" fn(format: *mut *mut ::core::ffi::c_void, r#type: UDateFormatSymbolType, symbolindex: i32, value: *mut u16, valuelength: i32, status: *mut UErrorCode);
pub type udat_toCalendarDateField = unsafe extern "system" fn(field: UDateFormatField) -> UCalendarDateFields;
pub type udat_toPattern = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, localized: i8, result: *mut u16, resultlength: i32, status: *mut UErrorCode) -> i32;
pub type udatpg_addPattern = unsafe extern "system" fn(dtpg: *mut *mut ::core::ffi::c_void, pattern: *const u16, patternlength: i32, r#override: i8, conflictingpattern: *mut u16, capacity: i32, plength: *mut i32, perrorcode: *mut UErrorCode) -> UDateTimePatternConflict;
pub type udatpg_clone = unsafe extern "system" fn(dtpg: *const *const ::core::ffi::c_void, perrorcode: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
pub type udatpg_close = unsafe extern "system" fn(dtpg: *mut *mut ::core::ffi::c_void);
pub type udatpg_getAppendItemFormat = unsafe extern "system" fn(dtpg: *const *const ::core::ffi::c_void, field: UDateTimePatternField, plength: *mut i32) -> *mut u16;
pub type udatpg_getAppendItemName = unsafe extern "system" fn(dtpg: *const *const ::core::ffi::c_void, field: UDateTimePatternField, plength: *mut i32) -> *mut u16;
pub type udatpg_getBaseSkeleton = unsafe extern "system" fn(unuseddtpg: *mut *mut ::core::ffi::c_void, pattern: *const u16, length: i32, baseskeleton: *mut u16, capacity: i32, perrorcode: *mut UErrorCode) -> i32;
pub type udatpg_getBestPattern = unsafe extern "system" fn(dtpg: *mut *mut ::core::ffi::c_void, skeleton: *const u16, length: i32, bestpattern: *mut u16, capacity: i32, perrorcode: *mut UErrorCode) -> i32;
pub type udatpg_getBestPatternWithOptions = unsafe extern "system" fn(dtpg: *mut *mut ::core::ffi::c_void, skeleton: *const u16, length: i32, options: UDateTimePatternMatchOptions, bestpattern: *mut u16, capacity: i32, perrorcode: *mut UErrorCode) -> i32;
pub type udatpg_getDateTimeFormat = unsafe extern "system" fn(dtpg: *const *const ::core::ffi::c_void, plength: *mut i32) -> *mut u16;
pub type udatpg_getDecimal = unsafe extern "system" fn(dtpg: *const *const ::core::ffi::c_void, plength: *mut i32) -> *mut u16;
pub type udatpg_getFieldDisplayName = unsafe extern "system" fn(dtpg: *const *const ::core::ffi::c_void, field: UDateTimePatternField, width: UDateTimePGDisplayWidth, fieldname: *mut u16, capacity: i32, perrorcode: *mut UErrorCode) -> i32;
pub type udatpg_getPatternForSkeleton = unsafe extern "system" fn(dtpg: *const *const ::core::ffi::c_void, skeleton: *const u16, skeletonlength: i32, plength: *mut i32) -> *mut u16;
pub type udatpg_getSkeleton = unsafe extern "system" fn(unuseddtpg: *mut *mut ::core::ffi::c_void, pattern: *const u16, length: i32, skeleton: *mut u16, capacity: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type udatpg_open = unsafe extern "system" fn(locale: super::Foundation::PSTR, perrorcode: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
pub type udatpg_openBaseSkeletons = unsafe extern "system" fn(dtpg: *const *const ::core::ffi::c_void, perrorcode: *mut UErrorCode) -> *mut UEnumeration;
pub type udatpg_openEmpty = unsafe extern "system" fn(perrorcode: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
pub type udatpg_openSkeletons = unsafe extern "system" fn(dtpg: *const *const ::core::ffi::c_void, perrorcode: *mut UErrorCode) -> *mut UEnumeration;
pub type udatpg_replaceFieldTypes = unsafe extern "system" fn(dtpg: *mut *mut ::core::ffi::c_void, pattern: *const u16, patternlength: i32, skeleton: *const u16, skeletonlength: i32, dest: *mut u16, destcapacity: i32, perrorcode: *mut UErrorCode) -> i32;
pub type udatpg_replaceFieldTypesWithOptions = unsafe extern "system" fn(dtpg: *mut *mut ::core::ffi::c_void, pattern: *const u16, patternlength: i32, skeleton: *const u16, skeletonlength: i32, options: UDateTimePatternMatchOptions, dest: *mut u16, destcapacity: i32, perrorcode: *mut UErrorCode) -> i32;
pub type udatpg_setAppendItemFormat = unsafe extern "system" fn(dtpg: *mut *mut ::core::ffi::c_void, field: UDateTimePatternField, value: *const u16, length: i32);
pub type udatpg_setAppendItemName = unsafe extern "system" fn(dtpg: *mut *mut ::core::ffi::c_void, field: UDateTimePatternField, value: *const u16, length: i32);
pub type udatpg_setDateTimeFormat = unsafe extern "system" fn(dtpg: *const *const ::core::ffi::c_void, dtformat: *const u16, length: i32);
pub type udatpg_setDecimal = unsafe extern "system" fn(dtpg: *mut *mut ::core::ffi::c_void, decimal: *const u16, length: i32);
pub type udtitvfmt_close = unsafe extern "system" fn(formatter: *mut UDateIntervalFormat);
pub type udtitvfmt_closeResult = unsafe extern "system" fn(uresult: *mut UFormattedDateInterval);
pub type udtitvfmt_format = unsafe extern "system" fn(formatter: *const UDateIntervalFormat, fromdate: f64, todate: f64, result: *mut u16, resultcapacity: i32, position: *mut UFieldPosition, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type udtitvfmt_open = unsafe extern "system" fn(locale: super::Foundation::PSTR, skeleton: *const u16, skeletonlength: i32, tzid: *const u16, tzidlength: i32, status: *mut UErrorCode) -> *mut UDateIntervalFormat;
pub type udtitvfmt_openResult = unsafe extern "system" fn(ec: *mut UErrorCode) -> *mut UFormattedDateInterval;
pub type udtitvfmt_resultAsValue = unsafe extern "system" fn(uresult: *const UFormattedDateInterval, ec: *mut UErrorCode) -> *mut UFormattedValue;
pub type uenum_close = unsafe extern "system" fn(en: *mut UEnumeration);
pub type uenum_count = unsafe extern "system" fn(en: *mut UEnumeration, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uenum_next = unsafe extern "system" fn(en: *mut UEnumeration, resultlength: *mut i32, status: *mut UErrorCode) -> super::Foundation::PSTR;
pub type uenum_openCharStringsEnumeration = unsafe extern "system" fn(strings: *const *const i8, count: i32, ec: *mut UErrorCode) -> *mut UEnumeration;
pub type uenum_openUCharStringsEnumeration = unsafe extern "system" fn(strings: *const *const u16, count: i32, ec: *mut UErrorCode) -> *mut UEnumeration;
pub type uenum_reset = unsafe extern "system" fn(en: *mut UEnumeration, status: *mut UErrorCode);
pub type uenum_unext = unsafe extern "system" fn(en: *mut UEnumeration, resultlength: *mut i32, status: *mut UErrorCode) -> *mut u16;
pub type ufieldpositer_close = unsafe extern "system" fn(fpositer: *mut UFieldPositionIterator);
pub type ufieldpositer_next = unsafe extern "system" fn(fpositer: *mut UFieldPositionIterator, beginindex: *mut i32, endindex: *mut i32) -> i32;
pub type ufieldpositer_open = unsafe extern "system" fn(status: *mut UErrorCode) -> *mut UFieldPositionIterator;
pub type ufmt_close = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void);
pub type ufmt_getArrayItemByIndex = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, n: i32, status: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
pub type ufmt_getArrayLength = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, status: *mut UErrorCode) -> i32;
pub type ufmt_getDate = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, status: *mut UErrorCode) -> f64;
#[cfg(feature = "Win32_Foundation")]
pub type ufmt_getDecNumChars = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, len: *mut i32, status: *mut UErrorCode) -> super::Foundation::PSTR;
pub type ufmt_getDouble = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, status: *mut UErrorCode) -> f64;
pub type ufmt_getInt64 = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, status: *mut UErrorCode) -> i64;
pub type ufmt_getLong = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, status: *mut UErrorCode) -> i32;
pub type ufmt_getObject = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, status: *mut UErrorCode) -> *mut ::core::ffi::c_void;
pub type ufmt_getType = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, status: *mut UErrorCode) -> UFormattableType;
pub type ufmt_getUChars = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, len: *mut i32, status: *mut UErrorCode) -> *mut u16;
pub type ufmt_isNumeric = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void) -> i8;
pub type ufmt_open = unsafe extern "system" fn(status: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
pub type ufmtval_getString = unsafe extern "system" fn(ufmtval: *const UFormattedValue, plength: *mut i32, ec: *mut UErrorCode) -> *mut u16;
pub type ufmtval_nextPosition = unsafe extern "system" fn(ufmtval: *const UFormattedValue, ucfpos: *mut UConstrainedFieldPosition, ec: *mut UErrorCode) -> i8;
#[cfg(feature = "Win32_Foundation")]
pub type ugender_getInstance = unsafe extern "system" fn(locale: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut UGenderInfo;
pub type ugender_getListGender = unsafe extern "system" fn(genderinfo: *const UGenderInfo, genders: *const UGender, size: i32, status: *mut UErrorCode) -> UGender;
pub type uidna_close = unsafe extern "system" fn(idna: *mut UIDNA);
pub type uidna_labelToASCII = unsafe extern "system" fn(idna: *const UIDNA, label: *const u16, length: i32, dest: *mut u16, capacity: i32, pinfo: *mut UIDNAInfo, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uidna_labelToASCII_UTF8 = unsafe extern "system" fn(idna: *const UIDNA, label: super::Foundation::PSTR, length: i32, dest: super::Foundation::PSTR, capacity: i32, pinfo: *mut UIDNAInfo, perrorcode: *mut UErrorCode) -> i32;
pub type uidna_labelToUnicode = unsafe extern "system" fn(idna: *const UIDNA, label: *const u16, length: i32, dest: *mut u16, capacity: i32, pinfo: *mut UIDNAInfo, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uidna_labelToUnicodeUTF8 = unsafe extern "system" fn(idna: *const UIDNA, label: super::Foundation::PSTR, length: i32, dest: super::Foundation::PSTR, capacity: i32, pinfo: *mut UIDNAInfo, perrorcode: *mut UErrorCode) -> i32;
pub type uidna_nameToASCII = unsafe extern "system" fn(idna: *const UIDNA, name: *const u16, length: i32, dest: *mut u16, capacity: i32, pinfo: *mut UIDNAInfo, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uidna_nameToASCII_UTF8 = unsafe extern "system" fn(idna: *const UIDNA, name: super::Foundation::PSTR, length: i32, dest: super::Foundation::PSTR, capacity: i32, pinfo: *mut UIDNAInfo, perrorcode: *mut UErrorCode) -> i32;
pub type uidna_nameToUnicode = unsafe extern "system" fn(idna: *const UIDNA, name: *const u16, length: i32, dest: *mut u16, capacity: i32, pinfo: *mut UIDNAInfo, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uidna_nameToUnicodeUTF8 = unsafe extern "system" fn(idna: *const UIDNA, name: super::Foundation::PSTR, length: i32, dest: super::Foundation::PSTR, capacity: i32, pinfo: *mut UIDNAInfo, perrorcode: *mut UErrorCode) -> i32;
pub type uidna_openUTS46 = unsafe extern "system" fn(options: u32, perrorcode: *mut UErrorCode) -> *mut UIDNA;
pub type uiter_current32 = unsafe extern "system" fn(iter: *mut UCharIterator) -> i32;
pub type uiter_getState = unsafe extern "system" fn(iter: *const UCharIterator) -> u32;
pub type uiter_next32 = unsafe extern "system" fn(iter: *mut UCharIterator) -> i32;
pub type uiter_previous32 = unsafe extern "system" fn(iter: *mut UCharIterator) -> i32;
pub type uiter_setState = unsafe extern "system" fn(iter: *mut UCharIterator, state: u32, perrorcode: *mut UErrorCode);
pub type uiter_setString = unsafe extern "system" fn(iter: *mut UCharIterator, s: *const u16, length: i32);
#[cfg(feature = "Win32_Foundation")]
pub type uiter_setUTF16BE = unsafe extern "system" fn(iter: *mut UCharIterator, s: super::Foundation::PSTR, length: i32);
#[cfg(feature = "Win32_Foundation")]
pub type uiter_setUTF8 = unsafe extern "system" fn(iter: *mut UCharIterator, s: super::Foundation::PSTR, length: i32);
pub type uldn_close = unsafe extern "system" fn(ldn: *mut ULocaleDisplayNames);
pub type uldn_getContext = unsafe extern "system" fn(ldn: *const ULocaleDisplayNames, r#type: UDisplayContextType, perrorcode: *mut UErrorCode) -> UDisplayContext;
pub type uldn_getDialectHandling = unsafe extern "system" fn(ldn: *const ULocaleDisplayNames) -> UDialectHandling;
#[cfg(feature = "Win32_Foundation")]
pub type uldn_getLocale = unsafe extern "system" fn(ldn: *const ULocaleDisplayNames) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type uldn_keyDisplayName = unsafe extern "system" fn(ldn: *const ULocaleDisplayNames, key: super::Foundation::PSTR, result: *mut u16, maxresultsize: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uldn_keyValueDisplayName = unsafe extern "system" fn(ldn: *const ULocaleDisplayNames, key: super::Foundation::PSTR, value: super::Foundation::PSTR, result: *mut u16, maxresultsize: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uldn_languageDisplayName = unsafe extern "system" fn(ldn: *const ULocaleDisplayNames, lang: super::Foundation::PSTR, result: *mut u16, maxresultsize: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uldn_localeDisplayName = unsafe extern "system" fn(ldn: *const ULocaleDisplayNames, locale: super::Foundation::PSTR, result: *mut u16, maxresultsize: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uldn_open = unsafe extern "system" fn(locale: super::Foundation::PSTR, dialecthandling: UDialectHandling, perrorcode: *mut UErrorCode) -> *mut ULocaleDisplayNames;
#[cfg(feature = "Win32_Foundation")]
pub type uldn_openForContext = unsafe extern "system" fn(locale: super::Foundation::PSTR, contexts: *mut UDisplayContext, length: i32, perrorcode: *mut UErrorCode) -> *mut ULocaleDisplayNames;
#[cfg(feature = "Win32_Foundation")]
pub type uldn_regionDisplayName = unsafe extern "system" fn(ldn: *const ULocaleDisplayNames, region: super::Foundation::PSTR, result: *mut u16, maxresultsize: i32, perrorcode: *mut UErrorCode) -> i32;
pub type uldn_scriptCodeDisplayName = unsafe extern "system" fn(ldn: *const ULocaleDisplayNames, scriptcode: UScriptCode, result: *mut u16, maxresultsize: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uldn_scriptDisplayName = unsafe extern "system" fn(ldn: *const ULocaleDisplayNames, script: super::Foundation::PSTR, result: *mut u16, maxresultsize: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uldn_variantDisplayName = unsafe extern "system" fn(ldn: *const ULocaleDisplayNames, variant: super::Foundation::PSTR, result: *mut u16, maxresultsize: i32, perrorcode: *mut UErrorCode) -> i32;
pub type ulistfmt_close = unsafe extern "system" fn(listfmt: *mut UListFormatter);
pub type ulistfmt_closeResult = unsafe extern "system" fn(uresult: *mut UFormattedList);
pub type ulistfmt_format = unsafe extern "system" fn(listfmt: *const UListFormatter, strings: *const *const u16, stringlengths: *const i32, stringcount: i32, result: *mut u16, resultcapacity: i32, status: *mut UErrorCode) -> i32;
pub type ulistfmt_formatStringsToResult = unsafe extern "system" fn(listfmt: *const UListFormatter, strings: *const *const u16, stringlengths: *const i32, stringcount: i32, uresult: *mut UFormattedList, status: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ulistfmt_open = unsafe extern "system" fn(locale: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut UListFormatter;
#[cfg(feature = "Win32_Foundation")]
pub type ulistfmt_openForType = unsafe extern "system" fn(locale: super::Foundation::PSTR, r#type: UListFormatterType, width: UListFormatterWidth, status: *mut UErrorCode) -> *mut UListFormatter;
pub type ulistfmt_openResult = unsafe extern "system" fn(ec: *mut UErrorCode) -> *mut UFormattedList;
pub type ulistfmt_resultAsValue = unsafe extern "system" fn(uresult: *const UFormattedList, ec: *mut UErrorCode) -> *mut UFormattedValue;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_acceptLanguage = unsafe extern "system" fn(result: super::Foundation::PSTR, resultavailable: i32, outresult: *mut UAcceptResult, acceptlist: *const *const i8, acceptlistcount: i32, availablelocales: *mut UEnumeration, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_acceptLanguageFromHTTP = unsafe extern "system" fn(result: super::Foundation::PSTR, resultavailable: i32, outresult: *mut UAcceptResult, httpacceptlanguage: super::Foundation::PSTR, availablelocales: *mut UEnumeration, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_addLikelySubtags = unsafe extern "system" fn(localeid: super::Foundation::PSTR, maximizedlocaleid: super::Foundation::PSTR, maximizedlocaleidcapacity: i32, err: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_canonicalize = unsafe extern "system" fn(localeid: super::Foundation::PSTR, name: super::Foundation::PSTR, namecapacity: i32, err: *mut UErrorCode) -> i32;
pub type uloc_countAvailable = unsafe extern "system" fn() -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_forLanguageTag = unsafe extern "system" fn(langtag: super::Foundation::PSTR, localeid: super::Foundation::PSTR, localeidcapacity: i32, parsedlength: *mut i32, err: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getAvailable = unsafe extern "system" fn(n: i32) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getBaseName = unsafe extern "system" fn(localeid: super::Foundation::PSTR, name: super::Foundation::PSTR, namecapacity: i32, err: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getCharacterOrientation = unsafe extern "system" fn(localeid: super::Foundation::PSTR, status: *mut UErrorCode) -> ULayoutType;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getCountry = unsafe extern "system" fn(localeid: super::Foundation::PSTR, country: super::Foundation::PSTR, countrycapacity: i32, err: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getDefault = unsafe extern "system" fn() -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getDisplayCountry = unsafe extern "system" fn(locale: super::Foundation::PSTR, displaylocale: super::Foundation::PSTR, country: *mut u16, countrycapacity: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getDisplayKeyword = unsafe extern "system" fn(keyword: super::Foundation::PSTR, displaylocale: super::Foundation::PSTR, dest: *mut u16, destcapacity: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getDisplayKeywordValue = unsafe extern "system" fn(locale: super::Foundation::PSTR, keyword: super::Foundation::PSTR, displaylocale: super::Foundation::PSTR, dest: *mut u16, destcapacity: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getDisplayLanguage = unsafe extern "system" fn(locale: super::Foundation::PSTR, displaylocale: super::Foundation::PSTR, language: *mut u16, languagecapacity: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getDisplayName = unsafe extern "system" fn(localeid: super::Foundation::PSTR, inlocaleid: super::Foundation::PSTR, result: *mut u16, maxresultsize: i32, err: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getDisplayScript = unsafe extern "system" fn(locale: super::Foundation::PSTR, displaylocale: super::Foundation::PSTR, script: *mut u16, scriptcapacity: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getDisplayVariant = unsafe extern "system" fn(locale: super::Foundation::PSTR, displaylocale: super::Foundation::PSTR, variant: *mut u16, variantcapacity: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getISO3Country = unsafe extern "system" fn(localeid: super::Foundation::PSTR) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getISO3Language = unsafe extern "system" fn(localeid: super::Foundation::PSTR) -> super::Foundation::PSTR;
pub type uloc_getISOCountries = unsafe extern "system" fn() -> *mut *mut i8;
pub type uloc_getISOLanguages = unsafe extern "system" fn() -> *mut *mut i8;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getKeywordValue = unsafe extern "system" fn(localeid: super::Foundation::PSTR, keywordname: super::Foundation::PSTR, buffer: super::Foundation::PSTR, buffercapacity: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getLCID = unsafe extern "system" fn(localeid: super::Foundation::PSTR) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getLanguage = unsafe extern "system" fn(localeid: super::Foundation::PSTR, language: super::Foundation::PSTR, languagecapacity: i32, err: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getLineOrientation = unsafe extern "system" fn(localeid: super::Foundation::PSTR, status: *mut UErrorCode) -> ULayoutType;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getLocaleForLCID = unsafe extern "system" fn(hostid: u32, locale: super::Foundation::PSTR, localecapacity: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getName = unsafe extern "system" fn(localeid: super::Foundation::PSTR, name: super::Foundation::PSTR, namecapacity: i32, err: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getParent = unsafe extern "system" fn(localeid: super::Foundation::PSTR, parent: super::Foundation::PSTR, parentcapacity: i32, err: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getScript = unsafe extern "system" fn(localeid: super::Foundation::PSTR, script: super::Foundation::PSTR, scriptcapacity: i32, err: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_getVariant = unsafe extern "system" fn(localeid: super::Foundation::PSTR, variant: super::Foundation::PSTR, variantcapacity: i32, err: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_isRightToLeft = unsafe extern "system" fn(locale: super::Foundation::PSTR) -> i8;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_minimizeSubtags = unsafe extern "system" fn(localeid: super::Foundation::PSTR, minimizedlocaleid: super::Foundation::PSTR, minimizedlocaleidcapacity: i32, err: *mut UErrorCode) -> i32;
pub type uloc_openAvailableByType = unsafe extern "system" fn(r#type: ULocAvailableType, status: *mut UErrorCode) -> *mut UEnumeration;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_openKeywords = unsafe extern "system" fn(localeid: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut UEnumeration;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_setDefault = unsafe extern "system" fn(localeid: super::Foundation::PSTR, status: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type uloc_setKeywordValue = unsafe extern "system" fn(keywordname: super::Foundation::PSTR, keywordvalue: super::Foundation::PSTR, buffer: super::Foundation::PSTR, buffercapacity: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_toLanguageTag = unsafe extern "system" fn(localeid: super::Foundation::PSTR, langtag: super::Foundation::PSTR, langtagcapacity: i32, strict: i8, err: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_toLegacyKey = unsafe extern "system" fn(keyword: super::Foundation::PSTR) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_toLegacyType = unsafe extern "system" fn(keyword: super::Foundation::PSTR, value: super::Foundation::PSTR) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_toUnicodeLocaleKey = unsafe extern "system" fn(keyword: super::Foundation::PSTR) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type uloc_toUnicodeLocaleType = unsafe extern "system" fn(keyword: super::Foundation::PSTR, value: super::Foundation::PSTR) -> super::Foundation::PSTR;
pub type ulocdata_close = unsafe extern "system" fn(uld: *mut ULocaleData);
pub type ulocdata_getCLDRVersion = unsafe extern "system" fn(versionarray: *mut u8, status: *mut UErrorCode);
pub type ulocdata_getDelimiter = unsafe extern "system" fn(uld: *mut ULocaleData, r#type: ULocaleDataDelimiterType, result: *mut u16, resultlength: i32, status: *mut UErrorCode) -> i32;
pub type ulocdata_getExemplarSet = unsafe extern "system" fn(uld: *mut ULocaleData, fillin: *mut USet, options: u32, extype: ULocaleDataExemplarSetType, status: *mut UErrorCode) -> *mut USet;
pub type ulocdata_getLocaleDisplayPattern = unsafe extern "system" fn(uld: *mut ULocaleData, pattern: *mut u16, patterncapacity: i32, status: *mut UErrorCode) -> i32;
pub type ulocdata_getLocaleSeparator = unsafe extern "system" fn(uld: *mut ULocaleData, separator: *mut u16, separatorcapacity: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type ulocdata_getMeasurementSystem = unsafe extern "system" fn(localeid: super::Foundation::PSTR, status: *mut UErrorCode) -> UMeasurementSystem;
pub type ulocdata_getNoSubstitute = unsafe extern "system" fn(uld: *mut ULocaleData) -> i8;
#[cfg(feature = "Win32_Foundation")]
pub type ulocdata_getPaperSize = unsafe extern "system" fn(localeid: super::Foundation::PSTR, height: *mut i32, width: *mut i32, status: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ulocdata_open = unsafe extern "system" fn(localeid: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut ULocaleData;
pub type ulocdata_setNoSubstitute = unsafe extern "system" fn(uld: *mut ULocaleData, setting: i8);
pub type umsg_applyPattern = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, pattern: *const u16, patternlength: i32, parseerror: *mut UParseError, status: *mut UErrorCode);
pub type umsg_autoQuoteApostrophe = unsafe extern "system" fn(pattern: *const u16, patternlength: i32, dest: *mut u16, destcapacity: i32, ec: *mut UErrorCode) -> i32;
pub type umsg_clone = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, status: *mut UErrorCode) -> *mut ::core::ffi::c_void;
pub type umsg_close = unsafe extern "system" fn(format: *mut *mut ::core::ffi::c_void);
pub type umsg_format = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, result: *mut u16, resultlength: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type umsg_getLocale = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type umsg_open = unsafe extern "system" fn(pattern: *const u16, patternlength: i32, locale: super::Foundation::PSTR, parseerror: *mut UParseError, status: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
pub type umsg_parse = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, source: *const u16, sourcelength: i32, count: *mut i32, status: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type umsg_setLocale = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, locale: super::Foundation::PSTR);
pub type umsg_toPattern = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, result: *mut u16, resultlength: i32, status: *mut UErrorCode) -> i32;
pub type umsg_vformat = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, result: *mut u16, resultlength: i32, ap: *mut i8, status: *mut UErrorCode) -> i32;
pub type umsg_vparse = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, source: *const u16, sourcelength: i32, count: *mut i32, ap: *mut i8, status: *mut UErrorCode);
pub type umutablecptrie_buildImmutable = unsafe extern "system" fn(trie: *mut UMutableCPTrie, r#type: UCPTrieType, valuewidth: UCPTrieValueWidth, perrorcode: *mut UErrorCode) -> *mut UCPTrie;
pub type umutablecptrie_clone = unsafe extern "system" fn(other: *const UMutableCPTrie, perrorcode: *mut UErrorCode) -> *mut UMutableCPTrie;
pub type umutablecptrie_close = unsafe extern "system" fn(trie: *mut UMutableCPTrie);
pub type umutablecptrie_fromUCPMap = unsafe extern "system" fn(map: *const UCPMap, perrorcode: *mut UErrorCode) -> *mut UMutableCPTrie;
pub type umutablecptrie_fromUCPTrie = unsafe extern "system" fn(trie: *const UCPTrie, perrorcode: *mut UErrorCode) -> *mut UMutableCPTrie;
pub type umutablecptrie_get = unsafe extern "system" fn(trie: *const UMutableCPTrie, c: i32) -> u32;
pub type umutablecptrie_getRange = unsafe extern "system" fn(trie: *const UMutableCPTrie, start: i32, option: UCPMapRangeOption, surrogatevalue: u32, filter: *mut UCPMapValueFilter, context: *const ::core::ffi::c_void, pvalue: *mut u32) -> i32;
pub type umutablecptrie_open = unsafe extern "system" fn(initialvalue: u32, errorvalue: u32, perrorcode: *mut UErrorCode) -> *mut UMutableCPTrie;
pub type umutablecptrie_set = unsafe extern "system" fn(trie: *mut UMutableCPTrie, c: i32, value: u32, perrorcode: *mut UErrorCode);
pub type umutablecptrie_setRange = unsafe extern "system" fn(trie: *mut UMutableCPTrie, start: i32, end: i32, value: u32, perrorcode: *mut UErrorCode);
pub type unorm2_append = unsafe extern "system" fn(norm2: *const UNormalizer2, first: *mut u16, firstlength: i32, firstcapacity: i32, second: *const u16, secondlength: i32, perrorcode: *mut UErrorCode) -> i32;
pub type unorm2_close = unsafe extern "system" fn(norm2: *mut UNormalizer2);
pub type unorm2_composePair = unsafe extern "system" fn(norm2: *const UNormalizer2, a: i32, b: i32) -> i32;
pub type unorm2_getCombiningClass = unsafe extern "system" fn(norm2: *const UNormalizer2, c: i32) -> u8;
pub type unorm2_getDecomposition = unsafe extern "system" fn(norm2: *const UNormalizer2, c: i32, decomposition: *mut u16, capacity: i32, perrorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type unorm2_getInstance = unsafe extern "system" fn(packagename: super::Foundation::PSTR, name: super::Foundation::PSTR, mode: UNormalization2Mode, perrorcode: *mut UErrorCode) -> *mut UNormalizer2;
pub type unorm2_getNFCInstance = unsafe extern "system" fn(perrorcode: *mut UErrorCode) -> *mut UNormalizer2;
pub type unorm2_getNFDInstance = unsafe extern "system" fn(perrorcode: *mut UErrorCode) -> *mut UNormalizer2;
pub type unorm2_getNFKCCasefoldInstance = unsafe extern "system" fn(perrorcode: *mut UErrorCode) -> *mut UNormalizer2;
pub type unorm2_getNFKCInstance = unsafe extern "system" fn(perrorcode: *mut UErrorCode) -> *mut UNormalizer2;
pub type unorm2_getNFKDInstance = unsafe extern "system" fn(perrorcode: *mut UErrorCode) -> *mut UNormalizer2;
pub type unorm2_getRawDecomposition = unsafe extern "system" fn(norm2: *const UNormalizer2, c: i32, decomposition: *mut u16, capacity: i32, perrorcode: *mut UErrorCode) -> i32;
pub type unorm2_hasBoundaryAfter = unsafe extern "system" fn(norm2: *const UNormalizer2, c: i32) -> i8;
pub type unorm2_hasBoundaryBefore = unsafe extern "system" fn(norm2: *const UNormalizer2, c: i32) -> i8;
pub type unorm2_isInert = unsafe extern "system" fn(norm2: *const UNormalizer2, c: i32) -> i8;
pub type unorm2_isNormalized = unsafe extern "system" fn(norm2: *const UNormalizer2, s: *const u16, length: i32, perrorcode: *mut UErrorCode) -> i8;
pub type unorm2_normalize = unsafe extern "system" fn(norm2: *const UNormalizer2, src: *const u16, length: i32, dest: *mut u16, capacity: i32, perrorcode: *mut UErrorCode) -> i32;
pub type unorm2_normalizeSecondAndAppend = unsafe extern "system" fn(norm2: *const UNormalizer2, first: *mut u16, firstlength: i32, firstcapacity: i32, second: *const u16, secondlength: i32, perrorcode: *mut UErrorCode) -> i32;
pub type unorm2_openFiltered = unsafe extern "system" fn(norm2: *const UNormalizer2, filterset: *const USet, perrorcode: *mut UErrorCode) -> *mut UNormalizer2;
pub type unorm2_quickCheck = unsafe extern "system" fn(norm2: *const UNormalizer2, s: *const u16, length: i32, perrorcode: *mut UErrorCode) -> UNormalizationCheckResult;
pub type unorm2_spanQuickCheckYes = unsafe extern "system" fn(norm2: *const UNormalizer2, s: *const u16, length: i32, perrorcode: *mut UErrorCode) -> i32;
pub type unorm_compare = unsafe extern "system" fn(s1: *const u16, length1: i32, s2: *const u16, length2: i32, options: u32, perrorcode: *mut UErrorCode) -> i32;
pub type unum_applyPattern = unsafe extern "system" fn(format: *mut *mut ::core::ffi::c_void, localized: i8, pattern: *const u16, patternlength: i32, parseerror: *mut UParseError, status: *mut UErrorCode);
pub type unum_clone = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, status: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
pub type unum_close = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void);
pub type unum_countAvailable = unsafe extern "system" fn() -> i32;
pub type unum_format = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, number: i32, result: *mut u16, resultlength: i32, pos: *mut UFieldPosition, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type unum_formatDecimal = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, number: super::Foundation::PSTR, length: i32, result: *mut u16, resultlength: i32, pos: *mut UFieldPosition, status: *mut UErrorCode) -> i32;
pub type unum_formatDouble = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, number: f64, result: *mut u16, resultlength: i32, pos: *mut UFieldPosition, status: *mut UErrorCode) -> i32;
pub type unum_formatDoubleCurrency = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, number: f64, currency: *mut u16, result: *mut u16, resultlength: i32, pos: *mut UFieldPosition, status: *mut UErrorCode) -> i32;
pub type unum_formatDoubleForFields = unsafe extern "system" fn(format: *const *const ::core::ffi::c_void, number: f64, result: *mut u16, resultlength: i32, fpositer: *mut UFieldPositionIterator, status: *mut UErrorCode) -> i32;
pub type unum_formatInt64 = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, number: i64, result: *mut u16, resultlength: i32, pos: *mut UFieldPosition, status: *mut UErrorCode) -> i32;
pub type unum_formatUFormattable = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, number: *const *const ::core::ffi::c_void, result: *mut u16, resultlength: i32, pos: *mut UFieldPosition, status: *mut UErrorCode) -> i32;
pub type unum_getAttribute = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, attr: UNumberFormatAttribute) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type unum_getAvailable = unsafe extern "system" fn(localeindex: i32) -> super::Foundation::PSTR;
pub type unum_getContext = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, r#type: UDisplayContextType, status: *mut UErrorCode) -> UDisplayContext;
pub type unum_getDoubleAttribute = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, attr: UNumberFormatAttribute) -> f64;
#[cfg(feature = "Win32_Foundation")]
pub type unum_getLocaleByType = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, r#type: ULocDataLocaleType, status: *mut UErrorCode) -> super::Foundation::PSTR;
pub type unum_getSymbol = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, symbol: UNumberFormatSymbol, buffer: *mut u16, size: i32, status: *mut UErrorCode) -> i32;
pub type unum_getTextAttribute = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, tag: UNumberFormatTextAttribute, result: *mut u16, resultlength: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type unum_open = unsafe extern "system" fn(style: UNumberFormatStyle, pattern: *const u16, patternlength: i32, locale: super::Foundation::PSTR, parseerr: *mut UParseError, status: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
pub type unum_parse = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, text: *const u16, textlength: i32, parsepos: *mut i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type unum_parseDecimal = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, text: *const u16, textlength: i32, parsepos: *mut i32, outbuf: super::Foundation::PSTR, outbuflength: i32, status: *mut UErrorCode) -> i32;
pub type unum_parseDouble = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, text: *const u16, textlength: i32, parsepos: *mut i32, status: *mut UErrorCode) -> f64;
pub type unum_parseDoubleCurrency = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, text: *const u16, textlength: i32, parsepos: *mut i32, currency: *mut u16, status: *mut UErrorCode) -> f64;
pub type unum_parseInt64 = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, text: *const u16, textlength: i32, parsepos: *mut i32, status: *mut UErrorCode) -> i64;
pub type unum_parseToUFormattable = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, result: *mut *mut ::core::ffi::c_void, text: *const u16, textlength: i32, parsepos: *mut i32, status: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
pub type unum_setAttribute = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, attr: UNumberFormatAttribute, newvalue: i32);
pub type unum_setContext = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, value: UDisplayContext, status: *mut UErrorCode);
pub type unum_setDoubleAttribute = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, attr: UNumberFormatAttribute, newvalue: f64);
pub type unum_setSymbol = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, symbol: UNumberFormatSymbol, value: *const u16, length: i32, status: *mut UErrorCode);
pub type unum_setTextAttribute = unsafe extern "system" fn(fmt: *mut *mut ::core::ffi::c_void, tag: UNumberFormatTextAttribute, newvalue: *const u16, newvaluelength: i32, status: *mut UErrorCode);
pub type unum_toPattern = unsafe extern "system" fn(fmt: *const *const ::core::ffi::c_void, ispatternlocalized: i8, result: *mut u16, resultlength: i32, status: *mut UErrorCode) -> i32;
pub type unumf_close = unsafe extern "system" fn(uformatter: *mut UNumberFormatter);
pub type unumf_closeResult = unsafe extern "system" fn(uresult: *mut UFormattedNumber);
#[cfg(feature = "Win32_Foundation")]
pub type unumf_formatDecimal = unsafe extern "system" fn(uformatter: *const UNumberFormatter, value: super::Foundation::PSTR, valuelen: i32, uresult: *mut UFormattedNumber, ec: *mut UErrorCode);
pub type unumf_formatDouble = unsafe extern "system" fn(uformatter: *const UNumberFormatter, value: f64, uresult: *mut UFormattedNumber, ec: *mut UErrorCode);
pub type unumf_formatInt = unsafe extern "system" fn(uformatter: *const UNumberFormatter, value: i64, uresult: *mut UFormattedNumber, ec: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type unumf_openForSkeletonAndLocale = unsafe extern "system" fn(skeleton: *const u16, skeletonlen: i32, locale: super::Foundation::PSTR, ec: *mut UErrorCode) -> *mut UNumberFormatter;
#[cfg(feature = "Win32_Foundation")]
pub type unumf_openForSkeletonAndLocaleWithError = unsafe extern "system" fn(skeleton: *const u16, skeletonlen: i32, locale: super::Foundation::PSTR, perror: *mut UParseError, ec: *mut UErrorCode) -> *mut UNumberFormatter;
pub type unumf_openResult = unsafe extern "system" fn(ec: *mut UErrorCode) -> *mut UFormattedNumber;
pub type unumf_resultAsValue = unsafe extern "system" fn(uresult: *const UFormattedNumber, ec: *mut UErrorCode) -> *mut UFormattedValue;
pub type unumf_resultGetAllFieldPositions = unsafe extern "system" fn(uresult: *const UFormattedNumber, ufpositer: *mut UFieldPositionIterator, ec: *mut UErrorCode);
pub type unumf_resultNextFieldPosition = unsafe extern "system" fn(uresult: *const UFormattedNumber, ufpos: *mut UFieldPosition, ec: *mut UErrorCode) -> i8;
pub type unumf_resultToString = unsafe extern "system" fn(uresult: *const UFormattedNumber, buffer: *mut u16, buffercapacity: i32, ec: *mut UErrorCode) -> i32;
pub type unumsys_close = unsafe extern "system" fn(unumsys: *mut UNumberingSystem);
pub type unumsys_getDescription = unsafe extern "system" fn(unumsys: *const UNumberingSystem, result: *mut u16, resultlength: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type unumsys_getName = unsafe extern "system" fn(unumsys: *const UNumberingSystem) -> super::Foundation::PSTR;
pub type unumsys_getRadix = unsafe extern "system" fn(unumsys: *const UNumberingSystem) -> i32;
pub type unumsys_isAlgorithmic = unsafe extern "system" fn(unumsys: *const UNumberingSystem) -> i8;
#[cfg(feature = "Win32_Foundation")]
pub type unumsys_open = unsafe extern "system" fn(locale: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut UNumberingSystem;
pub type unumsys_openAvailableNames = unsafe extern "system" fn(status: *mut UErrorCode) -> *mut UEnumeration;
#[cfg(feature = "Win32_Foundation")]
pub type unumsys_openByName = unsafe extern "system" fn(name: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut UNumberingSystem;
pub type uplrules_close = unsafe extern "system" fn(uplrules: *mut UPluralRules);
pub type uplrules_getKeywords = unsafe extern "system" fn(uplrules: *const UPluralRules, status: *mut UErrorCode) -> *mut UEnumeration;
#[cfg(feature = "Win32_Foundation")]
pub type uplrules_open = unsafe extern "system" fn(locale: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut UPluralRules;
#[cfg(feature = "Win32_Foundation")]
pub type uplrules_openForType = unsafe extern "system" fn(locale: super::Foundation::PSTR, r#type: UPluralType, status: *mut UErrorCode) -> *mut UPluralRules;
pub type uplrules_select = unsafe extern "system" fn(uplrules: *const UPluralRules, number: f64, keyword: *mut u16, capacity: i32, status: *mut UErrorCode) -> i32;
pub type uplrules_selectFormatted = unsafe extern "system" fn(uplrules: *const UPluralRules, number: *const UFormattedNumber, keyword: *mut u16, capacity: i32, status: *mut UErrorCode) -> i32;
pub type uregex_appendReplacement = unsafe extern "system" fn(regexp: *mut URegularExpression, replacementtext: *const u16, replacementlength: i32, destbuf: *mut *mut u16, destcapacity: *mut i32, status: *mut UErrorCode) -> i32;
pub type uregex_appendReplacementUText = unsafe extern "system" fn(regexp: *mut URegularExpression, replacementtext: *mut UText, dest: *mut UText, status: *mut UErrorCode);
pub type uregex_appendTail = unsafe extern "system" fn(regexp: *mut URegularExpression, destbuf: *mut *mut u16, destcapacity: *mut i32, status: *mut UErrorCode) -> i32;
pub type uregex_appendTailUText = unsafe extern "system" fn(regexp: *mut URegularExpression, dest: *mut UText, status: *mut UErrorCode) -> *mut UText;
pub type uregex_clone = unsafe extern "system" fn(regexp: *const URegularExpression, status: *mut UErrorCode) -> *mut URegularExpression;
pub type uregex_close = unsafe extern "system" fn(regexp: *mut URegularExpression);
pub type uregex_end = unsafe extern "system" fn(regexp: *mut URegularExpression, groupnum: i32, status: *mut UErrorCode) -> i32;
pub type uregex_end64 = unsafe extern "system" fn(regexp: *mut URegularExpression, groupnum: i32, status: *mut UErrorCode) -> i64;
pub type uregex_find = unsafe extern "system" fn(regexp: *mut URegularExpression, startindex: i32, status: *mut UErrorCode) -> i8;
pub type uregex_find64 = unsafe extern "system" fn(regexp: *mut URegularExpression, startindex: i64, status: *mut UErrorCode) -> i8;
pub type uregex_findNext = unsafe extern "system" fn(regexp: *mut URegularExpression, status: *mut UErrorCode) -> i8;
pub type uregex_flags = unsafe extern "system" fn(regexp: *const URegularExpression, status: *mut UErrorCode) -> i32;
pub type uregex_getFindProgressCallback = unsafe extern "system" fn(regexp: *const URegularExpression, callback: *mut URegexFindProgressCallback, context: *const *const ::core::ffi::c_void, status: *mut UErrorCode);
pub type uregex_getMatchCallback = unsafe extern "system" fn(regexp: *const URegularExpression, callback: *mut URegexMatchCallback, context: *const *const ::core::ffi::c_void, status: *mut UErrorCode);
pub type uregex_getStackLimit = unsafe extern "system" fn(regexp: *const URegularExpression, status: *mut UErrorCode) -> i32;
pub type uregex_getText = unsafe extern "system" fn(regexp: *mut URegularExpression, textlength: *mut i32, status: *mut UErrorCode) -> *mut u16;
pub type uregex_getTimeLimit = unsafe extern "system" fn(regexp: *const URegularExpression, status: *mut UErrorCode) -> i32;
pub type uregex_getUText = unsafe extern "system" fn(regexp: *mut URegularExpression, dest: *mut UText, status: *mut UErrorCode) -> *mut UText;
pub type uregex_group = unsafe extern "system" fn(regexp: *mut URegularExpression, groupnum: i32, dest: *mut u16, destcapacity: i32, status: *mut UErrorCode) -> i32;
pub type uregex_groupCount = unsafe extern "system" fn(regexp: *mut URegularExpression, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uregex_groupNumberFromCName = unsafe extern "system" fn(regexp: *mut URegularExpression, groupname: super::Foundation::PSTR, namelength: i32, status: *mut UErrorCode) -> i32;
pub type uregex_groupNumberFromName = unsafe extern "system" fn(regexp: *mut URegularExpression, groupname: *const u16, namelength: i32, status: *mut UErrorCode) -> i32;
pub type uregex_groupUText = unsafe extern "system" fn(regexp: *mut URegularExpression, groupnum: i32, dest: *mut UText, grouplength: *mut i64, status: *mut UErrorCode) -> *mut UText;
pub type uregex_hasAnchoringBounds = unsafe extern "system" fn(regexp: *const URegularExpression, status: *mut UErrorCode) -> i8;
pub type uregex_hasTransparentBounds = unsafe extern "system" fn(regexp: *const URegularExpression, status: *mut UErrorCode) -> i8;
pub type uregex_hitEnd = unsafe extern "system" fn(regexp: *const URegularExpression, status: *mut UErrorCode) -> i8;
pub type uregex_lookingAt = unsafe extern "system" fn(regexp: *mut URegularExpression, startindex: i32, status: *mut UErrorCode) -> i8;
pub type uregex_lookingAt64 = unsafe extern "system" fn(regexp: *mut URegularExpression, startindex: i64, status: *mut UErrorCode) -> i8;
pub type uregex_matches = unsafe extern "system" fn(regexp: *mut URegularExpression, startindex: i32, status: *mut UErrorCode) -> i8;
pub type uregex_matches64 = unsafe extern "system" fn(regexp: *mut URegularExpression, startindex: i64, status: *mut UErrorCode) -> i8;
pub type uregex_open = unsafe extern "system" fn(pattern: *const u16, patternlength: i32, flags: u32, pe: *mut UParseError, status: *mut UErrorCode) -> *mut URegularExpression;
#[cfg(feature = "Win32_Foundation")]
pub type uregex_openC = unsafe extern "system" fn(pattern: super::Foundation::PSTR, flags: u32, pe: *mut UParseError, status: *mut UErrorCode) -> *mut URegularExpression;
pub type uregex_openUText = unsafe extern "system" fn(pattern: *mut UText, flags: u32, pe: *mut UParseError, status: *mut UErrorCode) -> *mut URegularExpression;
pub type uregex_pattern = unsafe extern "system" fn(regexp: *const URegularExpression, patlength: *mut i32, status: *mut UErrorCode) -> *mut u16;
pub type uregex_patternUText = unsafe extern "system" fn(regexp: *const URegularExpression, status: *mut UErrorCode) -> *mut UText;
pub type uregex_refreshUText = unsafe extern "system" fn(regexp: *mut URegularExpression, text: *mut UText, status: *mut UErrorCode);
pub type uregex_regionEnd = unsafe extern "system" fn(regexp: *const URegularExpression, status: *mut UErrorCode) -> i32;
pub type uregex_regionEnd64 = unsafe extern "system" fn(regexp: *const URegularExpression, status: *mut UErrorCode) -> i64;
pub type uregex_regionStart = unsafe extern "system" fn(regexp: *const URegularExpression, status: *mut UErrorCode) -> i32;
pub type uregex_regionStart64 = unsafe extern "system" fn(regexp: *const URegularExpression, status: *mut UErrorCode) -> i64;
pub type uregex_replaceAll = unsafe extern "system" fn(regexp: *mut URegularExpression, replacementtext: *const u16, replacementlength: i32, destbuf: *mut u16, destcapacity: i32, status: *mut UErrorCode) -> i32;
pub type uregex_replaceAllUText = unsafe extern "system" fn(regexp: *mut URegularExpression, replacement: *mut UText, dest: *mut UText, status: *mut UErrorCode) -> *mut UText;
pub type uregex_replaceFirst = unsafe extern "system" fn(regexp: *mut URegularExpression, replacementtext: *const u16, replacementlength: i32, destbuf: *mut u16, destcapacity: i32, status: *mut UErrorCode) -> i32;
pub type uregex_replaceFirstUText = unsafe extern "system" fn(regexp: *mut URegularExpression, replacement: *mut UText, dest: *mut UText, status: *mut UErrorCode) -> *mut UText;
pub type uregex_requireEnd = unsafe extern "system" fn(regexp: *const URegularExpression, status: *mut UErrorCode) -> i8;
pub type uregex_reset = unsafe extern "system" fn(regexp: *mut URegularExpression, index: i32, status: *mut UErrorCode);
pub type uregex_reset64 = unsafe extern "system" fn(regexp: *mut URegularExpression, index: i64, status: *mut UErrorCode);
pub type uregex_setFindProgressCallback = unsafe extern "system" fn(regexp: *mut URegularExpression, callback: URegexFindProgressCallback, context: *const ::core::ffi::c_void, status: *mut UErrorCode);
pub type uregex_setMatchCallback = unsafe extern "system" fn(regexp: *mut URegularExpression, callback: URegexMatchCallback, context: *const ::core::ffi::c_void, status: *mut UErrorCode);
pub type uregex_setRegion = unsafe extern "system" fn(regexp: *mut URegularExpression, regionstart: i32, regionlimit: i32, status: *mut UErrorCode);
pub type uregex_setRegion64 = unsafe extern "system" fn(regexp: *mut URegularExpression, regionstart: i64, regionlimit: i64, status: *mut UErrorCode);
pub type uregex_setRegionAndStart = unsafe extern "system" fn(regexp: *mut URegularExpression, regionstart: i64, regionlimit: i64, startindex: i64, status: *mut UErrorCode);
pub type uregex_setStackLimit = unsafe extern "system" fn(regexp: *mut URegularExpression, limit: i32, status: *mut UErrorCode);
pub type uregex_setText = unsafe extern "system" fn(regexp: *mut URegularExpression, text: *const u16, textlength: i32, status: *mut UErrorCode);
pub type uregex_setTimeLimit = unsafe extern "system" fn(regexp: *mut URegularExpression, limit: i32, status: *mut UErrorCode);
pub type uregex_setUText = unsafe extern "system" fn(regexp: *mut URegularExpression, text: *mut UText, status: *mut UErrorCode);
pub type uregex_split = unsafe extern "system" fn(regexp: *mut URegularExpression, destbuf: *mut u16, destcapacity: i32, requiredcapacity: *mut i32, destfields: *mut *mut u16, destfieldscapacity: i32, status: *mut UErrorCode) -> i32;
pub type uregex_splitUText = unsafe extern "system" fn(regexp: *mut URegularExpression, destfields: *mut *mut UText, destfieldscapacity: i32, status: *mut UErrorCode) -> i32;
pub type uregex_start = unsafe extern "system" fn(regexp: *mut URegularExpression, groupnum: i32, status: *mut UErrorCode) -> i32;
pub type uregex_start64 = unsafe extern "system" fn(regexp: *mut URegularExpression, groupnum: i32, status: *mut UErrorCode) -> i64;
pub type uregex_useAnchoringBounds = unsafe extern "system" fn(regexp: *mut URegularExpression, b: i8, status: *mut UErrorCode);
pub type uregex_useTransparentBounds = unsafe extern "system" fn(regexp: *mut URegularExpression, b: i8, status: *mut UErrorCode);
pub type uregion_areEqual = unsafe extern "system" fn(uregion: *const URegion, otherregion: *const URegion) -> i8;
pub type uregion_contains = unsafe extern "system" fn(uregion: *const URegion, otherregion: *const URegion) -> i8;
pub type uregion_getAvailable = unsafe extern "system" fn(r#type: URegionType, status: *mut UErrorCode) -> *mut UEnumeration;
pub type uregion_getContainedRegions = unsafe extern "system" fn(uregion: *const URegion, status: *mut UErrorCode) -> *mut UEnumeration;
pub type uregion_getContainedRegionsOfType = unsafe extern "system" fn(uregion: *const URegion, r#type: URegionType, status: *mut UErrorCode) -> *mut UEnumeration;
pub type uregion_getContainingRegion = unsafe extern "system" fn(uregion: *const URegion) -> *mut URegion;
pub type uregion_getContainingRegionOfType = unsafe extern "system" fn(uregion: *const URegion, r#type: URegionType) -> *mut URegion;
pub type uregion_getNumericCode = unsafe extern "system" fn(uregion: *const URegion) -> i32;
pub type uregion_getPreferredValues = unsafe extern "system" fn(uregion: *const URegion, status: *mut UErrorCode) -> *mut UEnumeration;
#[cfg(feature = "Win32_Foundation")]
pub type uregion_getRegionCode = unsafe extern "system" fn(uregion: *const URegion) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type uregion_getRegionFromCode = unsafe extern "system" fn(regioncode: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut URegion;
pub type uregion_getRegionFromNumericCode = unsafe extern "system" fn(code: i32, status: *mut UErrorCode) -> *mut URegion;
pub type uregion_getType = unsafe extern "system" fn(uregion: *const URegion) -> URegionType;
pub type ureldatefmt_close = unsafe extern "system" fn(reldatefmt: *mut URelativeDateTimeFormatter);
pub type ureldatefmt_closeResult = unsafe extern "system" fn(ufrdt: *mut UFormattedRelativeDateTime);
pub type ureldatefmt_combineDateAndTime = unsafe extern "system" fn(reldatefmt: *const URelativeDateTimeFormatter, relativedatestring: *const u16, relativedatestringlen: i32, timestring: *const u16, timestringlen: i32, result: *mut u16, resultcapacity: i32, status: *mut UErrorCode) -> i32;
pub type ureldatefmt_format = unsafe extern "system" fn(reldatefmt: *const URelativeDateTimeFormatter, offset: f64, unit: URelativeDateTimeUnit, result: *mut u16, resultcapacity: i32, status: *mut UErrorCode) -> i32;
pub type ureldatefmt_formatNumeric = unsafe extern "system" fn(reldatefmt: *const URelativeDateTimeFormatter, offset: f64, unit: URelativeDateTimeUnit, result: *mut u16, resultcapacity: i32, status: *mut UErrorCode) -> i32;
pub type ureldatefmt_formatNumericToResult = unsafe extern "system" fn(reldatefmt: *const URelativeDateTimeFormatter, offset: f64, unit: URelativeDateTimeUnit, result: *mut UFormattedRelativeDateTime, status: *mut UErrorCode);
pub type ureldatefmt_formatToResult = unsafe extern "system" fn(reldatefmt: *const URelativeDateTimeFormatter, offset: f64, unit: URelativeDateTimeUnit, result: *mut UFormattedRelativeDateTime, status: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type ureldatefmt_open = unsafe extern "system" fn(locale: super::Foundation::PSTR, nftoadopt: *mut *mut ::core::ffi::c_void, width: UDateRelativeDateTimeFormatterStyle, capitalizationcontext: UDisplayContext, status: *mut UErrorCode) -> *mut URelativeDateTimeFormatter;
pub type ureldatefmt_openResult = unsafe extern "system" fn(ec: *mut UErrorCode) -> *mut UFormattedRelativeDateTime;
pub type ureldatefmt_resultAsValue = unsafe extern "system" fn(ufrdt: *const UFormattedRelativeDateTime, ec: *mut UErrorCode) -> *mut UFormattedValue;
pub type ures_close = unsafe extern "system" fn(resourcebundle: *mut UResourceBundle);
pub type ures_getBinary = unsafe extern "system" fn(resourcebundle: *const UResourceBundle, len: *mut i32, status: *mut UErrorCode) -> *mut u8;
pub type ures_getByIndex = unsafe extern "system" fn(resourcebundle: *const UResourceBundle, indexr: i32, fillin: *mut UResourceBundle, status: *mut UErrorCode) -> *mut UResourceBundle;
#[cfg(feature = "Win32_Foundation")]
pub type ures_getByKey = unsafe extern "system" fn(resourcebundle: *const UResourceBundle, key: super::Foundation::PSTR, fillin: *mut UResourceBundle, status: *mut UErrorCode) -> *mut UResourceBundle;
pub type ures_getInt = unsafe extern "system" fn(resourcebundle: *const UResourceBundle, status: *mut UErrorCode) -> i32;
pub type ures_getIntVector = unsafe extern "system" fn(resourcebundle: *const UResourceBundle, len: *mut i32, status: *mut UErrorCode) -> *mut i32;
#[cfg(feature = "Win32_Foundation")]
pub type ures_getKey = unsafe extern "system" fn(resourcebundle: *const UResourceBundle) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type ures_getLocaleByType = unsafe extern "system" fn(resourcebundle: *const UResourceBundle, r#type: ULocDataLocaleType, status: *mut UErrorCode) -> super::Foundation::PSTR;
pub type ures_getNextResource = unsafe extern "system" fn(resourcebundle: *mut UResourceBundle, fillin: *mut UResourceBundle, status: *mut UErrorCode) -> *mut UResourceBundle;
pub type ures_getNextString = unsafe extern "system" fn(resourcebundle: *mut UResourceBundle, len: *mut i32, key: *const *const i8, status: *mut UErrorCode) -> *mut u16;
pub type ures_getSize = unsafe extern "system" fn(resourcebundle: *const UResourceBundle) -> i32;
pub type ures_getString = unsafe extern "system" fn(resourcebundle: *const UResourceBundle, len: *mut i32, status: *mut UErrorCode) -> *mut u16;
pub type ures_getStringByIndex = unsafe extern "system" fn(resourcebundle: *const UResourceBundle, indexs: i32, len: *mut i32, status: *mut UErrorCode) -> *mut u16;
#[cfg(feature = "Win32_Foundation")]
pub type ures_getStringByKey = unsafe extern "system" fn(resb: *const UResourceBundle, key: super::Foundation::PSTR, len: *mut i32, status: *mut UErrorCode) -> *mut u16;
pub type ures_getType = unsafe extern "system" fn(resourcebundle: *const UResourceBundle) -> UResType;
pub type ures_getUInt = unsafe extern "system" fn(resourcebundle: *const UResourceBundle, status: *mut UErrorCode) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type ures_getUTF8String = unsafe extern "system" fn(resb: *const UResourceBundle, dest: super::Foundation::PSTR, length: *mut i32, forcecopy: i8, status: *mut UErrorCode) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type ures_getUTF8StringByIndex = unsafe extern "system" fn(resb: *const UResourceBundle, stringindex: i32, dest: super::Foundation::PSTR, plength: *mut i32, forcecopy: i8, status: *mut UErrorCode) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type ures_getUTF8StringByKey = unsafe extern "system" fn(resb: *const UResourceBundle, key: super::Foundation::PSTR, dest: super::Foundation::PSTR, plength: *mut i32, forcecopy: i8, status: *mut UErrorCode) -> super::Foundation::PSTR;
pub type ures_getVersion = unsafe extern "system" fn(resb: *const UResourceBundle, versioninfo: *mut u8);
pub type ures_hasNext = unsafe extern "system" fn(resourcebundle: *const UResourceBundle) -> i8;
#[cfg(feature = "Win32_Foundation")]
pub type ures_open = unsafe extern "system" fn(packagename: super::Foundation::PSTR, locale: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut UResourceBundle;
#[cfg(feature = "Win32_Foundation")]
pub type ures_openAvailableLocales = unsafe extern "system" fn(packagename: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut UEnumeration;
#[cfg(feature = "Win32_Foundation")]
pub type ures_openDirect = unsafe extern "system" fn(packagename: super::Foundation::PSTR, locale: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut UResourceBundle;
#[cfg(feature = "Win32_Foundation")]
pub type ures_openU = unsafe extern "system" fn(packagename: *const u16, locale: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut UResourceBundle;
pub type ures_resetIterator = unsafe extern "system" fn(resourcebundle: *mut UResourceBundle);
pub type uscript_breaksBetweenLetters = unsafe extern "system" fn(script: UScriptCode) -> i8;
#[cfg(feature = "Win32_Foundation")]
pub type uscript_getCode = unsafe extern "system" fn(nameorabbrorlocale: super::Foundation::PSTR, fillin: *mut UScriptCode, capacity: i32, err: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uscript_getName = unsafe extern "system" fn(scriptcode: UScriptCode) -> super::Foundation::PSTR;
pub type uscript_getSampleString = unsafe extern "system" fn(script: UScriptCode, dest: *mut u16, capacity: i32, perrorcode: *mut UErrorCode) -> i32;
pub type uscript_getScript = unsafe extern "system" fn(codepoint: i32, err: *mut UErrorCode) -> UScriptCode;
pub type uscript_getScriptExtensions = unsafe extern "system" fn(c: i32, scripts: *mut UScriptCode, capacity: i32, errorcode: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uscript_getShortName = unsafe extern "system" fn(scriptcode: UScriptCode) -> super::Foundation::PSTR;
pub type uscript_getUsage = unsafe extern "system" fn(script: UScriptCode) -> UScriptUsage;
pub type uscript_hasScript = unsafe extern "system" fn(c: i32, sc: UScriptCode) -> i8;
pub type uscript_isCased = unsafe extern "system" fn(script: UScriptCode) -> i8;
pub type uscript_isRightToLeft = unsafe extern "system" fn(script: UScriptCode) -> i8;
pub type usearch_close = unsafe extern "system" fn(searchiter: *mut UStringSearch);
pub type usearch_first = unsafe extern "system" fn(strsrch: *mut UStringSearch, status: *mut UErrorCode) -> i32;
pub type usearch_following = unsafe extern "system" fn(strsrch: *mut UStringSearch, position: i32, status: *mut UErrorCode) -> i32;
pub type usearch_getAttribute = unsafe extern "system" fn(strsrch: *const UStringSearch, attribute: USearchAttribute) -> USearchAttributeValue;
pub type usearch_getBreakIterator = unsafe extern "system" fn(strsrch: *const UStringSearch) -> *mut UBreakIterator;
pub type usearch_getCollator = unsafe extern "system" fn(strsrch: *const UStringSearch) -> *mut UCollator;
pub type usearch_getMatchedLength = unsafe extern "system" fn(strsrch: *const UStringSearch) -> i32;
pub type usearch_getMatchedStart = unsafe extern "system" fn(strsrch: *const UStringSearch) -> i32;
pub type usearch_getMatchedText = unsafe extern "system" fn(strsrch: *const UStringSearch, result: *mut u16, resultcapacity: i32, status: *mut UErrorCode) -> i32;
pub type usearch_getOffset = unsafe extern "system" fn(strsrch: *const UStringSearch) -> i32;
pub type usearch_getPattern = unsafe extern "system" fn(strsrch: *const UStringSearch, length: *mut i32) -> *mut u16;
pub type usearch_getText = unsafe extern "system" fn(strsrch: *const UStringSearch, length: *mut i32) -> *mut u16;
pub type usearch_last = unsafe extern "system" fn(strsrch: *mut UStringSearch, status: *mut UErrorCode) -> i32;
pub type usearch_next = unsafe extern "system" fn(strsrch: *mut UStringSearch, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type usearch_open = unsafe extern "system" fn(pattern: *const u16, patternlength: i32, text: *const u16, textlength: i32, locale: super::Foundation::PSTR, breakiter: *mut UBreakIterator, status: *mut UErrorCode) -> *mut UStringSearch;
pub type usearch_openFromCollator = unsafe extern "system" fn(pattern: *const u16, patternlength: i32, text: *const u16, textlength: i32, collator: *const UCollator, breakiter: *mut UBreakIterator, status: *mut UErrorCode) -> *mut UStringSearch;
pub type usearch_preceding = unsafe extern "system" fn(strsrch: *mut UStringSearch, position: i32, status: *mut UErrorCode) -> i32;
pub type usearch_previous = unsafe extern "system" fn(strsrch: *mut UStringSearch, status: *mut UErrorCode) -> i32;
pub type usearch_reset = unsafe extern "system" fn(strsrch: *mut UStringSearch);
pub type usearch_setAttribute = unsafe extern "system" fn(strsrch: *mut UStringSearch, attribute: USearchAttribute, value: USearchAttributeValue, status: *mut UErrorCode);
pub type usearch_setBreakIterator = unsafe extern "system" fn(strsrch: *mut UStringSearch, breakiter: *mut UBreakIterator, status: *mut UErrorCode);
pub type usearch_setCollator = unsafe extern "system" fn(strsrch: *mut UStringSearch, collator: *const UCollator, status: *mut UErrorCode);
pub type usearch_setOffset = unsafe extern "system" fn(strsrch: *mut UStringSearch, position: i32, status: *mut UErrorCode);
pub type usearch_setPattern = unsafe extern "system" fn(strsrch: *mut UStringSearch, pattern: *const u16, patternlength: i32, status: *mut UErrorCode);
pub type usearch_setText = unsafe extern "system" fn(strsrch: *mut UStringSearch, text: *const u16, textlength: i32, status: *mut UErrorCode);
pub type uset_add = unsafe extern "system" fn(set: *mut USet, c: i32);
pub type uset_addAll = unsafe extern "system" fn(set: *mut USet, additionalset: *const USet);
pub type uset_addAllCodePoints = unsafe extern "system" fn(set: *mut USet, str: *const u16, strlen: i32);
pub type uset_addRange = unsafe extern "system" fn(set: *mut USet, start: i32, end: i32);
pub type uset_addString = unsafe extern "system" fn(set: *mut USet, str: *const u16, strlen: i32);
pub type uset_applyIntPropertyValue = unsafe extern "system" fn(set: *mut USet, prop: UProperty, value: i32, ec: *mut UErrorCode);
pub type uset_applyPattern = unsafe extern "system" fn(set: *mut USet, pattern: *const u16, patternlength: i32, options: u32, status: *mut UErrorCode) -> i32;
pub type uset_applyPropertyAlias = unsafe extern "system" fn(set: *mut USet, prop: *const u16, proplength: i32, value: *const u16, valuelength: i32, ec: *mut UErrorCode);
pub type uset_charAt = unsafe extern "system" fn(set: *const USet, charindex: i32) -> i32;
pub type uset_clear = unsafe extern "system" fn(set: *mut USet);
pub type uset_clone = unsafe extern "system" fn(set: *const USet) -> *mut USet;
pub type uset_cloneAsThawed = unsafe extern "system" fn(set: *const USet) -> *mut USet;
pub type uset_close = unsafe extern "system" fn(set: *mut USet);
pub type uset_closeOver = unsafe extern "system" fn(set: *mut USet, attributes: i32);
pub type uset_compact = unsafe extern "system" fn(set: *mut USet);
pub type uset_complement = unsafe extern "system" fn(set: *mut USet);
pub type uset_complementAll = unsafe extern "system" fn(set: *mut USet, complement: *const USet);
pub type uset_contains = unsafe extern "system" fn(set: *const USet, c: i32) -> i8;
pub type uset_containsAll = unsafe extern "system" fn(set1: *const USet, set2: *const USet) -> i8;
pub type uset_containsAllCodePoints = unsafe extern "system" fn(set: *const USet, str: *const u16, strlen: i32) -> i8;
pub type uset_containsNone = unsafe extern "system" fn(set1: *const USet, set2: *const USet) -> i8;
pub type uset_containsRange = unsafe extern "system" fn(set: *const USet, start: i32, end: i32) -> i8;
pub type uset_containsSome = unsafe extern "system" fn(set1: *const USet, set2: *const USet) -> i8;
pub type uset_containsString = unsafe extern "system" fn(set: *const USet, str: *const u16, strlen: i32) -> i8;
pub type uset_equals = unsafe extern "system" fn(set1: *const USet, set2: *const USet) -> i8;
pub type uset_freeze = unsafe extern "system" fn(set: *mut USet);
pub type uset_getItem = unsafe extern "system" fn(set: *const USet, itemindex: i32, start: *mut i32, end: *mut i32, str: *mut u16, strcapacity: i32, ec: *mut UErrorCode) -> i32;
pub type uset_getItemCount = unsafe extern "system" fn(set: *const USet) -> i32;
pub type uset_getSerializedRange = unsafe extern "system" fn(set: *const USerializedSet, rangeindex: i32, pstart: *mut i32, pend: *mut i32) -> i8;
pub type uset_getSerializedRangeCount = unsafe extern "system" fn(set: *const USerializedSet) -> i32;
pub type uset_getSerializedSet = unsafe extern "system" fn(fillset: *mut USerializedSet, src: *const u16, srclength: i32) -> i8;
pub type uset_indexOf = unsafe extern "system" fn(set: *const USet, c: i32) -> i32;
pub type uset_isEmpty = unsafe extern "system" fn(set: *const USet) -> i8;
pub type uset_isFrozen = unsafe extern "system" fn(set: *const USet) -> i8;
pub type uset_open = unsafe extern "system" fn(start: i32, end: i32) -> *mut USet;
pub type uset_openEmpty = unsafe extern "system" fn() -> *mut USet;
pub type uset_openPattern = unsafe extern "system" fn(pattern: *const u16, patternlength: i32, ec: *mut UErrorCode) -> *mut USet;
pub type uset_openPatternOptions = unsafe extern "system" fn(pattern: *const u16, patternlength: i32, options: u32, ec: *mut UErrorCode) -> *mut USet;
pub type uset_remove = unsafe extern "system" fn(set: *mut USet, c: i32);
pub type uset_removeAll = unsafe extern "system" fn(set: *mut USet, removeset: *const USet);
pub type uset_removeAllStrings = unsafe extern "system" fn(set: *mut USet);
pub type uset_removeRange = unsafe extern "system" fn(set: *mut USet, start: i32, end: i32);
pub type uset_removeString = unsafe extern "system" fn(set: *mut USet, str: *const u16, strlen: i32);
pub type uset_resemblesPattern = unsafe extern "system" fn(pattern: *const u16, patternlength: i32, pos: i32) -> i8;
pub type uset_retain = unsafe extern "system" fn(set: *mut USet, start: i32, end: i32);
pub type uset_retainAll = unsafe extern "system" fn(set: *mut USet, retain: *const USet);
pub type uset_serialize = unsafe extern "system" fn(set: *const USet, dest: *mut u16, destcapacity: i32, perrorcode: *mut UErrorCode) -> i32;
pub type uset_serializedContains = unsafe extern "system" fn(set: *const USerializedSet, c: i32) -> i8;
pub type uset_set = unsafe extern "system" fn(set: *mut USet, start: i32, end: i32);
pub type uset_setSerializedToOne = unsafe extern "system" fn(fillset: *mut USerializedSet, c: i32);
pub type uset_size = unsafe extern "system" fn(set: *const USet) -> i32;
pub type uset_span = unsafe extern "system" fn(set: *const USet, s: *const u16, length: i32, spancondition: USetSpanCondition) -> i32;
pub type uset_spanBack = unsafe extern "system" fn(set: *const USet, s: *const u16, length: i32, spancondition: USetSpanCondition) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uset_spanBackUTF8 = unsafe extern "system" fn(set: *const USet, s: super::Foundation::PSTR, length: i32, spancondition: USetSpanCondition) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uset_spanUTF8 = unsafe extern "system" fn(set: *const USet, s: super::Foundation::PSTR, length: i32, spancondition: USetSpanCondition) -> i32;
pub type uset_toPattern = unsafe extern "system" fn(set: *const USet, result: *mut u16, resultcapacity: i32, escapeunprintable: i8, ec: *mut UErrorCode) -> i32;
pub type uspoof_areConfusable = unsafe extern "system" fn(sc: *const USpoofChecker, id1: *const u16, length1: i32, id2: *const u16, length2: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uspoof_areConfusableUTF8 = unsafe extern "system" fn(sc: *const USpoofChecker, id1: super::Foundation::PSTR, length1: i32, id2: super::Foundation::PSTR, length2: i32, status: *mut UErrorCode) -> i32;
pub type uspoof_check = unsafe extern "system" fn(sc: *const USpoofChecker, id: *const u16, length: i32, position: *mut i32, status: *mut UErrorCode) -> i32;
pub type uspoof_check2 = unsafe extern "system" fn(sc: *const USpoofChecker, id: *const u16, length: i32, checkresult: *mut USpoofCheckResult, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uspoof_check2UTF8 = unsafe extern "system" fn(sc: *const USpoofChecker, id: super::Foundation::PSTR, length: i32, checkresult: *mut USpoofCheckResult, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uspoof_checkUTF8 = unsafe extern "system" fn(sc: *const USpoofChecker, id: super::Foundation::PSTR, length: i32, position: *mut i32, status: *mut UErrorCode) -> i32;
pub type uspoof_clone = unsafe extern "system" fn(sc: *const USpoofChecker, status: *mut UErrorCode) -> *mut USpoofChecker;
pub type uspoof_close = unsafe extern "system" fn(sc: *mut USpoofChecker);
pub type uspoof_closeCheckResult = unsafe extern "system" fn(checkresult: *mut USpoofCheckResult);
pub type uspoof_getAllowedChars = unsafe extern "system" fn(sc: *const USpoofChecker, status: *mut UErrorCode) -> *mut USet;
#[cfg(feature = "Win32_Foundation")]
pub type uspoof_getAllowedLocales = unsafe extern "system" fn(sc: *mut USpoofChecker, status: *mut UErrorCode) -> super::Foundation::PSTR;
pub type uspoof_getCheckResultChecks = unsafe extern "system" fn(checkresult: *const USpoofCheckResult, status: *mut UErrorCode) -> i32;
pub type uspoof_getCheckResultNumerics = unsafe extern "system" fn(checkresult: *const USpoofCheckResult, status: *mut UErrorCode) -> *mut USet;
pub type uspoof_getCheckResultRestrictionLevel = unsafe extern "system" fn(checkresult: *const USpoofCheckResult, status: *mut UErrorCode) -> URestrictionLevel;
pub type uspoof_getChecks = unsafe extern "system" fn(sc: *const USpoofChecker, status: *mut UErrorCode) -> i32;
pub type uspoof_getInclusionSet = unsafe extern "system" fn(status: *mut UErrorCode) -> *mut USet;
pub type uspoof_getRecommendedSet = unsafe extern "system" fn(status: *mut UErrorCode) -> *mut USet;
pub type uspoof_getRestrictionLevel = unsafe extern "system" fn(sc: *const USpoofChecker) -> URestrictionLevel;
pub type uspoof_getSkeleton = unsafe extern "system" fn(sc: *const USpoofChecker, r#type: u32, id: *const u16, length: i32, dest: *mut u16, destcapacity: i32, status: *mut UErrorCode) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type uspoof_getSkeletonUTF8 = unsafe extern "system" fn(sc: *const USpoofChecker, r#type: u32, id: super::Foundation::PSTR, length: i32, dest: super::Foundation::PSTR, destcapacity: i32, status: *mut UErrorCode) -> i32;
pub type uspoof_open = unsafe extern "system" fn(status: *mut UErrorCode) -> *mut USpoofChecker;
pub type uspoof_openCheckResult = unsafe extern "system" fn(status: *mut UErrorCode) -> *mut USpoofCheckResult;
pub type uspoof_openFromSerialized = unsafe extern "system" fn(data: *const ::core::ffi::c_void, length: i32, pactuallength: *mut i32, perrorcode: *mut UErrorCode) -> *mut USpoofChecker;
#[cfg(feature = "Win32_Foundation")]
pub type uspoof_openFromSource = unsafe extern "system" fn(confusables: super::Foundation::PSTR, confusableslen: i32, confusableswholescript: super::Foundation::PSTR, confusableswholescriptlen: i32, errtype: *mut i32, pe: *mut UParseError, status: *mut UErrorCode) -> *mut USpoofChecker;
pub type uspoof_serialize = unsafe extern "system" fn(sc: *mut USpoofChecker, data: *mut ::core::ffi::c_void, capacity: i32, status: *mut UErrorCode) -> i32;
pub type uspoof_setAllowedChars = unsafe extern "system" fn(sc: *mut USpoofChecker, chars: *const USet, status: *mut UErrorCode);
#[cfg(feature = "Win32_Foundation")]
pub type uspoof_setAllowedLocales = unsafe extern "system" fn(sc: *mut USpoofChecker, localeslist: super::Foundation::PSTR, status: *mut UErrorCode);
pub type uspoof_setChecks = unsafe extern "system" fn(sc: *mut USpoofChecker, checks: i32, status: *mut UErrorCode);
pub type uspoof_setRestrictionLevel = unsafe extern "system" fn(sc: *mut USpoofChecker, restrictionlevel: URestrictionLevel);
pub type usprep_close = unsafe extern "system" fn(profile: *mut UStringPrepProfile);
#[cfg(feature = "Win32_Foundation")]
pub type usprep_open = unsafe extern "system" fn(path: super::Foundation::PSTR, filename: super::Foundation::PSTR, status: *mut UErrorCode) -> *mut UStringPrepProfile;
pub type usprep_openByType = unsafe extern "system" fn(r#type: UStringPrepProfileType, status: *mut UErrorCode) -> *mut UStringPrepProfile;
pub type usprep_prepare = unsafe extern "system" fn(prep: *const UStringPrepProfile, src: *const u16, srclength: i32, dest: *mut u16, destcapacity: i32, options: i32, parseerror: *mut UParseError, status: *mut UErrorCode) -> i32;
pub type utext_char32At = unsafe extern "system" fn(ut: *mut UText, nativeindex: i64) -> i32;
pub type utext_clone = unsafe extern "system" fn(dest: *mut UText, src: *const UText, deep: i8, readonly: i8, status: *mut UErrorCode) -> *mut UText;
pub type utext_close = unsafe extern "system" fn(ut: *mut UText) -> *mut UText;
pub type utext_copy = unsafe extern "system" fn(ut: *mut UText, nativestart: i64, nativelimit: i64, destindex: i64, r#move: i8, status: *mut UErrorCode);
pub type utext_current32 = unsafe extern "system" fn(ut: *mut UText) -> i32;
pub type utext_equals = unsafe extern "system" fn(a: *const UText, b: *const UText) -> i8;
pub type utext_extract = unsafe extern "system" fn(ut: *mut UText, nativestart: i64, nativelimit: i64, dest: *mut u16, destcapacity: i32, status: *mut UErrorCode) -> i32;
pub type utext_freeze = unsafe extern "system" fn(ut: *mut UText);
pub type utext_getNativeIndex = unsafe extern "system" fn(ut: *const UText) -> i64;
pub type utext_getPreviousNativeIndex = unsafe extern "system" fn(ut: *mut UText) -> i64;
pub type utext_hasMetaData = unsafe extern "system" fn(ut: *const UText) -> i8;
pub type utext_isLengthExpensive = unsafe extern "system" fn(ut: *const UText) -> i8;
pub type utext_isWritable = unsafe extern "system" fn(ut: *const UText) -> i8;
pub type utext_moveIndex32 = unsafe extern "system" fn(ut: *mut UText, delta: i32) -> i8;
pub type utext_nativeLength = unsafe extern "system" fn(ut: *mut UText) -> i64;
pub type utext_next32 = unsafe extern "system" fn(ut: *mut UText) -> i32;
pub type utext_next32From = unsafe extern "system" fn(ut: *mut UText, nativeindex: i64) -> i32;
pub type utext_openUChars = unsafe extern "system" fn(ut: *mut UText, s: *const u16, length: i64, status: *mut UErrorCode) -> *mut UText;
#[cfg(feature = "Win32_Foundation")]
pub type utext_openUTF8 = unsafe extern "system" fn(ut: *mut UText, s: super::Foundation::PSTR, length: i64, status: *mut UErrorCode) -> *mut UText;
pub type utext_previous32 = unsafe extern "system" fn(ut: *mut UText) -> i32;
pub type utext_previous32From = unsafe extern "system" fn(ut: *mut UText, nativeindex: i64) -> i32;
pub type utext_replace = unsafe extern "system" fn(ut: *mut UText, nativestart: i64, nativelimit: i64, replacementtext: *const u16, replacementlength: i32, status: *mut UErrorCode) -> i32;
pub type utext_setNativeIndex = unsafe extern "system" fn(ut: *mut UText, nativeindex: i64);
pub type utext_setup = unsafe extern "system" fn(ut: *mut UText, extraspace: i32, status: *mut UErrorCode) -> *mut UText;
pub type utf8_appendCharSafeBody = unsafe extern "system" fn(s: *mut u8, i: i32, length: i32, c: i32, piserror: *mut i8) -> i32;
pub type utf8_back1SafeBody = unsafe extern "system" fn(s: *const u8, start: i32, i: i32) -> i32;
pub type utf8_nextCharSafeBody = unsafe extern "system" fn(s: *const u8, pi: *mut i32, length: i32, c: i32, strict: i8) -> i32;
pub type utf8_prevCharSafeBody = unsafe extern "system" fn(s: *const u8, start: i32, pi: *mut i32, c: i32, strict: i8) -> i32;
pub type utmscale_fromInt64 = unsafe extern "system" fn(othertime: i64, timescale: UDateTimeScale, status: *mut UErrorCode) -> i64;
pub type utmscale_getTimeScaleValue = unsafe extern "system" fn(timescale: UDateTimeScale, value: UTimeScaleValue, status: *mut UErrorCode) -> i64;
pub type utmscale_toInt64 = unsafe extern "system" fn(universaltime: i64, timescale: UDateTimeScale, status: *mut UErrorCode) -> i64;
#[cfg(feature = "Win32_Foundation")]
pub type utrace_format = unsafe extern "system" fn(outbuf: super::Foundation::PSTR, capacity: i32, indent: i32, fmt: super::Foundation::PSTR) -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type utrace_functionName = unsafe extern "system" fn(fnnumber: i32) -> super::Foundation::PSTR;
#[cfg(feature = "Win32_Foundation")]
pub type utrace_getFunctions = unsafe extern "system" fn(context: *const *const ::core::ffi::c_void, e: *mut UTraceEntry, x: *mut UTraceExit, d: *mut UTraceData);
pub type utrace_getLevel = unsafe extern "system" fn() -> i32;
#[cfg(feature = "Win32_Foundation")]
pub type utrace_setFunctions = unsafe extern "system" fn(context: *const ::core::ffi::c_void, e: UTraceEntry, x: UTraceExit, d: UTraceData);
pub type utrace_setLevel = unsafe extern "system" fn(tracelevel: i32);
#[cfg(feature = "Win32_Foundation")]
pub type utrace_vformat = unsafe extern "system" fn(outbuf: super::Foundation::PSTR, capacity: i32, indent: i32, fmt: super::Foundation::PSTR, args: *mut i8) -> i32;
pub type utrans_clone = unsafe extern "system" fn(trans: *const *const ::core::ffi::c_void, status: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
pub type utrans_close = unsafe extern "system" fn(trans: *mut *mut ::core::ffi::c_void);
pub type utrans_countAvailableIDs = unsafe extern "system" fn() -> i32;
pub type utrans_getSourceSet = unsafe extern "system" fn(trans: *const *const ::core::ffi::c_void, ignorefilter: i8, fillin: *mut USet, status: *mut UErrorCode) -> *mut USet;
pub type utrans_getUnicodeID = unsafe extern "system" fn(trans: *const *const ::core::ffi::c_void, resultlength: *mut i32) -> *mut u16;
pub type utrans_openIDs = unsafe extern "system" fn(perrorcode: *mut UErrorCode) -> *mut UEnumeration;
pub type utrans_openInverse = unsafe extern "system" fn(trans: *const *const ::core::ffi::c_void, status: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
pub type utrans_openU = unsafe extern "system" fn(id: *const u16, idlength: i32, dir: UTransDirection, rules: *const u16, ruleslength: i32, parseerror: *mut UParseError, perrorcode: *mut UErrorCode) -> *mut *mut ::core::ffi::c_void;
pub type utrans_register = unsafe extern "system" fn(adoptedtrans: *mut *mut ::core::ffi::c_void, status: *mut UErrorCode);
pub type utrans_setFilter = unsafe extern "system" fn(trans: *mut *mut ::core::ffi::c_void, filterpattern: *const u16, filterpatternlen: i32, status: *mut UErrorCode);
pub type utrans_toRules = unsafe extern "system" fn(trans: *const *const ::core::ffi::c_void, escapeunprintable: i8, result: *mut u16, resultlength: i32, status: *mut UErrorCode) -> i32;
pub type utrans_trans = unsafe extern "system" fn(trans: *const *const ::core::ffi::c_void, rep: *mut *mut ::core::ffi::c_void, repfunc: *const UReplaceableCallbacks, start: i32, limit: *mut i32, status: *mut UErrorCode);
pub type utrans_transIncremental = unsafe extern "system" fn(trans: *const *const ::core::ffi::c_void, rep: *mut *mut ::core::ffi::c_void, repfunc: *const UReplaceableCallbacks, pos: *mut UTransPosition, status: *mut UErrorCode);
pub type utrans_transIncrementalUChars = unsafe extern "system" fn(trans: *const *const ::core::ffi::c_void, text: *mut u16, textlength: *mut i32, textcapacity: i32, pos: *mut UTransPosition, status: *mut UErrorCode);
pub type utrans_transUChars = unsafe extern "system" fn(trans: *const *const ::core::ffi::c_void, text: *mut u16, textlength: *mut i32, textcapacity: i32, start: i32, limit: *mut i32, status: *mut UErrorCode);
pub type utrans_unregisterID = unsafe extern "system" fn(id: *const u16, idlength: i32);
