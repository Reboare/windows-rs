...
pub type DXCoreCreateAdapterFactory = unsafe extern "system" fn(riid: *const ::windows_sys::core::GUID, ppvfactory: *mut *mut ::core::ffi::c_void) -> ::windows_sys::core::HRESULT;
