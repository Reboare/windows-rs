...
pub type CreateAudioReverb = unsafe extern "system" fn(ppapo: *mut ::windows_sys::core::IUnknown) -> ::windows_sys::core::HRESULT;
pub type CreateAudioVolumeMeter = unsafe extern "system" fn(ppapo: *mut ::windows_sys::core::IUnknown) -> ::windows_sys::core::HRESULT;
pub type CreateFX = unsafe extern "system" fn(clsid: *const ::windows_sys::core::GUID, peffect: *mut ::windows_sys::core::IUnknown, pinitdat: *const ::core::ffi::c_void, initdatabytesize: u32) -> ::windows_sys::core::HRESULT;
pub type CreateHrtfApo = unsafe extern "system" fn(init: *const HrtfApoInit, xapo: *mut IXAPO) -> ::windows_sys::core::HRESULT;
pub type XAudio2CreateWithVersionInfo = unsafe extern "system" fn(ppxaudio2: *mut IXAudio2, flags: u32, xaudio2processor: u32, ntddiversion: u32) -> ::windows_sys::core::HRESULT;
