...
#[cfg(feature = "Win32_Foundation")]
pub type AccessCheckByTypeAndAuditAlarmW = unsafe extern "system" fn(
...
#[cfg(feature = "Win32_Foundation")]
pub type AccessCheckByTypeResultListAndAuditAlarmByHandleA = unsafe extern "system" fn(
    subsystemname: super::Foundation::PSTR,
    handleid: *const ::core::ffi::c_void,
...
#[cfg(feature = "Win32_Foundation")]
pub type AccessCheckByTypeResultListAndAuditAlarmByHandleW = unsafe extern "system" fn(
    subsystemname: super::Foundation::PWSTR,
    handleid: *const ::core::ffi::c_void,
    clienttoken: super::Foundation::HANDLE,
    objecttypename: super::Foundation::PWSTR,
...
#[cfg(feature = "Win32_Foundation")]
pub type AccessCheckByTypeResultListAndAuditAlarmW = unsafe extern "system" fn(
    subsystemname: super::Foundation::PWSTR,
    handleid: *const ::core::ffi::c_void,
    objecttypename: super::Foundation::PWSTR,
    objectname: super::Foundation::PWSTR,
...
#[cfg(feature = "Win32_Foundation")]
pub type AddAccessAllowedAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: u32, accessmask: u32, psid: super::Foundation::PSID) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AddAccessAllowedAceEx = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: u32, aceflags: ACE_FLAGS, accessmask: u32, psid: super::Foundation::PSID) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AddAccessAllowedObjectAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: u32, aceflags: ACE_FLAGS, accessmask: u32, objecttypeguid: *const ::windows_sys::core::GUID, inheritedobjecttypeguid: *const ::windows_sys::core::GUID, psid: super::Foundation::PSID) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AddAccessDeniedAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: u32, accessmask: u32, psid: super::Foundation::PSID) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AddAccessDeniedAceEx = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: u32, aceflags: ACE_FLAGS, accessmask: u32, psid: super::Foundation::PSID) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AddAccessDeniedObjectAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: u32, aceflags: ACE_FLAGS, accessmask: u32, objecttypeguid: *const ::windows_sys::core::GUID, inheritedobjecttypeguid: *const ::windows_sys::core::GUID, psid: super::Foundation::PSID) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AddAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: u32, dwstartingaceindex: u32, pacelist: *const ::core::ffi::c_void, nacelistlength: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AddAuditAccessAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: u32, dwaccessmask: u32, psid: super::Foundation::PSID, bauditsuccess: super::Foundation::BOOL, bauditfailure: super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AddAuditAccessAceEx = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: u32, aceflags: ACE_FLAGS, dwaccessmask: u32, psid: super::Foundation::PSID, bauditsuccess: super::Foundation::BOOL, bauditfailure: super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AddAuditAccessObjectAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: u32, aceflags: ACE_FLAGS, accessmask: u32, objecttypeguid: *const ::windows_sys::core::GUID, inheritedobjecttypeguid: *const ::windows_sys::core::GUID, psid: super::Foundation::PSID, bauditsuccess: super::Foundation::BOOL, bauditfailure: super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AddConditionalAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: u32, aceflags: ACE_FLAGS, acetype: u8, accessmask: u32, psid: super::Foundation::PSID, conditionstr: super::Foundation::PWSTR, returnlength: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AddMandatoryAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: ACE_REVISION, aceflags: ACE_FLAGS, mandatorypolicy: u32, plabelsid: super::Foundation::PSID) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AddResourceAttributeAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: u32, aceflags: ACE_FLAGS, accessmask: u32, psid: super::Foundation::PSID, pattributeinfo: *const CLAIM_SECURITY_ATTRIBUTES_INFORMATION, preturnlength: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AddScopedPolicyIDAce = unsafe extern "system" fn(pacl: *mut ACL, dwacerevision: u32, aceflags: ACE_FLAGS, accessmask: u32, psid: super::Foundation::PSID) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AdjustTokenGroups = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE, resettodefault: super::Foundation::BOOL, newstate: *const TOKEN_GROUPS, bufferlength: u32, previousstate: *mut TOKEN_GROUPS, returnlength: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AdjustTokenPrivileges = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE, disableallprivileges: super::Foundation::BOOL, newstate: *const TOKEN_PRIVILEGES, bufferlength: u32, previousstate: *mut TOKEN_PRIVILEGES, returnlength: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
...
#[cfg(feature = "Win32_Foundation")]
pub type AllocateLocallyUniqueId = unsafe extern "system" fn(luid: *mut super::Foundation::LUID) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AreAllAccessesGranted = unsafe extern "system" fn(grantedaccess: u32, desiredaccess: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type AreAnyAccessesGranted = unsafe extern "system" fn(grantedaccess: u32, desiredaccess: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type CheckTokenCapability = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE, capabilitysidtocheck: super::Foundation::PSID, hascapability: *mut super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type CheckTokenMembership = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE, sidtocheck: super::Foundation::PSID, ismember: *mut super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type CheckTokenMembershipEx = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE, sidtocheck: super::Foundation::PSID, flags: u32, ismember: *mut super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type ConvertToAutoInheritPrivateObjectSecurity = unsafe extern "system" fn(parentdescriptor: *const SECURITY_DESCRIPTOR, currentsecuritydescriptor: *const SECURITY_DESCRIPTOR, newsecuritydescriptor: *mut *mut SECURITY_DESCRIPTOR, objecttype: *const ::windows_sys::core::GUID, isdirectoryobject: super::Foundation::BOOLEAN, genericmapping: *const GENERIC_MAPPING) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type CopySid = unsafe extern "system" fn(ndestinationsidlength: u32, pdestinationsid: super::Foundation::PSID, psourcesid: super::Foundation::PSID) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type CreatePrivateObjectSecurity = unsafe extern "system" fn(parentdescriptor: *const SECURITY_DESCRIPTOR, creatordescriptor: *const SECURITY_DESCRIPTOR, newdescriptor: *mut *mut SECURITY_DESCRIPTOR, isdirectoryobject: super::Foundation::BOOL, token: super::Foundation::HANDLE, genericmapping: *const GENERIC_MAPPING) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
...
#[cfg(feature = "Win32_Foundation")]
pub type CreateWellKnownSid = unsafe extern "system" fn(wellknownsidtype: WELL_KNOWN_SID_TYPE, domainsid: super::Foundation::PSID, psid: super::Foundation::PSID, cbsid: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type DeleteAce = unsafe extern "system" fn(pacl: *mut ACL, dwaceindex: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type DeriveCapabilitySidsFromName = unsafe extern "system" fn(capname: super::Foundation::PWSTR, capabilitygroupsids: *mut *mut super::Foundation::PSID, capabilitygroupsidcount: *mut u32, capabilitysids: *mut *mut super::Foundation::PSID, capabilitysidcount: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type DestroyPrivateObjectSecurity = unsafe extern "system" fn(objectdescriptor: *const *const SECURITY_DESCRIPTOR) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type DuplicateToken = unsafe extern "system" fn(existingtokenhandle: super::Foundation::HANDLE, impersonationlevel: SECURITY_IMPERSONATION_LEVEL, duplicatetokenhandle: *mut super::Foundation::HANDLE) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type DuplicateTokenEx = unsafe extern "system" fn(hexistingtoken: super::Foundation::HANDLE, dwdesiredaccess: TOKEN_ACCESS_MASK, lptokenattributes: *const SECURITY_ATTRIBUTES, impersonationlevel: SECURITY_IMPERSONATION_LEVEL, tokentype: TOKEN_TYPE, phnewtoken: *mut super::Foundation::HANDLE) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EqualDomainSid = unsafe extern "system" fn(psid1: super::Foundation::PSID, psid2: super::Foundation::PSID, pfequal: *mut super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EqualPrefixSid = unsafe extern "system" fn(psid1: super::Foundation::PSID, psid2: super::Foundation::PSID) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type EqualSid = unsafe extern "system" fn(psid1: super::Foundation::PSID, psid2: super::Foundation::PSID) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type FindFirstFreeAce = unsafe extern "system" fn(pacl: *const ACL, pace: *mut *mut ::core::ffi::c_void) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type FreeSid = unsafe extern "system" fn(psid: super::Foundation::PSID) -> *mut ::core::ffi::c_void;
#[cfg(feature = "Win32_Foundation")]
pub type GetAce = unsafe extern "system" fn(pacl: *const ACL, dwaceindex: u32, pace: *mut *mut ::core::ffi::c_void) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetAclInformation = unsafe extern "system" fn(pacl: *const ACL, paclinformation: *mut ::core::ffi::c_void, naclinformationlength: u32, dwaclinformationclass: ACL_INFORMATION_CLASS) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetAppContainerAce = unsafe extern "system" fn(acl: *const ACL, startingaceindex: u32, appcontainerace: *mut *mut ::core::ffi::c_void, appcontaineraceindex: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetCachedSigningLevel = unsafe extern "system" fn(file: super::Foundation::HANDLE, flags: *mut u32, signinglevel: *mut u32, thumbprint: *mut u8, thumbprintsize: *mut u32, thumbprintalgorithm: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetFileSecurityA = unsafe extern "system" fn(lpfilename: super::Foundation::PSTR, requestedinformation: u32, psecuritydescriptor: *mut SECURITY_DESCRIPTOR, nlength: u32, lpnlengthneeded: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetFileSecurityW = unsafe extern "system" fn(lpfilename: super::Foundation::PWSTR, requestedinformation: u32, psecuritydescriptor: *mut SECURITY_DESCRIPTOR, nlength: u32, lpnlengthneeded: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetKernelObjectSecurity = unsafe extern "system" fn(handle: super::Foundation::HANDLE, requestedinformation: u32, psecuritydescriptor: *mut SECURITY_DESCRIPTOR, nlength: u32, lpnlengthneeded: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetLengthSid = unsafe extern "system" fn(psid: super::Foundation::PSID) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetPrivateObjectSecurity = unsafe extern "system" fn(objectdescriptor: *const SECURITY_DESCRIPTOR, securityinformation: u32, resultantdescriptor: *mut SECURITY_DESCRIPTOR, descriptorlength: u32, returnlength: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetSecurityDescriptorControl = unsafe extern "system" fn(psecuritydescriptor: *const SECURITY_DESCRIPTOR, pcontrol: *mut u16, lpdwrevision: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetSecurityDescriptorDacl = unsafe extern "system" fn(psecuritydescriptor: *const SECURITY_DESCRIPTOR, lpbdaclpresent: *mut i32, pdacl: *mut *mut ACL, lpbdacldefaulted: *mut i32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetSecurityDescriptorGroup = unsafe extern "system" fn(psecuritydescriptor: *const SECURITY_DESCRIPTOR, pgroup: *mut super::Foundation::PSID, lpbgroupdefaulted: *mut i32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetSecurityDescriptorLength = unsafe extern "system" fn(psecuritydescriptor: *const SECURITY_DESCRIPTOR) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetSecurityDescriptorOwner = unsafe extern "system" fn(psecuritydescriptor: *const SECURITY_DESCRIPTOR, powner: *mut super::Foundation::PSID, lpbownerdefaulted: *mut i32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetSecurityDescriptorRMControl = unsafe extern "system" fn(securitydescriptor: *const SECURITY_DESCRIPTOR, rmcontrol: *mut u8) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetSecurityDescriptorSacl = unsafe extern "system" fn(psecuritydescriptor: *const SECURITY_DESCRIPTOR, lpbsaclpresent: *mut i32, psacl: *mut *mut ACL, lpbsacldefaulted: *mut i32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetSidIdentifierAuthority = unsafe extern "system" fn(psid: super::Foundation::PSID) -> *mut SID_IDENTIFIER_AUTHORITY;
pub type GetSidLengthRequired = unsafe extern "system" fn(nsubauthoritycount: u8) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetSidSubAuthority = unsafe extern "system" fn(psid: super::Foundation::PSID, nsubauthority: u32) -> *mut u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetSidSubAuthorityCount = unsafe extern "system" fn(psid: super::Foundation::PSID) -> *mut u8;
#[cfg(feature = "Win32_Foundation")]
pub type GetTokenInformation = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE, tokeninformationclass: TOKEN_INFORMATION_CLASS, tokeninformation: *mut ::core::ffi::c_void, tokeninformationlength: u32, returnlength: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetUserObjectSecurity = unsafe extern "system" fn(hobj: super::Foundation::HANDLE, psirequested: *const u32, psid: *mut SECURITY_DESCRIPTOR, nlength: u32, lpnlengthneeded: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetWindowsAccountDomainSid = unsafe extern "system" fn(psid: super::Foundation::PSID, pdomainsid: super::Foundation::PSID, cbdomainsid: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type ImpersonateAnonymousToken = unsafe extern "system" fn(threadhandle: super::Foundation::HANDLE) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type ImpersonateLoggedOnUser = unsafe extern "system" fn(htoken: super::Foundation::HANDLE) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type ImpersonateSelf = unsafe extern "system" fn(impersonationlevel: SECURITY_IMPERSONATION_LEVEL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type InitializeAcl = unsafe extern "system" fn(pacl: *mut ACL, nacllength: u32, dwaclrevision: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type InitializeSecurityDescriptor = unsafe extern "system" fn(psecuritydescriptor: *mut SECURITY_DESCRIPTOR, dwrevision: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type InitializeSid = unsafe extern "system" fn(sid: super::Foundation::PSID, pidentifierauthority: *const SID_IDENTIFIER_AUTHORITY, nsubauthoritycount: u8) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsTokenRestricted = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsValidAcl = unsafe extern "system" fn(pacl: *const ACL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsValidSecurityDescriptor = unsafe extern "system" fn(psecuritydescriptor: *const SECURITY_DESCRIPTOR) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsValidSid = unsafe extern "system" fn(psid: super::Foundation::PSID) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsWellKnownSid = unsafe extern "system" fn(psid: super::Foundation::PSID, wellknownsidtype: WELL_KNOWN_SID_TYPE) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type LogonUserA = unsafe extern "system" fn(lpszusername: super::Foundation::PSTR, lpszdomain: super::Foundation::PSTR, lpszpassword: super::Foundation::PSTR, dwlogontype: LOGON32_LOGON, dwlogonprovider: LOGON32_PROVIDER, phtoken: *mut super::Foundation::HANDLE) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type LogonUserExA = unsafe extern "system" fn(lpszusername: super::Foundation::PSTR, lpszdomain: super::Foundation::PSTR, lpszpassword: super::Foundation::PSTR, dwlogontype: LOGON32_LOGON, dwlogonprovider: LOGON32_PROVIDER, phtoken: *mut super::Foundation::HANDLE, pplogonsid: *mut super::Foundation::PSID, ppprofilebuffer: *mut *mut ::core::ffi::c_void, pdwprofilelength: *mut u32, pquotalimits: *mut QUOTA_LIMITS) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type LogonUserExW = unsafe extern "system" fn(lpszusername: super::Foundation::PWSTR, lpszdomain: super::Foundation::PWSTR, lpszpassword: super::Foundation::PWSTR, dwlogontype: LOGON32_LOGON, dwlogonprovider: LOGON32_PROVIDER, phtoken: *mut super::Foundation::HANDLE, pplogonsid: *mut super::Foundation::PSID, ppprofilebuffer: *mut *mut ::core::ffi::c_void, pdwprofilelength: *mut u32, pquotalimits: *mut QUOTA_LIMITS) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type LogonUserW = unsafe extern "system" fn(lpszusername: super::Foundation::PWSTR, lpszdomain: super::Foundation::PWSTR, lpszpassword: super::Foundation::PWSTR, dwlogontype: LOGON32_LOGON, dwlogonprovider: LOGON32_PROVIDER, phtoken: *mut super::Foundation::HANDLE) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type LookupAccountNameA = unsafe extern "system" fn(lpsystemname: super::Foundation::PSTR, lpaccountname: super::Foundation::PSTR, sid: super::Foundation::PSID, cbsid: *mut u32, referenceddomainname: super::Foundation::PSTR, cchreferenceddomainname: *mut u32, peuse: *mut SID_NAME_USE) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type LookupAccountNameW = unsafe extern "system" fn(lpsystemname: super::Foundation::PWSTR, lpaccountname: super::Foundation::PWSTR, sid: super::Foundation::PSID, cbsid: *mut u32, referenceddomainname: super::Foundation::PWSTR, cchreferenceddomainname: *mut u32, peuse: *mut SID_NAME_USE) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type LookupAccountSidA = unsafe extern "system" fn(lpsystemname: super::Foundation::PSTR, sid: super::Foundation::PSID, name: super::Foundation::PSTR, cchname: *mut u32, referenceddomainname: super::Foundation::PSTR, cchreferenceddomainname: *mut u32, peuse: *mut SID_NAME_USE) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type LookupAccountSidW = unsafe extern "system" fn(lpsystemname: super::Foundation::PWSTR, sid: super::Foundation::PSID, name: super::Foundation::PWSTR, cchname: *mut u32, referenceddomainname: super::Foundation::PWSTR, cchreferenceddomainname: *mut u32, peuse: *mut SID_NAME_USE) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type LookupPrivilegeDisplayNameA = unsafe extern "system" fn(lpsystemname: super::Foundation::PSTR, lpname: super::Foundation::PSTR, lpdisplayname: super::Foundation::PSTR, cchdisplayname: *mut u32, lplanguageid: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type LookupPrivilegeDisplayNameW = unsafe extern "system" fn(lpsystemname: super::Foundation::PWSTR, lpname: super::Foundation::PWSTR, lpdisplayname: super::Foundation::PWSTR, cchdisplayname: *mut u32, lplanguageid: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type LookupPrivilegeNameA = unsafe extern "system" fn(lpsystemname: super::Foundation::PSTR, lpluid: *const super::Foundation::LUID, lpname: super::Foundation::PSTR, cchname: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type LookupPrivilegeNameW = unsafe extern "system" fn(lpsystemname: super::Foundation::PWSTR, lpluid: *const super::Foundation::LUID, lpname: super::Foundation::PWSTR, cchname: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type LookupPrivilegeValueA = unsafe extern "system" fn(lpsystemname: super::Foundation::PSTR, lpname: super::Foundation::PSTR, lpluid: *mut super::Foundation::LUID) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type LookupPrivilegeValueW = unsafe extern "system" fn(lpsystemname: super::Foundation::PWSTR, lpname: super::Foundation::PWSTR, lpluid: *mut super::Foundation::LUID) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type MakeAbsoluteSD = unsafe extern "system" fn(pselfrelativesecuritydescriptor: *const SECURITY_DESCRIPTOR, pabsolutesecuritydescriptor: *mut SECURITY_DESCRIPTOR, lpdwabsolutesecuritydescriptorsize: *mut u32, pdacl: *mut ACL, lpdwdaclsize: *mut u32, psacl: *mut ACL, lpdwsaclsize: *mut u32, powner: super::Foundation::PSID, lpdwownersize: *mut u32, pprimarygroup: super::Foundation::PSID, lpdwprimarygroupsize: *mut u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type MakeSelfRelativeSD = unsafe extern "system" fn(pabsolutesecuritydescriptor: *const SECURITY_DESCRIPTOR, pselfrelativesecuritydescriptor: *mut SECURITY_DESCRIPTOR, lpdwbufferlength: *mut u32) -> super::Foundation::BOOL;
pub type MapGenericMask = unsafe extern "system" fn(accessmask: *mut u32, genericmapping: *const GENERIC_MAPPING);
#[cfg(feature = "Win32_Foundation")]
pub type ObjectCloseAuditAlarmA = unsafe extern "system" fn(subsystemname: super::Foundation::PSTR, handleid: *const ::core::ffi::c_void, generateonclose: super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type ObjectCloseAuditAlarmW = unsafe extern "system" fn(subsystemname: super::Foundation::PWSTR, handleid: *const ::core::ffi::c_void, generateonclose: super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type ObjectDeleteAuditAlarmA = unsafe extern "system" fn(subsystemname: super::Foundation::PSTR, handleid: *const ::core::ffi::c_void, generateonclose: super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type ObjectDeleteAuditAlarmW = unsafe extern "system" fn(subsystemname: super::Foundation::PWSTR, handleid: *const ::core::ffi::c_void, generateonclose: super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type ObjectOpenAuditAlarmA =
    unsafe extern "system" fn(subsystemname: super::Foundation::PSTR, handleid: *const ::core::ffi::c_void, objecttypename: super::Foundation::PSTR, objectname: super::Foundation::PSTR, psecuritydescriptor: *const SECURITY_DESCRIPTOR, clienttoken: super::Foundation::HANDLE, desiredaccess: u32, grantedaccess: u32, privileges: *const PRIVILEGE_SET, objectcreation: super::Foundation::BOOL, accessgranted: super::Foundation::BOOL, generateonclose: *mut i32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type ObjectOpenAuditAlarmW =
    unsafe extern "system" fn(subsystemname: super::Foundation::PWSTR, handleid: *const ::core::ffi::c_void, objecttypename: super::Foundation::PWSTR, objectname: super::Foundation::PWSTR, psecuritydescriptor: *const SECURITY_DESCRIPTOR, clienttoken: super::Foundation::HANDLE, desiredaccess: u32, grantedaccess: u32, privileges: *const PRIVILEGE_SET, objectcreation: super::Foundation::BOOL, accessgranted: super::Foundation::BOOL, generateonclose: *mut i32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type ObjectPrivilegeAuditAlarmA = unsafe extern "system" fn(subsystemname: super::Foundation::PSTR, handleid: *const ::core::ffi::c_void, clienttoken: super::Foundation::HANDLE, desiredaccess: u32, privileges: *const PRIVILEGE_SET, accessgranted: super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type ObjectPrivilegeAuditAlarmW = unsafe extern "system" fn(subsystemname: super::Foundation::PWSTR, handleid: *const ::core::ffi::c_void, clienttoken: super::Foundation::HANDLE, desiredaccess: u32, privileges: *const PRIVILEGE_SET, accessgranted: super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type PrivilegeCheck = unsafe extern "system" fn(clienttoken: super::Foundation::HANDLE, requiredprivileges: *mut PRIVILEGE_SET, pfresult: *mut i32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type PrivilegedServiceAuditAlarmA = unsafe extern "system" fn(subsystemname: super::Foundation::PSTR, servicename: super::Foundation::PSTR, clienttoken: super::Foundation::HANDLE, privileges: *const PRIVILEGE_SET, accessgranted: super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type PrivilegedServiceAuditAlarmW = unsafe extern "system" fn(subsystemname: super::Foundation::PWSTR, servicename: super::Foundation::PWSTR, clienttoken: super::Foundation::HANDLE, privileges: *const PRIVILEGE_SET, accessgranted: super::Foundation::BOOL) -> super::Foundation::BOOL;
pub type QuerySecurityAccessMask = unsafe extern "system" fn(securityinformation: u32, desiredaccess: *mut u32);
#[cfg(feature = "Win32_Foundation")]
pub type RevertToSelf = unsafe extern "system" fn() -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type RtlConvertSidToUnicodeString = unsafe extern "system" fn(unicodestring: *mut super::Foundation::UNICODE_STRING, sid: super::Foundation::PSID, allocatedestinationstring: super::Foundation::BOOLEAN) -> super::Foundation::NTSTATUS;
#[cfg(feature = "Win32_Foundation")]
pub type RtlNormalizeSecurityDescriptor = unsafe extern "system" fn(securitydescriptor: *mut *mut SECURITY_DESCRIPTOR, securitydescriptorlength: u32, newsecuritydescriptor: *mut *mut SECURITY_DESCRIPTOR, newsecuritydescriptorlength: *mut u32, checkonly: super::Foundation::BOOLEAN) -> super::Foundation::BOOLEAN;
#[cfg(feature = "Win32_Foundation")]
pub type SetAclInformation = unsafe extern "system" fn(pacl: *mut ACL, paclinformation: *const ::core::ffi::c_void, naclinformationlength: u32, dwaclinformationclass: ACL_INFORMATION_CLASS) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetCachedSigningLevel = unsafe extern "system" fn(sourcefiles: *const super::Foundation::HANDLE, sourcefilecount: u32, flags: u32, targetfile: super::Foundation::HANDLE) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetFileSecurityA = unsafe extern "system" fn(lpfilename: super::Foundation::PSTR, securityinformation: u32, psecuritydescriptor: *const SECURITY_DESCRIPTOR) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetFileSecurityW = unsafe extern "system" fn(lpfilename: super::Foundation::PWSTR, securityinformation: u32, psecuritydescriptor: *const SECURITY_DESCRIPTOR) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetKernelObjectSecurity = unsafe extern "system" fn(handle: super::Foundation::HANDLE, securityinformation: u32, securitydescriptor: *const SECURITY_DESCRIPTOR) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetPrivateObjectSecurity = unsafe extern "system" fn(securityinformation: u32, modificationdescriptor: *const SECURITY_DESCRIPTOR, objectssecuritydescriptor: *mut *mut SECURITY_DESCRIPTOR, genericmapping: *const GENERIC_MAPPING, token: super::Foundation::HANDLE) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetPrivateObjectSecurityEx = unsafe extern "system" fn(securityinformation: u32, modificationdescriptor: *const SECURITY_DESCRIPTOR, objectssecuritydescriptor: *mut *mut SECURITY_DESCRIPTOR, autoinheritflags: SECURITY_AUTO_INHERIT_FLAGS, genericmapping: *const GENERIC_MAPPING, token: super::Foundation::HANDLE) -> super::Foundation::BOOL;
pub type SetSecurityAccessMask = unsafe extern "system" fn(securityinformation: u32, desiredaccess: *mut u32);
#[cfg(feature = "Win32_Foundation")]
pub type SetSecurityDescriptorControl = unsafe extern "system" fn(psecuritydescriptor: *const SECURITY_DESCRIPTOR, controlbitsofinterest: u16, controlbitstoset: u16) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetSecurityDescriptorDacl = unsafe extern "system" fn(psecuritydescriptor: *mut SECURITY_DESCRIPTOR, bdaclpresent: super::Foundation::BOOL, pdacl: *const ACL, bdacldefaulted: super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetSecurityDescriptorGroup = unsafe extern "system" fn(psecuritydescriptor: *mut SECURITY_DESCRIPTOR, pgroup: super::Foundation::PSID, bgroupdefaulted: super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetSecurityDescriptorOwner = unsafe extern "system" fn(psecuritydescriptor: *mut SECURITY_DESCRIPTOR, powner: super::Foundation::PSID, bownerdefaulted: super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetSecurityDescriptorRMControl = unsafe extern "system" fn(securitydescriptor: *mut SECURITY_DESCRIPTOR, rmcontrol: *const u8) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type SetSecurityDescriptorSacl = unsafe extern "system" fn(psecuritydescriptor: *mut SECURITY_DESCRIPTOR, bsaclpresent: super::Foundation::BOOL, psacl: *const ACL, bsacldefaulted: super::Foundation::BOOL) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetTokenInformation = unsafe extern "system" fn(tokenhandle: super::Foundation::HANDLE, tokeninformationclass: TOKEN_INFORMATION_CLASS, tokeninformation: *const ::core::ffi::c_void, tokeninformationlength: u32) -> super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetUserObjectSecurity = unsafe extern "system" fn(hobj: super::Foundation::HANDLE, psirequested: *const OBJECT_SECURITY_INFORMATION, psid: *const SECURITY_DESCRIPTOR) -> super::Foundation::BOOL;
#[repr(C)]
