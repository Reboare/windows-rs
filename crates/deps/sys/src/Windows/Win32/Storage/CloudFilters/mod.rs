...
pub type CfConnectSyncRoot = unsafe extern "system" fn(syncrootpath: super::super::Foundation::PWSTR, callbacktable: *const CF_CALLBACK_REGISTRATION, callbackcontext: *const ::core::ffi::c_void, connectflags: CF_CONNECT_FLAGS, connectionkey: *mut CF_CONNECTION_KEY) -> ::windows_sys::core::HRESULT;
...
pub type CfCreatePlaceholders = unsafe extern "system" fn(basedirectorypath: super::super::Foundation::PWSTR, placeholderarray: *mut CF_PLACEHOLDER_CREATE_INFO, placeholdercount: u32, createflags: CF_CREATE_FLAGS, entriesprocessed: *mut u32) -> ::windows_sys::core::HRESULT;
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
...
#[cfg(feature = "Win32_Foundation")]
pub type CfGetSyncRootInfoByPath = unsafe extern "system" fn(filepath: super::super::Foundation::PWSTR, infoclass: CF_SYNC_ROOT_INFO_CLASS, infobuffer: *mut ::core::ffi::c_void, infobufferlength: u32, returnedlength: *mut u32) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
...
#[cfg(feature = "Win32_Foundation")]
pub type CfOpenFileWithOplock = unsafe extern "system" fn(filepath: super::super::Foundation::PWSTR, flags: CF_OPEN_FILE_FLAGS, protectedhandle: *mut super::super::Foundation::HANDLE) -> ::windows_sys::core::HRESULT;
...
#[cfg(feature = "Win32_Foundation")]
pub type CfReferenceProtectedHandle = unsafe extern "system" fn(protectedhandle: super::super::Foundation::HANDLE) -> super::super::Foundation::BOOLEAN;
#[cfg(feature = "Win32_Foundation")]
pub type CfRegisterSyncRoot = unsafe extern "system" fn(syncrootpath: super::super::Foundation::PWSTR, registration: *const CF_SYNC_REGISTRATION, policies: *const CF_SYNC_POLICIES, registerflags: CF_REGISTER_FLAGS) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type CfReleaseProtectedHandle = unsafe extern "system" fn(protectedhandle: super::super::Foundation::HANDLE);
#[cfg(feature = "Win32_Foundation")]
pub type CfReleaseTransferKey = unsafe extern "system" fn(filehandle: super::super::Foundation::HANDLE, transferkey: *mut i64);
...
#[cfg(feature = "Win32_Foundation")]
pub type CfReportSyncStatus = unsafe extern "system" fn(syncrootpath: super::super::Foundation::PWSTR, syncstatus: *const CF_SYNC_STATUS) -> ::windows_sys::core::HRESULT;
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_IO"))]
...
#[cfg(feature = "Win32_Foundation")]
pub type CfUnregisterSyncRoot = unsafe extern "system" fn(syncrootpath: super::super::Foundation::PWSTR) -> ::windows_sys::core::HRESULT;
