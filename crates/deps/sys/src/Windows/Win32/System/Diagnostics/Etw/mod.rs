...
pub type CloseTrace = unsafe extern "system" fn(tracehandle: u64) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type ControlTraceA = unsafe extern "system" fn(tracehandle: u64, instancename: super::super::super::Foundation::PSTR, properties: *mut EVENT_TRACE_PROPERTIES, controlcode: EVENT_TRACE_CONTROL) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type ControlTraceW = unsafe extern "system" fn(tracehandle: u64, instancename: super::super::super::Foundation::PWSTR, properties: *mut EVENT_TRACE_PROPERTIES, controlcode: EVENT_TRACE_CONTROL) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type CreateTraceInstanceId = unsafe extern "system" fn(reghandle: super::super::super::Foundation::HANDLE, instinfo: *mut EVENT_INSTANCE_INFO) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type CveEventWrite = unsafe extern "system" fn(cveid: super::super::super::Foundation::PWSTR, additionaldetails: super::super::super::Foundation::PWSTR) -> i32;
pub type EnableTrace = unsafe extern "system" fn(enable: u32, enableflag: u32, enablelevel: u32, controlguid: *const ::windows_sys::core::GUID, tracehandle: u64) -> u32;
pub type EnableTraceEx = unsafe extern "system" fn(providerid: *const ::windows_sys::core::GUID, sourceid: *const ::windows_sys::core::GUID, tracehandle: u64, isenabled: u32, level: u8, matchanykeyword: u64, matchallkeyword: u64, enableproperty: u32, enablefilterdesc: *const EVENT_FILTER_DESCRIPTOR) -> u32;
pub type EnableTraceEx2 = unsafe extern "system" fn(tracehandle: u64, providerid: *const ::windows_sys::core::GUID, controlcode: u32, level: u8, matchanykeyword: u64, matchallkeyword: u64, timeout: u32, enableparameters: *const ENABLE_TRACE_PARAMETERS) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type EnumerateTraceGuids = unsafe extern "system" fn(guidpropertiesarray: *mut *mut TRACE_GUID_PROPERTIES, propertyarraycount: u32, guidcount: *mut u32) -> u32;
pub type EnumerateTraceGuidsEx = unsafe extern "system" fn(tracequeryinfoclass: TRACE_QUERY_INFO_CLASS, inbuffer: *const ::core::ffi::c_void, inbuffersize: u32, outbuffer: *mut ::core::ffi::c_void, outbuffersize: u32, returnlength: *mut u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type EventAccessControl = unsafe extern "system" fn(guid: *const ::windows_sys::core::GUID, operation: u32, sid: super::super::super::Foundation::PSID, rights: u32, allowordeny: super::super::super::Foundation::BOOLEAN) -> u32;
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub type EventAccessQuery = unsafe extern "system" fn(guid: *const ::windows_sys::core::GUID, buffer: *mut super::super::super::Security::SECURITY_DESCRIPTOR, buffersize: *mut u32) -> u32;
...
#[cfg(feature = "Win32_Foundation")]
pub type EventEnabled = unsafe extern "system" fn(reghandle: u64, eventdescriptor: *const EVENT_DESCRIPTOR) -> super::super::super::Foundation::BOOLEAN;
#[cfg(feature = "Win32_Foundation")]
pub type EventProviderEnabled = unsafe extern "system" fn(reghandle: u64, level: u8, keyword: u64) -> super::super::super::Foundation::BOOLEAN;
pub type EventRegister = unsafe extern "system" fn(providerid: *const ::windows_sys::core::GUID, enablecallback: PENABLECALLBACK, callbackcontext: *const ::core::ffi::c_void, reghandle: *mut u64) -> u32;
pub type EventSetInformation = unsafe extern "system" fn(reghandle: u64, informationclass: EVENT_INFO_CLASS, eventinformation: *const ::core::ffi::c_void, informationlength: u32) -> u32;
pub type EventUnregister = unsafe extern "system" fn(reghandle: u64) -> u32;
pub type EventWrite = unsafe extern "system" fn(reghandle: u64, eventdescriptor: *const EVENT_DESCRIPTOR, userdatacount: u32, userdata: *const EVENT_DATA_DESCRIPTOR) -> u32;
pub type EventWriteEx = unsafe extern "system" fn(reghandle: u64, eventdescriptor: *const EVENT_DESCRIPTOR, filter: u64, flags: u32, activityid: *const ::windows_sys::core::GUID, relatedactivityid: *const ::windows_sys::core::GUID, userdatacount: u32, userdata: *const EVENT_DATA_DESCRIPTOR) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type EventWriteString = unsafe extern "system" fn(reghandle: u64, level: u8, keyword: u64, string: super::super::super::Foundation::PWSTR) -> u32;
pub type EventWriteTransfer = unsafe extern "system" fn(reghandle: u64, eventdescriptor: *const EVENT_DESCRIPTOR, activityid: *const ::windows_sys::core::GUID, relatedactivityid: *const ::windows_sys::core::GUID, userdatacount: u32, userdata: *const EVENT_DATA_DESCRIPTOR) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type FlushTraceA = unsafe extern "system" fn(tracehandle: u64, instancename: super::super::super::Foundation::PSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type FlushTraceW = unsafe extern "system" fn(tracehandle: u64, instancename: super::super::super::Foundation::PWSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> u32;
...
pub type OpenTraceA = unsafe extern "system" fn(logfile: *mut EVENT_TRACE_LOGFILEA) -> u64;
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Time"))]
pub type OpenTraceW = unsafe extern "system" fn(logfile: *mut EVENT_TRACE_LOGFILEW) -> u64;
#[cfg(feature = "Win32_Foundation")]
pub type ProcessTrace = unsafe extern "system" fn(handlearray: *const u64, handlecount: u32, starttime: *const super::super::super::Foundation::FILETIME, endtime: *const super::super::super::Foundation::FILETIME) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type QueryAllTracesA = unsafe extern "system" fn(propertyarray: *mut *mut EVENT_TRACE_PROPERTIES, propertyarraycount: u32, loggercount: *mut u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type QueryAllTracesW = unsafe extern "system" fn(propertyarray: *mut *mut EVENT_TRACE_PROPERTIES, propertyarraycount: u32, loggercount: *mut u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type QueryTraceA = unsafe extern "system" fn(tracehandle: u64, instancename: super::super::super::Foundation::PSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> u32;
pub type QueryTraceProcessingHandle = unsafe extern "system" fn(processinghandle: u64, informationclass: ETW_PROCESS_HANDLE_INFO_TYPE, inbuffer: *const ::core::ffi::c_void, inbuffersize: u32, outbuffer: *mut ::core::ffi::c_void, outbuffersize: u32, returnlength: *mut u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type QueryTraceW = unsafe extern "system" fn(tracehandle: u64, instancename: super::super::super::Foundation::PWSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type RegisterTraceGuidsA = unsafe extern "system" fn(requestaddress: WMIDPREQUEST, requestcontext: *const ::core::ffi::c_void, controlguid: *const ::windows_sys::core::GUID, guidcount: u32, traceguidreg: *const TRACE_GUID_REGISTRATION, mofimagepath: super::super::super::Foundation::PSTR, mofresourcename: super::super::super::Foundation::PSTR, registrationhandle: *mut u64) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type RegisterTraceGuidsW = unsafe extern "system" fn(requestaddress: WMIDPREQUEST, requestcontext: *const ::core::ffi::c_void, controlguid: *const ::windows_sys::core::GUID, guidcount: u32, traceguidreg: *const TRACE_GUID_REGISTRATION, mofimagepath: super::super::super::Foundation::PWSTR, mofresourcename: super::super::super::Foundation::PWSTR, registrationhandle: *mut u64) -> u32;
pub type RemoveTraceCallback = unsafe extern "system" fn(pguid: *const ::windows_sys::core::GUID) -> u32;
pub type SetTraceCallback = unsafe extern "system" fn(pguid: *const ::windows_sys::core::GUID, eventcallback: PEVENT_CALLBACK) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type StartTraceA = unsafe extern "system" fn(tracehandle: *mut u64, instancename: super::super::super::Foundation::PSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type StartTraceW = unsafe extern "system" fn(tracehandle: *mut u64, instancename: super::super::super::Foundation::PWSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type StopTraceA = unsafe extern "system" fn(tracehandle: u64, instancename: super::super::super::Foundation::PSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type StopTraceW = unsafe extern "system" fn(tracehandle: u64, instancename: super::super::super::Foundation::PWSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type TdhAggregatePayloadFilters = unsafe extern "system" fn(payloadfiltercount: u32, payloadfilterptrs: *const *const ::core::ffi::c_void, eventmatchallflags: *const super::super::super::Foundation::BOOLEAN, eventfilterdescriptor: *mut EVENT_FILTER_DESCRIPTOR) -> u32;
...
#[cfg(feature = "Win32_Foundation")]
pub type TdhFormatProperty = unsafe extern "system" fn(eventinfo: *const TRACE_EVENT_INFO, mapinfo: *const EVENT_MAP_INFO, pointersize: u32, propertyintype: u16, propertyouttype: u16, propertylength: u16, userdatalength: u16, userdata: *const u8, buffersize: *mut u32, buffer: super::super::super::Foundation::PWSTR, userdataconsumed: *mut u16) -> u32;
...
#[cfg(feature = "Win32_Foundation")]
pub type TdhGetEventMapInformation = unsafe extern "system" fn(pevent: *const EVENT_RECORD, pmapname: super::super::super::Foundation::PWSTR, pbuffer: *mut EVENT_MAP_INFO, pbuffersize: *mut u32) -> u32;
...
#[cfg(feature = "Win32_Foundation")]
pub type TdhGetWppProperty = unsafe extern "system" fn(handle: TDH_HANDLE, eventrecord: *const EVENT_RECORD, propertyname: super::super::super::Foundation::PWSTR, buffersize: *mut u32, buffer: *mut u8) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type TdhLoadManifest = unsafe extern "system" fn(manifest: super::super::super::Foundation::PWSTR) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type TdhLoadManifestFromBinary = unsafe extern "system" fn(binarypath: super::super::super::Foundation::PWSTR) -> u32;
...
#[cfg(feature = "Win32_Foundation")]
pub type TdhUnloadManifest = unsafe extern "system" fn(manifest: super::super::super::Foundation::PWSTR) -> u32;
pub type TdhUnloadManifestFromMemory = unsafe extern "system" fn(pdata: *const ::core::ffi::c_void, cbdata: u32) -> u32;
pub type TraceEvent = unsafe extern "system" fn(tracehandle: u64, eventtrace: *const EVENT_TRACE_HEADER) -> u32;
#[cfg(feature = "Win32_Foundation")]
...
pub type TraceMessage = unsafe extern "system" fn(loggerhandle: u64, messageflags: TRACE_MESSAGE_FLAGS, messageguid: *const ::windows_sys::core::GUID, messagenumber: u16) -> u32;
pub type TraceMessageVa = unsafe extern "system" fn(loggerhandle: u64, messageflags: TRACE_MESSAGE_FLAGS, messageguid: *const ::windows_sys::core::GUID, messagenumber: u16, messagearglist: *const i8) -> u32;
pub type TraceQueryInformation = unsafe extern "system" fn(sessionhandle: u64, informationclass: TRACE_QUERY_INFO_CLASS, traceinformation: *mut ::core::ffi::c_void, informationlength: u32, returnlength: *mut u32) -> u32;
pub type TraceSetInformation = unsafe extern "system" fn(sessionhandle: u64, informationclass: TRACE_QUERY_INFO_CLASS, traceinformation: *const ::core::ffi::c_void, informationlength: u32) -> u32;
pub type UnregisterTraceGuids = unsafe extern "system" fn(registrationhandle: u64) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type UpdateTraceA = unsafe extern "system" fn(tracehandle: u64, instancename: super::super::super::Foundation::PSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type UpdateTraceW = unsafe extern "system" fn(tracehandle: u64, instancename: super::super::super::Foundation::PWSTR, properties: *mut EVENT_TRACE_PROPERTIES) -> u32;
#[repr(C)]
