...
#[cfg(feature = "Win32_Foundation")]
pub type CommandLineFromMsiDescriptor = unsafe extern "system" fn(descriptor: super::super::Foundation::PWSTR, commandline: super::super::Foundation::PWSTR, commandlinelength: *mut u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type CreateGPOLink = unsafe extern "system" fn(lpgpo: super::super::Foundation::PWSTR, lpcontainer: super::super::Foundation::PWSTR, fhighpriority: super::super::Foundation::BOOL) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type DeleteAllGPOLinks = unsafe extern "system" fn(lpcontainer: super::super::Foundation::PWSTR) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type DeleteGPOLink = unsafe extern "system" fn(lpgpo: super::super::Foundation::PWSTR, lpcontainer: super::super::Foundation::PWSTR) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type EnterCriticalPolicySection = unsafe extern "system" fn(bmachine: super::super::Foundation::BOOL) -> super::super::Foundation::HANDLE;
#[cfg(feature = "Win32_Foundation")]
pub type ExportRSoPData = unsafe extern "system" fn(lpnamespace: super::super::Foundation::PWSTR, lpfilename: super::super::Foundation::PWSTR) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type FreeGPOListA = unsafe extern "system" fn(pgpolist: *const GROUP_POLICY_OBJECTA) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type FreeGPOListW = unsafe extern "system" fn(pgpolist: *const GROUP_POLICY_OBJECTW) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GenerateGPNotification = unsafe extern "system" fn(bmachine: super::super::Foundation::BOOL, lpwszmgmtproduct: super::super::Foundation::PWSTR, dwmgmtproductoptions: u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetAppliedGPOListA = unsafe extern "system" fn(dwflags: u32, pmachinename: super::super::Foundation::PSTR, psiduser: super::super::Foundation::PSID, pguidextension: *const ::windows_sys::core::GUID, ppgpolist: *mut *mut GROUP_POLICY_OBJECTA) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetAppliedGPOListW = unsafe extern "system" fn(dwflags: u32, pmachinename: super::super::Foundation::PWSTR, psiduser: super::super::Foundation::PSID, pguidextension: *const ::windows_sys::core::GUID, ppgpolist: *mut *mut GROUP_POLICY_OBJECTW) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetGPOListA = unsafe extern "system" fn(htoken: super::super::Foundation::HANDLE, lpname: super::super::Foundation::PSTR, lphostname: super::super::Foundation::PSTR, lpcomputername: super::super::Foundation::PSTR, dwflags: u32, pgpolist: *mut *mut GROUP_POLICY_OBJECTA) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetGPOListW = unsafe extern "system" fn(htoken: super::super::Foundation::HANDLE, lpname: super::super::Foundation::PWSTR, lphostname: super::super::Foundation::PWSTR, lpcomputername: super::super::Foundation::PWSTR, dwflags: u32, pgpolist: *mut *mut GROUP_POLICY_OBJECTW) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetLocalManagedApplicationData = unsafe extern "system" fn(productcode: super::super::Foundation::PWSTR, displayname: *mut super::super::Foundation::PWSTR, supporturl: *mut super::super::Foundation::PWSTR);
#[cfg(feature = "Win32_Foundation")]
pub type GetLocalManagedApplications = unsafe extern "system" fn(buserapps: super::super::Foundation::BOOL, pdwapps: *mut u32, prglocalapps: *mut *mut LOCALMANAGEDAPPLICATION) -> u32;
...
#[cfg(feature = "Win32_Foundation")]
pub type ImportRSoPData = unsafe extern "system" fn(lpnamespace: super::super::Foundation::PWSTR, lpfilename: super::super::Foundation::PWSTR) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type InstallApplication = unsafe extern "system" fn(pinstallinfo: *const INSTALLDATA) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type LeaveCriticalPolicySection = unsafe extern "system" fn(hsection: super::super::Foundation::HANDLE) -> super::super::Foundation::BOOL;
...
#[cfg(feature = "Win32_Foundation")]
pub type RefreshPolicy = unsafe extern "system" fn(bmachine: super::super::Foundation::BOOL) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type RefreshPolicyEx = unsafe extern "system" fn(bmachine: super::super::Foundation::BOOL, dwoptions: u32) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type RegisterGPNotification = unsafe extern "system" fn(hevent: super::super::Foundation::HANDLE, bmachine: super::super::Foundation::BOOL) -> super::super::Foundation::BOOL;
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_Security"))]
pub type RsopAccessCheckByType = unsafe extern "system" fn(
...
#[cfg(feature = "Win32_Foundation")]
pub type RsopFileAccessCheck = unsafe extern "system" fn(pszfilename: super::super::Foundation::PWSTR, prsoptoken: *const ::core::ffi::c_void, dwdesiredaccessmask: u32, pdwgrantedaccessmask: *mut u32, pbaccessstatus: *mut i32) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_System_Wmi")]
pub type RsopResetPolicySettingStatus = unsafe extern "system" fn(dwflags: u32, pservices: super::Wmi::IWbemServices, psettinginstance: super::Wmi::IWbemClassObject) -> ::windows_sys::core::HRESULT;
#[cfg(all(feature = "Win32_Foundation", feature = "Win32_System_Wmi"))]
pub type RsopSetPolicySettingStatus = unsafe extern "system" fn(dwflags: u32, pservices: super::Wmi::IWbemServices, psettinginstance: super::Wmi::IWbemClassObject, ninfo: u32, pstatus: *const POLICYSETTINGSTATUSINFO) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type UninstallApplication = unsafe extern "system" fn(productcode: super::super::Foundation::PWSTR, dwstatus: u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type UnregisterGPNotification = unsafe extern "system" fn(hevent: super::super::Foundation::HANDLE) -> super::super::Foundation::BOOL;
