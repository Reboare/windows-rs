...
pub type WSManCloseCommand = unsafe extern "system" fn(commandhandle: *mut WSMAN_COMMAND, flags: u32, r#async: *const WSMAN_SHELL_ASYNC);
pub type WSManCloseOperation = unsafe extern "system" fn(operationhandle: *mut WSMAN_OPERATION, flags: u32) -> u32;
pub type WSManCloseSession = unsafe extern "system" fn(session: *mut WSMAN_SESSION, flags: u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type WSManCloseShell = unsafe extern "system" fn(shellhandle: *mut WSMAN_SHELL, flags: u32, r#async: *const WSMAN_SHELL_ASYNC);
#[cfg(feature = "Win32_Foundation")]
pub type WSManConnectShell = unsafe extern "system" fn(session: *mut WSMAN_SESSION, flags: u32, resourceuri: super::super::Foundation::PWSTR, shellid: super::super::Foundation::PWSTR, options: *const WSMAN_OPTION_SET, connectxml: *const WSMAN_DATA, r#async: *const WSMAN_SHELL_ASYNC, shell: *mut *mut WSMAN_SHELL);
#[cfg(feature = "Win32_Foundation")]
pub type WSManConnectShellCommand = unsafe extern "system" fn(shell: *mut WSMAN_SHELL, flags: u32, commandid: super::super::Foundation::PWSTR, options: *const WSMAN_OPTION_SET, connectxml: *const WSMAN_DATA, r#async: *const WSMAN_SHELL_ASYNC, command: *mut *mut WSMAN_COMMAND);
#[cfg(feature = "Win32_Foundation")]
pub type WSManCreateSession = unsafe extern "system" fn(apihandle: *const WSMAN_API, connection: super::super::Foundation::PWSTR, flags: u32, serverauthenticationcredentials: *const WSMAN_AUTHENTICATION_CREDENTIALS, proxyinfo: *const WSMAN_PROXY_INFO, session: *mut *mut WSMAN_SESSION) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type WSManCreateShell = unsafe extern "system" fn(session: *mut WSMAN_SESSION, flags: u32, resourceuri: super::super::Foundation::PWSTR, startupinfo: *const WSMAN_SHELL_STARTUP_INFO_V11, options: *const WSMAN_OPTION_SET, createxml: *const WSMAN_DATA, r#async: *const WSMAN_SHELL_ASYNC, shell: *mut *mut WSMAN_SHELL);
#[cfg(feature = "Win32_Foundation")]
pub type WSManCreateShellEx = unsafe extern "system" fn(session: *mut WSMAN_SESSION, flags: u32, resourceuri: super::super::Foundation::PWSTR, shellid: super::super::Foundation::PWSTR, startupinfo: *const WSMAN_SHELL_STARTUP_INFO_V11, options: *const WSMAN_OPTION_SET, createxml: *const WSMAN_DATA, r#async: *const WSMAN_SHELL_ASYNC, shell: *mut *mut WSMAN_SHELL);
pub type WSManDeinitialize = unsafe extern "system" fn(apihandle: *mut WSMAN_API, flags: u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type WSManDisconnectShell = unsafe extern "system" fn(shell: *mut WSMAN_SHELL, flags: u32, disconnectinfo: *const WSMAN_SHELL_DISCONNECT_INFO, r#async: *const WSMAN_SHELL_ASYNC);
#[cfg(feature = "Win32_Foundation")]
pub type WSManGetErrorMessage = unsafe extern "system" fn(apihandle: *const WSMAN_API, flags: u32, languagecode: super::super::Foundation::PWSTR, errorcode: u32, messagelength: u32, message: super::super::Foundation::PWSTR, messagelengthused: *mut u32) -> u32;
pub type WSManGetSessionOptionAsDword = unsafe extern "system" fn(session: *const WSMAN_SESSION, option: WSManSessionOption, value: *mut u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type WSManGetSessionOptionAsString = unsafe extern "system" fn(session: *const WSMAN_SESSION, option: WSManSessionOption, stringlength: u32, string: super::super::Foundation::PWSTR, stringlengthused: *mut u32) -> u32;
pub type WSManInitialize = unsafe extern "system" fn(flags: u32, apihandle: *mut *mut WSMAN_API) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type WSManPluginAuthzOperationComplete = unsafe extern "system" fn(senderdetails: *const WSMAN_SENDER_DETAILS, flags: u32, userauthorizationcontext: *const ::core::ffi::c_void, errorcode: u32, extendederrorinformation: super::super::Foundation::PWSTR) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type WSManPluginAuthzQueryQuotaComplete = unsafe extern "system" fn(senderdetails: *const WSMAN_SENDER_DETAILS, flags: u32, quota: *const WSMAN_AUTHZ_QUOTA, errorcode: u32, extendederrorinformation: super::super::Foundation::PWSTR) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type WSManPluginAuthzUserComplete = unsafe extern "system" fn(senderdetails: *const WSMAN_SENDER_DETAILS, flags: u32, userauthorizationcontext: *const ::core::ffi::c_void, impersonationtoken: super::super::Foundation::HANDLE, userisadministrator: super::super::Foundation::BOOL, errorcode: u32, extendederrorinformation: super::super::Foundation::PWSTR) -> u32;
#[cfg(feature = "Win32_Foundation")]
...
#[cfg(feature = "Win32_Foundation")]
pub type WSManPluginOperationComplete = unsafe extern "system" fn(requestdetails: *const WSMAN_PLUGIN_REQUEST, flags: u32, errorcode: u32, extendedinformation: super::super::Foundation::PWSTR) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type WSManPluginReceiveResult = unsafe extern "system" fn(requestdetails: *const WSMAN_PLUGIN_REQUEST, flags: u32, stream: super::super::Foundation::PWSTR, streamresult: *const WSMAN_DATA, commandstate: super::super::Foundation::PWSTR, exitcode: u32) -> u32;
...
#[cfg(feature = "Win32_Foundation")]
pub type WSManReceiveShellOutput = unsafe extern "system" fn(shell: *mut WSMAN_SHELL, command: *const WSMAN_COMMAND, flags: u32, desiredstreamset: *const WSMAN_STREAM_ID_SET, r#async: *const WSMAN_SHELL_ASYNC, receiveoperation: *mut *mut WSMAN_OPERATION);
#[cfg(feature = "Win32_Foundation")]
pub type WSManReconnectShell = unsafe extern "system" fn(shell: *mut WSMAN_SHELL, flags: u32, r#async: *const WSMAN_SHELL_ASYNC);
#[cfg(feature = "Win32_Foundation")]
pub type WSManReconnectShellCommand = unsafe extern "system" fn(commandhandle: *mut WSMAN_COMMAND, flags: u32, r#async: *const WSMAN_SHELL_ASYNC);
#[cfg(feature = "Win32_Foundation")]
pub type WSManRunShellCommand = unsafe extern "system" fn(shell: *mut WSMAN_SHELL, flags: u32, commandline: super::super::Foundation::PWSTR, args: *const WSMAN_COMMAND_ARG_SET, options: *const WSMAN_OPTION_SET, r#async: *const WSMAN_SHELL_ASYNC, command: *mut *mut WSMAN_COMMAND);
#[cfg(feature = "Win32_Foundation")]
pub type WSManRunShellCommandEx = unsafe extern "system" fn(shell: *mut WSMAN_SHELL, flags: u32, commandid: super::super::Foundation::PWSTR, commandline: super::super::Foundation::PWSTR, args: *const WSMAN_COMMAND_ARG_SET, options: *const WSMAN_OPTION_SET, r#async: *const WSMAN_SHELL_ASYNC, command: *mut *mut WSMAN_COMMAND);
#[cfg(feature = "Win32_Foundation")]
pub type WSManSendShellInput = unsafe extern "system" fn(shell: *const WSMAN_SHELL, command: *const WSMAN_COMMAND, flags: u32, streamid: super::super::Foundation::PWSTR, streamdata: *const WSMAN_DATA, endofstream: super::super::Foundation::BOOL, r#async: *const WSMAN_SHELL_ASYNC, sendoperation: *mut *mut WSMAN_OPERATION);
#[cfg(feature = "Win32_Foundation")]
pub type WSManSetSessionOption = unsafe extern "system" fn(session: *const WSMAN_SESSION, option: WSManSessionOption, data: *const WSMAN_DATA) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type WSManSignalShell = unsafe extern "system" fn(shell: *const WSMAN_SHELL, command: *const WSMAN_COMMAND, flags: u32, code: super::super::Foundation::PWSTR, r#async: *const WSMAN_SHELL_ASYNC, signaloperation: *mut *mut WSMAN_OPERATION);
