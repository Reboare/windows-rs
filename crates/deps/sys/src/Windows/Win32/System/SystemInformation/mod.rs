...
pub type DnsHostnameToComputerNameExW = unsafe extern "system" fn(hostname: super::super::Foundation::PWSTR, computername: super::super::Foundation::PWSTR, nsize: *mut u32) -> super::super::Foundation::BOOL;
pub type EnumSystemFirmwareTables = unsafe extern "system" fn(firmwaretableprovidersignature: FIRMWARE_TABLE_PROVIDER, pfirmwaretableenumbuffer: *mut FIRMWARE_TABLE_ID, buffersize: u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetComputerNameExA = unsafe extern "system" fn(nametype: COMPUTER_NAME_FORMAT, lpbuffer: super::super::Foundation::PSTR, nsize: *mut u32) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetComputerNameExW = unsafe extern "system" fn(nametype: COMPUTER_NAME_FORMAT, lpbuffer: super::super::Foundation::PWSTR, nsize: *mut u32) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetFirmwareType = unsafe extern "system" fn(firmwaretype: *mut FIRMWARE_TYPE) -> super::super::Foundation::BOOL;
...
#[cfg(feature = "Win32_Foundation")]
pub type GetLogicalProcessorInformation = unsafe extern "system" fn(buffer: *mut SYSTEM_LOGICAL_PROCESSOR_INFORMATION, returnedlength: *mut u32) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetLogicalProcessorInformationEx = unsafe extern "system" fn(relationshiptype: LOGICAL_PROCESSOR_RELATIONSHIP, buffer: *mut SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX, returnedlength: *mut u32) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_System_Diagnostics_Debug")]
pub type GetNativeSystemInfo = unsafe extern "system" fn(lpsysteminfo: *mut SYSTEM_INFO);
#[cfg(feature = "Win32_Foundation")]
pub type GetOsManufacturingMode = unsafe extern "system" fn(pbenabled: *mut super::super::Foundation::BOOL) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetOsSafeBootMode = unsafe extern "system" fn(flags: *mut u32) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetPhysicallyInstalledSystemMemory = unsafe extern "system" fn(totalmemoryinkilobytes: *mut u64) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetProcessorSystemCycleTime = unsafe extern "system" fn(group: u16, buffer: *mut SYSTEM_PROCESSOR_CYCLE_TIME_INFORMATION, returnedlength: *mut u32) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetProductInfo = unsafe extern "system" fn(dwosmajorversion: u32, dwosminorversion: u32, dwspmajorversion: u32, dwspminorversion: u32, pdwreturnedproducttype: *mut OS_PRODUCT_TYPE) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetSystemCpuSetInformation = unsafe extern "system" fn(information: *mut SYSTEM_CPU_SET_INFORMATION, bufferlength: u32, returnedlength: *mut u32, process: super::super::Foundation::HANDLE, flags: u32) -> super::super::Foundation::BOOL;
pub type GetSystemDEPPolicy = unsafe extern "system" fn() -> DEP_SYSTEM_POLICY_TYPE;
#[cfg(feature = "Win32_Foundation")]
pub type GetSystemDirectoryA = unsafe extern "system" fn(lpbuffer: super::super::Foundation::PSTR, usize: u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetSystemDirectoryW = unsafe extern "system" fn(lpbuffer: super::super::Foundation::PWSTR, usize: u32) -> u32;
pub type GetSystemFirmwareTable = unsafe extern "system" fn(firmwaretableprovidersignature: FIRMWARE_TABLE_PROVIDER, firmwaretableid: FIRMWARE_TABLE_ID, pfirmwaretablebuffer: *mut ::core::ffi::c_void, buffersize: u32) -> u32;
#[cfg(feature = "Win32_System_Diagnostics_Debug")]
pub type GetSystemInfo = unsafe extern "system" fn(lpsysteminfo: *mut SYSTEM_INFO);
#[cfg(feature = "Win32_Foundation")]
pub type GetSystemLeapSecondInformation = unsafe extern "system" fn(enabled: *mut super::super::Foundation::BOOL, flags: *mut u32) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetSystemTime = unsafe extern "system" fn(lpsystemtime: *mut super::super::Foundation::SYSTEMTIME);
#[cfg(feature = "Win32_Foundation")]
pub type GetSystemTimeAdjustment = unsafe extern "system" fn(lptimeadjustment: *mut u32, lptimeincrement: *mut u32, lptimeadjustmentdisabled: *mut super::super::Foundation::BOOL) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetSystemTimeAdjustmentPrecise = unsafe extern "system" fn(lptimeadjustment: *mut u64, lptimeincrement: *mut u64, lptimeadjustmentdisabled: *mut super::super::Foundation::BOOL) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
...
#[cfg(feature = "Win32_Foundation")]
pub type GetSystemWindowsDirectoryA = unsafe extern "system" fn(lpbuffer: super::super::Foundation::PSTR, usize: u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetSystemWindowsDirectoryW = unsafe extern "system" fn(lpbuffer: super::super::Foundation::PWSTR, usize: u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetSystemWow64Directory2A = unsafe extern "system" fn(lpbuffer: super::super::Foundation::PSTR, usize: u32, imagefilemachinetype: u16) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetSystemWow64Directory2W = unsafe extern "system" fn(lpbuffer: super::super::Foundation::PWSTR, usize: u32, imagefilemachinetype: u16) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetSystemWow64DirectoryA = unsafe extern "system" fn(lpbuffer: super::super::Foundation::PSTR, usize: u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetSystemWow64DirectoryW = unsafe extern "system" fn(lpbuffer: super::super::Foundation::PWSTR, usize: u32) -> u32;
...
#[cfg(feature = "Win32_Foundation")]
pub type GetVersionExA = unsafe extern "system" fn(lpversioninformation: *mut OSVERSIONINFOA) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetVersionExW = unsafe extern "system" fn(lpversioninformation: *mut OSVERSIONINFOW) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetWindowsDirectoryA = unsafe extern "system" fn(lpbuffer: super::super::Foundation::PSTR, usize: u32) -> u32;
#[cfg(feature = "Win32_Foundation")]
pub type GetWindowsDirectoryW = unsafe extern "system" fn(lpbuffer: super::super::Foundation::PWSTR, usize: u32) -> u32;
pub type GlobalMemoryStatus = unsafe extern "system" fn(lpbuffer: *mut MEMORYSTATUS);
#[cfg(feature = "Win32_Foundation")]
pub type GlobalMemoryStatusEx = unsafe extern "system" fn(lpbuffer: *mut MEMORYSTATUSEX) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsUserCetAvailableInEnvironment = unsafe extern "system" fn(usercetenvironment: USER_CET_ENVIRONMENT) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsWow64GuestMachineSupported = unsafe extern "system" fn(wowguestmachine: u16, machineissupported: *mut super::super::Foundation::BOOL) -> ::windows_sys::core::HRESULT;
#[cfg(feature = "Win32_Foundation")]
pub type RtlConvertDeviceFamilyInfoToString = unsafe extern "system" fn(puldevicefamilybuffersize: *mut u32, puldeviceformbuffersize: *mut u32, devicefamily: super::super::Foundation::PWSTR, deviceform: super::super::Foundation::PWSTR) -> u32;
...
#[cfg(feature = "Win32_Foundation")]
pub type RtlGetProductInfo = unsafe extern "system" fn(osmajorversion: u32, osminorversion: u32, spmajorversion: u32, spminorversion: u32, returnedproducttype: *mut u32) -> super::super::Foundation::BOOLEAN;
...
#[cfg(feature = "Win32_Foundation")]
pub type SetComputerNameA = unsafe extern "system" fn(lpcomputername: super::super::Foundation::PSTR) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetComputerNameEx2W = unsafe extern "system" fn(nametype: COMPUTER_NAME_FORMAT, flags: u32, lpbuffer: super::super::Foundation::PWSTR) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetComputerNameExA = unsafe extern "system" fn(nametype: COMPUTER_NAME_FORMAT, lpbuffer: super::super::Foundation::PSTR) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetComputerNameExW = unsafe extern "system" fn(nametype: COMPUTER_NAME_FORMAT, lpbuffer: super::super::Foundation::PWSTR) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetComputerNameW = unsafe extern "system" fn(lpcomputername: super::super::Foundation::PWSTR) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetLocalTime = unsafe extern "system" fn(lpsystemtime: *const super::super::Foundation::SYSTEMTIME) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetSystemTime = unsafe extern "system" fn(lpsystemtime: *const super::super::Foundation::SYSTEMTIME) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetSystemTimeAdjustment = unsafe extern "system" fn(dwtimeadjustment: u32, btimeadjustmentdisabled: super::super::Foundation::BOOL) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetSystemTimeAdjustmentPrecise = unsafe extern "system" fn(dwtimeadjustment: u64, btimeadjustmentdisabled: super::super::Foundation::BOOL) -> super::super::Foundation::BOOL;
pub type VerSetConditionMask = unsafe extern "system" fn(conditionmask: u64, typemask: VER_FLAGS, condition: u8) -> u64;
#[cfg(feature = "Win32_Foundation")]
pub type VerifyVersionInfoA = unsafe extern "system" fn(lpversioninformation: *mut OSVERSIONINFOEXA, dwtypemask: VER_FLAGS, dwlconditionmask: u64) -> super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type VerifyVersionInfoW = unsafe extern "system" fn(lpversioninformation: *mut OSVERSIONINFOEXW, dwtypemask: VER_FLAGS, dwlconditionmask: u64) -> super::super::Foundation::BOOL;
#[repr(C)]
