...
pub type CloseGestureInfoHandle = unsafe extern "system" fn(hgestureinfo: HGESTUREINFO) -> super::super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type CloseTouchInputHandle = unsafe extern "system" fn(htouchinput: HTOUCHINPUT) -> super::super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetGestureConfig = unsafe extern "system" fn(hwnd: super::super::super::Foundation::HWND, dwreserved: u32, dwflags: u32, pcids: *const u32, pgestureconfig: *mut GESTURECONFIG, cbsize: u32) -> super::super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetGestureExtraArgs = unsafe extern "system" fn(hgestureinfo: HGESTUREINFO, cbextraargs: u32, pextraargs: *mut u8) -> super::super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetGestureInfo = unsafe extern "system" fn(hgestureinfo: HGESTUREINFO, pgestureinfo: *mut GESTUREINFO) -> super::super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type GetTouchInputInfo = unsafe extern "system" fn(htouchinput: HTOUCHINPUT, cinputs: u32, pinputs: *mut TOUCHINPUT, cbsize: i32) -> super::super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type IsTouchWindow = unsafe extern "system" fn(hwnd: super::super::super::Foundation::HWND, pulflags: *mut u32) -> super::super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type RegisterTouchWindow = unsafe extern "system" fn(hwnd: super::super::super::Foundation::HWND, ulflags: REGISTER_TOUCH_WINDOW_FLAGS) -> super::super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type SetGestureConfig = unsafe extern "system" fn(hwnd: super::super::super::Foundation::HWND, dwreserved: u32, cids: u32, pgestureconfig: *const GESTURECONFIG, cbsize: u32) -> super::super::super::Foundation::BOOL;
#[cfg(feature = "Win32_Foundation")]
pub type UnregisterTouchWindow = unsafe extern "system" fn(hwnd: super::super::super::Foundation::HWND) -> super::super::super::Foundation::BOOL;
#[repr(C)]
